...
public class ItemTeleLink extends Item {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
		...
		if(te != null && te instanceof TileEntityMachineTeleporter && world.getBlock(x, y, z) == ModBlocks.machine_teleporter ) {
			...
			if(stack.stackTagCompound == null)
			{
				...
				if(world.isRemote)
					player.addChatMessage(new ChatComponentText("[TeleLink] Set teleporter exit to " + x + ", " + y + ", " + z + "."));
			} else {
				...
				if(world.getBlock(x1, y1, z1) == ModBlocks.machine_teleporter && world.getTileEntity(x1, y1, z1) != null && world.getTileEntity(x1, y1, z1) instanceof TileEntityMachineTeleporter) {
					...
					if(world.isRemote)
						player.addChatMessage(new ChatComponentText("[TeleLink] Teleporters have been successfully linked."));
					
					stack.stackTagCompound = null;
				} else {
					if(world.isRemote)
						player.addChatMessage(new ChatComponentText("[TeleLink] Warning: Exit teleporter has been destroyed while linking. Values have been reset."));
					stack.stackTagCompound = null;
				}
			}
