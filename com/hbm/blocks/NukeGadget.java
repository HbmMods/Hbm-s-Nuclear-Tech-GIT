...
public class NukeGadget extends BlockContainer implements IBomb {
	...
	protected NukeGadget(Material p_i45386_1_) {
		super(p_i45386_1_);
	}
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!keepInventory)
        {
            TileEntityNukeGadget tileentityfurnace = (TileEntityNukeGadget)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
	...
	public boolean igniteTestBomb(World world, int x, int y, int z)
	{
		...
		*/
    	...
    	entity.wasteRange = 225;
    	entity.damageRange = 170;
