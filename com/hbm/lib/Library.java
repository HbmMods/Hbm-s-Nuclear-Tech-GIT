...
public class Library {
	...
	public static String book111 = "§lFuorite§r\nFluorite is a powderr which can be found in form of ores. It is used to make uranium and plutonium hexafluorite, gasses which can be enriched in a gas centrifuge.";
	...
	public static String book33 = "§lLittle Boy§r\nLittle Boy is a gun-type nuke which uses a tungsten-carbide neutron reflector, two different uranium 235 elements, a propellant and it's igniter. It has a explosion radius of 120.";
	...
	public static String book38 = "leaving no blocks untouched, besides Bedrock on Y: 0. It needs four quad rods of regular uranium, four quad rods filled with lead, two quad rods of neptunium and four Schrabidiumtrisulfide cells in order to explode. It has a crater radius of only 150 meters,";
	public static String book39 = "but because it's shape, it can destroy a whopping 14 million blocks, the seven million blocks of the bottom half are ten times more than the ammount of blocks the Gadhet will destroy below it's Y axis.";
	public static String book310 = "§lF.L.E.I.J.A.§r\nF.L.E.I.J.A. (pronounced §oFreija§r) is a high-tech Schrabidium bomb which consists of two special impulse igniters, three Schrabidium propellants and six magnetized F.L.E.I.J.A. uranium 235 cores. It has a range of 50 meters.";
	...
	public static String book41 = "§lMissiles§r\nThere are four different ties and four major groups of missiles. They need a launch pad to work and will fly to a maked target where they will explode. Most missiles are easily recognizable by their shape and color.";
