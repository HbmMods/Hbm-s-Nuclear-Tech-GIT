...
public class EntityLN2 extends Entity implements IProjectile
{
    ...
    public EntityLN2(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
	...
	public void onUpdate()
    {
        ...
        if (this.inGround)
        {
        	...
        	if(!worldObj.isRemote) {
        		ExplosionThermo.freeze(this.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ, i);
        		ExplosionThermo.snow(this.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ, i);
        	}
        }
        else
        {
            ...
            {
            	int j = 3;
        		ExplosionThermo.freeze(this.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ, j);
        		ExplosionThermo.snow(this.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ, j);
                this.setDead();
            }
