...
public class ItemSeed extends ItemFood implements IPlantable{
	private final Block soilId;
	
	public ItemSeed(int parHealAmount, float parSaturationModifier, 
	          Block parBlockPlant)
	    {
	        super(parHealAmount, parSaturationModifier, false);
	        ModBlocks.crop_strawberry = parBlockPlant;
	...
	public Block getPlant(IBlockAccess world, int x, int y, int z) {
		return ModBlocks.crop_strawberry;
	}
        ...
        else if (parPlayer.canPlayerEdit(parX, parY+1, parZ, par7, parItemStack))
        {
                  ...
                  .isAirBlock(parX, parY+1, parZ))
            {
             // place the plant block
                parWorld.setBlock(parX, parY+1, parZ, ModBlocks.crop_strawberry);
