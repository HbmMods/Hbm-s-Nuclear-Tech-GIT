...
public class ItemTeed extends ItemFood implements IPlantable{
	private final Block soilId;
	
	public ItemTeed(int parHealAmount, float parSaturationModifier, 
	          Block parBlockPlant)
	    {
	        super(parHealAmount, parSaturationModifier, false);
	        ModBlocks.crop_tea = parBlockPlant;
        ...
        else if (parPlayer.canPlayerEdit(parX, parY+1, parZ, par7, parItemStack))
        {
                  ...
                  .isAirBlock(parX, parY+1, parZ))
            {
             // place the plant block
                parWorld.setBlock(parX, parY+1, parZ, ModBlocks.crop_tea);
