...
public class ItemVVERFuel extends ItemEnumMulti {

	public ItemVVERFuel() {
		super(EnumVVERFuel.class, true, true);
	}
	
	public static enum EnumVVERFuel {
		...
		private EnumVVERFuel(double heatEmission, Function function, double yield) {
			this.heatEmission = heatEmission;
			this.function = function;
		}
		
		private EnumVVERFuel(double heatEmission, Function function) {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
		...
		EnumVVERFuel num = EnumUtil.grabEnumSafely(EnumVVERFuel.class, stack.getItemDamage());
