...
public class ModItems {
	...
	{			
		...
		disperser_canister = new ItemDisperser().setUnlocalizedName("disperser_canister").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":disperser_canister");
