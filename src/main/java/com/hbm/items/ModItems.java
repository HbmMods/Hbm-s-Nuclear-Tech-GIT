...
public class ModItems {
	...
	{			
		...
		rod_zirnox_uranium_fuel = new ItemZirnoxRod(ItemHazard.u * ItemHazard.rod_dual, false, 100000, 25).setUnlocalizedName("rod_zirnox_uranium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.rod_zirnox_empty).setTextureName(RefStrings.MODID + ":rod_zirnox_uranium_fuel");
		...
		rod_zirnox_thorium_fuel = new ItemZirnoxRod(ItemHazard.th232 * ItemHazard.rod_dual, false, 100000, 20).setUnlocalizedName("rod_zirnox_thorium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setTextureName(RefStrings.MODID + ":rod_zirnox_thorium_fuel");
