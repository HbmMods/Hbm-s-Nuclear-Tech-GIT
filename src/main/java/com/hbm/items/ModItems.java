...
import com.EconomyPlus.registry.Constants;
import com.EconomyPlus.registry.Constants.ERA;
...
public class ModItems {
	...
	private static void registerItem() {
		//Weapons
		EraRegistry.registerItem(redstone_sword, redstone_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(big_sword, big_sword.getUnlocalizedName(), ERA.NEVER);
		
		//Test Armor
		EraRegistry.registerItem(test_helmet, test_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_chestplate, test_chestplate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_leggings, test_leggings.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_boots, test_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cape_test, cape_test.getUnlocalizedName(), ERA.NEVER);
		
		//Test Nuke
		EraRegistry.registerItem(test_nuke_igniter, test_nuke_igniter.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_propellant, test_nuke_propellant.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_tier1_shielding, test_nuke_tier1_shielding.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_tier2_shielding, test_nuke_tier2_shielding.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_tier1_bullet, test_nuke_tier1_bullet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_tier2_bullet, test_nuke_tier2_bullet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_tier1_target, test_nuke_tier1_target.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(test_nuke_tier2_target, test_nuke_tier2_target.getUnlocalizedName(), ERA.NEVER);

		//Ingots
		EraRegistry.registerItem(ingot_uranium, ingot_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_u233, ingot_u233.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_u235, ingot_u235.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_u238, ingot_u238.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_u238m2, ingot_u238m2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_th232, ingot_th232.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_plutonium, ingot_plutonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pu238, ingot_pu238.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pu239, ingot_pu239.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pu240, ingot_pu240.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pu241, ingot_pu241.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pu_mix, ingot_pu_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_am241, ingot_am241.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_am242, ingot_am242.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_am_mix, ingot_am_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_neptunium, ingot_neptunium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_polonium, ingot_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_technetium, ingot_technetium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_co60, ingot_co60.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_sr90, ingot_sr90.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_au198, ingot_au198.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pb209, ingot_pb209.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_ra226, ingot_ra226.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_titanium, ingot_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_copper, ingot_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_red_copper, ingot_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_advanced_alloy, ingot_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_tungsten, ingot_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_aluminium, ingot_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_steel, ingot_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_tcalloy, ingot_tcalloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_cdalloy, ingot_cdalloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_lead, ingot_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_bismuth, ingot_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_arsenic, ingot_arsenic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_calcium, ingot_calcium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_cadmium, ingot_cadmium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_tantalium, ingot_tantalium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_niobium, ingot_niobium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_beryllium, ingot_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_cobalt, ingot_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_boron, ingot_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_graphite, ingot_graphite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_firebrick, ingot_firebrick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_dura_steel, ingot_dura_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_polymer, ingot_polymer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_bakelite, ingot_bakelite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_rubber, ingot_rubber.getUnlocalizedName(), ERA.ALWAYS);
		//GameRegistry.registerItem(ingot_pet, ingot_pet.getUnlocalizedName());
		EraRegistry.registerItem(ingot_pc, ingot_pc.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_pvc, ingot_pvc.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_mud, ingot_mud.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_schraranium, ingot_schraranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_schrabidium, ingot_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_schrabidate, ingot_schrabidate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_magnetized_tungsten, ingot_magnetized_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_combine_steel, ingot_combine_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_solinium, ingot_solinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_gh336, ingot_gh336.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_uranium_fuel, ingot_uranium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_thorium_fuel, ingot_thorium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_plutonium_fuel, ingot_plutonium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_neptunium_fuel, ingot_neptunium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_mox_fuel, ingot_mox_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_americium_fuel, ingot_americium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_schrabidium_fuel, ingot_schrabidium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_hes, ingot_hes.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_les, ingot_les.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_australium, ingot_australium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_weidanium, ingot_weidanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_reiium, ingot_reiium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_unobtainium, ingot_unobtainium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_daffergon, ingot_daffergon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_verticium, ingot_verticium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_lanthanium, ingot_lanthanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_actinium, ingot_actinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_desh, ingot_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_ferrouranium, ingot_ferrouranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_starmetal, ingot_starmetal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_saturnite, ingot_saturnite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_euphemium, ingot_euphemium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ingot_dineutronium, ingot_dineutronium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ingot_electronium, ingot_electronium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_smore, ingot_smore.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ingot_osmiridium, ingot_osmiridium.getUnlocalizedName(), ERA.ALWAYS);

		//Meteorite Ingots
		EraRegistry.registerItem(ingot_steel_dusted, ingot_steel_dusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_chainsteel, ingot_chainsteel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_meteorite, ingot_meteorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_meteorite_forged, ingot_meteorite_forged.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(blade_meteorite, blade_meteorite.getUnlocalizedName(), ERA.ALWAYS);

		//Misc Ingots
		EraRegistry.registerItem(ingot_phosphorus, ingot_phosphorus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(lithium, lithium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_zirconium, ingot_zirconium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_semtex, ingot_semtex.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_c4, ingot_c4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(oil_tar, oil_tar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(solid_fuel, solid_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(solid_fuel_presto, solid_fuel_presto.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(solid_fuel_presto_triplet, solid_fuel_presto_triplet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(solid_fuel_bf, solid_fuel_bf.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(solid_fuel_presto_bf, solid_fuel_presto_bf.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(solid_fuel_presto_triplet_bf, solid_fuel_presto_triplet_bf.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(rocket_fuel, rocket_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_fiberglass, ingot_fiberglass.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_asbestos, ingot_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		
		//Billets
		EraRegistry.registerItem(billet_uranium, billet_uranium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_u233, billet_u233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_u235, billet_u235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_u238, billet_u238.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_th232, billet_th232.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_plutonium, billet_plutonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pu238, billet_pu238.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pu239, billet_pu239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pu240, billet_pu240.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pu241, billet_pu241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pu_mix, billet_pu_mix.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_am241, billet_am241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_am242, billet_am242.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_am_mix, billet_am_mix.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_neptunium, billet_neptunium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_polonium, billet_polonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_technetium, billet_technetium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_cobalt, billet_cobalt.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_co60, billet_co60.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_sr90, billet_sr90.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_au198, billet_au198.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pb209, billet_pb209.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_ra226, billet_ra226.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_actinium, billet_actinium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_schrabidium, billet_schrabidium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_solinium, billet_solinium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_gh336, billet_gh336.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_australium, billet_australium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_australium_lesser, billet_australium_lesser.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_australium_greater, billet_australium_greater.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_uranium_fuel, billet_uranium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_thorium_fuel, billet_thorium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_plutonium_fuel, billet_plutonium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_neptunium_fuel, billet_neptunium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_mox_fuel, billet_mox_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_americium_fuel, billet_americium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_les, billet_les.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_schrabidium_fuel, billet_schrabidium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_hes, billet_hes.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_po210be, billet_po210be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_ra226be, billet_ra226be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_pu238be, billet_pu238be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_beryllium, billet_beryllium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_bismuth, billet_bismuth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_zirconium, billet_zirconium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_zfb_bismuth, billet_zfb_bismuth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_zfb_pu241, billet_zfb_pu241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_zfb_am_mix, billet_zfb_am_mix.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_yharonite, billet_yharonite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(billet_balefire_gold, billet_balefire_gold.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(billet_flashlead, billet_flashlead.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(billet_nuclear_waste, billet_nuclear_waste.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Dusts & Other
		EraRegistry.registerItem(cinnebar, cinnebar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_mercury, nugget_mercury.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ingot_mercury, ingot_mercury.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bottle_mercury, bottle_mercury.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coke, coke.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(lignite, lignite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coal_infernal, coal_infernal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(briquette, briquette.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(sulfur, sulfur.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(niter, niter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluorite, fluorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_coal, powder_coal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_coal_tiny, powder_coal_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_iron, powder_iron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_gold, powder_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lapis, powder_lapis.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_quartz, powder_quartz.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_diamond, powder_diamond.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_emerald, powder_emerald.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_uranium, powder_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_plutonium, powder_plutonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_neptunium, powder_neptunium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_polonium, powder_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_co60, powder_co60.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_sr90, powder_sr90.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_sr90_tiny, powder_sr90_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_i131, powder_i131.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_i131_tiny, powder_i131_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_xe135, powder_xe135.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_xe135_tiny, powder_xe135_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cs137, powder_cs137.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cs137_tiny, powder_cs137_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_au198, powder_au198.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_ra226, powder_ra226.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_at209, powder_at209.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_titanium, powder_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_copper, powder_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_red_copper, powder_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_advanced_alloy, powder_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_tungsten, powder_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_aluminium, powder_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_steel, powder_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_steel_tiny, powder_steel_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_tcalloy, powder_tcalloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lead, powder_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_bismuth, powder_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_calcium, powder_calcium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cadmium, powder_cadmium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_coltan_ore, powder_coltan_ore.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_coltan, powder_coltan.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_tantalium, powder_tantalium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_tektite, powder_tektite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_paleogenite, powder_paleogenite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_paleogenite_tiny, powder_paleogenite_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_impure_osmiridium, powder_impure_osmiridium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_borax, powder_borax.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_yellowcake, powder_yellowcake.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_beryllium, powder_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_dura_steel, powder_dura_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_polymer, powder_polymer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_bakelite, powder_bakelite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_schrabidium, powder_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_schrabidate, powder_schrabidate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_magnetized_tungsten, powder_magnetized_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_chlorophyte, powder_chlorophyte.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_combine_steel, powder_combine_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lithium, powder_lithium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lithium_tiny, powder_lithium_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_zirconium, powder_zirconium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lignite, powder_lignite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_iodine, powder_iodine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_thorium, powder_thorium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_neodymium, powder_neodymium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_neodymium_tiny, powder_neodymium_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_astatine, powder_astatine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_caesium, powder_caesium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_australium, powder_australium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_weidanium, powder_weidanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_reiium, powder_reiium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_unobtainium, powder_unobtainium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_daffergon, powder_daffergon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_verticium, powder_verticium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_strontium, powder_strontium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cobalt, powder_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cobalt_tiny, powder_cobalt_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_bromine, powder_bromine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_niobium, powder_niobium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_niobium_tiny, powder_niobium_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_tennessine, powder_tennessine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cerium, powder_cerium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cerium_tiny, powder_cerium_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lanthanium, powder_lanthanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_lanthanium_tiny, powder_lanthanium_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_actinium, powder_actinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_actinium_tiny, powder_actinium_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_boron, powder_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_boron_tiny, powder_boron_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_asbestos, powder_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_magic, powder_magic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_cloud, powder_cloud.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_sawdust, powder_sawdust.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_flux, powder_flux.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_fertilizer, powder_fertilizer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_balefire, powder_balefire.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(powder_semtex_mix, powder_semtex_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_desh_mix, powder_desh_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_desh_ready, powder_desh_ready.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_desh, powder_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_nitan_mix, powder_nitan_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_spark_mix, powder_spark_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_meteorite, powder_meteorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_meteorite_tiny, powder_meteorite_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_euphemium, powder_euphemium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_dineutronium, powder_dineutronium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(redstone_depleted, redstone_depleted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(dust, dust.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(dust_tiny, dust_tiny.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fallout, fallout.getUnlocalizedName(), ERA.ALWAYS);
		
		//Powders
		EraRegistry.registerItem(powder_fire, powder_fire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_ice, powder_ice.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_poison, powder_poison.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_thermite, powder_thermite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(powder_power, powder_power.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cordite, cordite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ballistite, ballistite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ball_dynamite, ball_dynamite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ball_tnt, ball_tnt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ball_tatb, ball_tatb.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ball_fireclay, ball_fireclay.getUnlocalizedName(), ERA.ALWAYS);
		
		//Ores
		EraRegistry.registerItem(ore_bedrock, ore_bedrock.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_centrifuged, ore_centrifuged.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_cleaned, ore_cleaned.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_separated, ore_separated.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_purified, ore_purified.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_nitrated, ore_nitrated.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_nitrocrystalline, ore_nitrocrystalline.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_deepcleaned, ore_deepcleaned.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_seared, ore_seared.getUnlocalizedName(), ERA.ALWAYS);
		//EraRegistry.registerItem(ore_radcleaned, ore_radcleaned.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_enriched, ore_enriched.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ore_byproduct, ore_byproduct.getUnlocalizedName(), ERA.ALWAYS);
		
		//Crystals
		EraRegistry.registerItem(crystal_coal, crystal_coal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_iron, crystal_iron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_gold, crystal_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_redstone, crystal_redstone.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_lapis, crystal_lapis.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_diamond, crystal_diamond.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_uranium, crystal_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_thorium, crystal_thorium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_plutonium, crystal_plutonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_titanium, crystal_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_sulfur, crystal_sulfur.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_niter, crystal_niter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_copper, crystal_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_tungsten, crystal_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_aluminium, crystal_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_fluorite, crystal_fluorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_beryllium, crystal_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_lead, crystal_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_schraranium, crystal_schraranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_schrabidium, crystal_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_rare, crystal_rare.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_phosphorus, crystal_phosphorus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_lithium, crystal_lithium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_cobalt, crystal_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_starmetal, crystal_starmetal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_cinnebar, crystal_cinnebar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_trixite, crystal_trixite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crystal_osmiridium, crystal_osmiridium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gem_tantalium, gem_tantalium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gem_volcanic, gem_volcanic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gem_alexandrite, gem_alexandrite.getUnlocalizedName(), ERA.ALWAYS);
		
		//Fragments
		EraRegistry.registerItem(fragment_neodymium, fragment_neodymium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_cobalt, fragment_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_niobium, fragment_niobium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_cerium, fragment_cerium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_lanthanium, fragment_lanthanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_actinium, fragment_actinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_boron, fragment_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_meteorite, fragment_meteorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fragment_coltan, fragment_coltan.getUnlocalizedName(), ERA.ALWAYS);
		
		//Things that look like rotten flesh but aren't
		EraRegistry.registerItem(biomass, biomass.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(biomass_compressed, biomass_compressed.getUnlocalizedName(), ERA.ALWAYS);
		//delicious!
		EraRegistry.registerItem(bio_wafer, bio_wafer.getUnlocalizedName(), ERA.ALWAYS);

		//Nuggets
		EraRegistry.registerItem(nugget_uranium, nugget_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_u233, nugget_u233.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_u235, nugget_u235.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_u238, nugget_u238.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_th232, nugget_th232.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_plutonium, nugget_plutonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_pu238, nugget_pu238.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_pu239, nugget_pu239.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_pu240, nugget_pu240.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_pu241, nugget_pu241.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_pu_mix, nugget_pu_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_am241, nugget_am241.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_am242, nugget_am242.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_am_mix, nugget_am_mix.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_neptunium, nugget_neptunium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_polonium, nugget_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_cobalt, nugget_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_co60, nugget_co60.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_sr90, nugget_sr90.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_technetium, nugget_technetium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_au198, nugget_au198.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_pb209, nugget_pb209.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_ra226, nugget_ra226.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_actinium, nugget_actinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_lead, nugget_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_bismuth, nugget_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_arsenic, nugget_arsenic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_tantalium, nugget_tantalium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_beryllium, nugget_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_schrabidium, nugget_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_solinium, nugget_solinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_gh336, nugget_gh336.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_uranium_fuel, nugget_uranium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_thorium_fuel, nugget_thorium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_plutonium_fuel, nugget_plutonium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_neptunium_fuel, nugget_neptunium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_mox_fuel, nugget_mox_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_americium_fuel, nugget_americium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_schrabidium_fuel, nugget_schrabidium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_hes, nugget_hes.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_les, nugget_les.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_zirconium, nugget_zirconium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_australium, nugget_australium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_australium_lesser, nugget_australium_lesser.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_australium_greater, nugget_australium_greater.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_weidanium, nugget_weidanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_reiium, nugget_reiium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_unobtainium, nugget_unobtainium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_daffergon, nugget_daffergon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_verticium, nugget_verticium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_desh, nugget_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_euphemium, nugget_euphemium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_dineutronium, nugget_dineutronium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nugget_osmiridium, nugget_osmiridium.getUnlocalizedName(), ERA.ALWAYS);

		//Plates
		EraRegistry.registerItem(plate_iron, plate_iron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_gold, plate_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_titanium, plate_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_aluminium, plate_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_steel, plate_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_lead, plate_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_copper, plate_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_advanced_alloy, plate_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(neutron_reflector, neutron_reflector.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_schrabidium, plate_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_combine_steel, plate_combine_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_mixed, plate_mixed.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_saturnite, plate_saturnite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_paa, plate_paa.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_polymer, plate_polymer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_kevlar, plate_kevlar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_dalekanium, plate_dalekanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_desh, plate_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_bismuth, plate_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_euphemium, plate_euphemium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_dineutronium, plate_dineutronium.getUnlocalizedName(), ERA.ALWAYS);
		
		//Armor Plates
		EraRegistry.registerItem(plate_armor_titanium, plate_armor_titanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(plate_armor_ajr, plate_armor_ajr.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(plate_armor_hev, plate_armor_hev.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(plate_armor_lunar, plate_armor_lunar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(plate_armor_fau, plate_armor_fau.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(plate_armor_dnt, plate_armor_dnt.getUnlocalizedName(), ERA.NEVER);
		
		//Heavy/Cast Plate
		EraRegistry.registerItem(plate_cast, plate_cast.getUnlocalizedName(), ERA.ALWAYS);
		
		//Boards
		EraRegistry.registerItem(board_copper, board_copper.getUnlocalizedName(), ERA.ALWAYS);
		
		//Bolts
		EraRegistry.registerItem(bolt_dura_steel, bolt_dura_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bolt_tungsten, bolt_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bolt_compound, bolt_compound.getUnlocalizedName(), ERA.ALWAYS);
		
		//Cloth
		EraRegistry.registerItem(hazmat_cloth, hazmat_cloth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(hazmat_cloth_red, hazmat_cloth_red.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(hazmat_cloth_grey, hazmat_cloth_grey.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(asbestos_cloth, asbestos_cloth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rag, rag.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rag_damp, rag_damp.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rag_piss, rag_piss.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(filter_coal, filter_coal.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Wires
		EraRegistry.registerItem(wire_aluminium, wire_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_copper, wire_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_tungsten, wire_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_red_copper, wire_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_advanced_alloy, wire_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_gold, wire_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_schrabidium, wire_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wire_magnetized_tungsten, wire_magnetized_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		
		//Parts
		EraRegistry.registerItem(coil_copper, coil_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_copper_torus, coil_copper_torus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_advanced_alloy, coil_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_advanced_torus, coil_advanced_torus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_gold, coil_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_gold_torus, coil_gold_torus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_tungsten, coil_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(coil_magnetized_tungsten, coil_magnetized_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(safety_fuse, safety_fuse.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(tank_steel, tank_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(motor, motor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(motor_desh, motor_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(centrifuge_element, centrifuge_element.getUnlocalizedName(), ERA.ALWAYS);
		//EraRegistry.registerItem(centrifuge_tower, centrifuge_tower.getUnlocalizedName());
		//EraRegistry.registerItem(magnet_dee, magnet_dee.getUnlocalizedName());
		EraRegistry.registerItem(magnet_circular, magnet_circular.getUnlocalizedName(), ERA.ALWAYS);
		//EraRegistry.registerItem(cyclotron_tower, cyclotron_tower.getUnlocalizedName());
		EraRegistry.registerItem(reactor_core, reactor_core.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(rtg_unit, rtg_unit.getUnlocalizedName(), ERA.ALWAYS);
		//EraRegistry.registerItem(thermo_unit_empty, thermo_unit_empty.getUnlocalizedName());
		//EraRegistry.registerItem(thermo_unit_endo, thermo_unit_endo.getUnlocalizedName());
		//EraRegistry.registerItem(thermo_unit_exo, thermo_unit_exo.getUnlocalizedName());
		EraRegistry.registerItem(levitation_unit, levitation_unit.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(pipes_steel, pipes_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(drill_titanium, drill_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(photo_panel, photo_panel.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(chlorine_pinwheel, chlorine_pinwheel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ring_starmetal, ring_starmetal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(deuterium_filter, deuterium_filter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chemical_dye, chemical_dye.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crayon, crayon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(part_generic, part_generic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(parts_legendary, parts_legendary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gear_large, gear_large.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(sawblade, sawblade.getUnlocalizedName(), ERA.ALWAYS);
		
		//Plant Products
		EraRegistry.registerItem(plant_item, plant_item.getUnlocalizedName(), ERA.ALWAYS);
		
		//Teleporter Parts
		//EraRegistry.registerItem(telepad, telepad.getUnlocalizedName());
		EraRegistry.registerItem(entanglement_kit, entanglement_kit.getUnlocalizedName(), ERA.COLDWAR);
		
		//AMS Parts
		EraRegistry.registerItem(component_limiter, component_limiter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(component_emitter, component_emitter.getUnlocalizedName(), ERA.COLDWAR);
		
		//Bomb Parts
		EraRegistry.registerItem(hull_small_steel, hull_small_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(hull_small_aluminium, hull_small_aluminium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(hull_big_steel, hull_big_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(hull_big_aluminium, hull_big_aluminium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(hull_big_titanium, hull_big_titanium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(fins_flat, fins_flat.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(fins_small_steel, fins_small_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(fins_big_steel, fins_big_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(fins_tri_steel, fins_tri_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(fins_quad_titanium, fins_quad_titanium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(sphere_steel, sphere_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pedestal_steel, pedestal_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(dysfunctional_reactor, dysfunctional_reactor.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rotor_steel, rotor_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(generator_steel, generator_steel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(blade_titanium, blade_titanium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(blade_tungsten, blade_tungsten.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(turbine_titanium, turbine_titanium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(turbine_tungsten, turbine_tungsten.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(flywheel_beryllium, flywheel_beryllium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(generator_front, generator_front.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(toothpicks, toothpicks.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ducttape, ducttape.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(catalyst_clay, catalyst_clay.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(missile_assembly, missile_assembly.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_generic_small, warhead_generic_small.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_generic_medium, warhead_generic_medium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_generic_large, warhead_generic_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_incendiary_small, warhead_incendiary_small.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_incendiary_medium, warhead_incendiary_medium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_incendiary_large, warhead_incendiary_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_cluster_small, warhead_cluster_small.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_cluster_medium, warhead_cluster_medium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_cluster_large, warhead_cluster_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_buster_small, warhead_buster_small.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_buster_medium, warhead_buster_medium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_buster_large, warhead_buster_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_nuclear, warhead_nuclear.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_mirvlet, warhead_mirvlet.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_mirv, warhead_mirv.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_volcano, warhead_volcano.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_thermo_endo, warhead_thermo_endo.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(warhead_thermo_exo, warhead_thermo_exo.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fuel_tank_small, fuel_tank_small.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fuel_tank_medium, fuel_tank_medium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fuel_tank_large, fuel_tank_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(thruster_small, thruster_small.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(thruster_medium, thruster_medium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(thruster_large, thruster_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(thruster_nuclear, thruster_nuclear.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_base, sat_base.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_head_mapper, sat_head_mapper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_head_scanner, sat_head_scanner.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_head_radar, sat_head_radar.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_head_laser, sat_head_laser.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_head_resonator, sat_head_resonator.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(seg_10, seg_10.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(seg_15, seg_15.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(seg_20, seg_20.getUnlocalizedName(), ERA.COLDWAR);
		
		//Chopper parts
		EraRegistry.registerItem(chopper_head, chopper_head.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(chopper_gun, chopper_gun.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(chopper_torso, chopper_torso.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(chopper_tail, chopper_tail.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(chopper_wing, chopper_wing.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(chopper_blades, chopper_blades.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(combine_scrap, combine_scrap.getUnlocalizedName(), ERA.COLDWAR);
		
		//Hammer Parts
		EraRegistry.registerItem(shimmer_head, shimmer_head.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(shimmer_axe_head, shimmer_axe_head.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(shimmer_handle, shimmer_handle.getUnlocalizedName(), ERA.NEVER);
		
		//Circuits
		EraRegistry.registerItem(circuit_raw, circuit_raw.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_aluminium, circuit_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_copper, circuit_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_red_copper, circuit_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_gold, circuit_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_schrabidium, circuit_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_bismuth_raw, circuit_bismuth_raw.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_bismuth, circuit_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_arsenic_raw, circuit_arsenic_raw.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_arsenic, circuit_arsenic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_tantalium_raw, circuit_tantalium_raw.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_tantalium, circuit_tantalium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crt_display, crt_display.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_star_piece, circuit_star_piece.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_star_component, circuit_star_component.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_star, circuit_star.getUnlocalizedName(), ERA.ALWAYS);
		
		//Military Circuits
		EraRegistry.registerItem(circuit_targeting_tier1, circuit_targeting_tier1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_targeting_tier2, circuit_targeting_tier2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_targeting_tier3, circuit_targeting_tier3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_targeting_tier4, circuit_targeting_tier4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_targeting_tier5, circuit_targeting_tier5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(circuit_targeting_tier6, circuit_targeting_tier6.getUnlocalizedName(), ERA.COLDWAR);
		
		//Gun Mechanisms
		EraRegistry.registerItem(mechanism_revolver_1, mechanism_revolver_1.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mechanism_revolver_2, mechanism_revolver_2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mechanism_rifle_1, mechanism_rifle_1.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mechanism_rifle_2, mechanism_rifle_2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mechanism_launcher_1, mechanism_launcher_1.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mechanism_launcher_2, mechanism_launcher_2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mechanism_special, mechanism_special.getUnlocalizedName(), ERA.NEVER);
		
		//Primers
		EraRegistry.registerItem(primer_357, primer_357.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(primer_44, primer_44.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(primer_9, primer_9.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(primer_50, primer_50.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(primer_buckshot, primer_buckshot.getUnlocalizedName(), ERA.COLDWAR);
		
		//Casings
		EraRegistry.registerItem(casing_357, casing_357.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(casing_44, casing_44.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(casing_9, casing_9.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(casing_50, casing_50.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(casing_buckshot, casing_buckshot.getUnlocalizedName(), ERA.COLDWAR);
		
		//Bullet Assemblies
		EraRegistry.registerItem(assembly_iron, assembly_iron.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_steel, assembly_steel.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_lead, assembly_lead.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_gold, assembly_gold.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_schrabidium, assembly_schrabidium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_nightmare, assembly_nightmare.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_desh, assembly_desh.getUnlocalizedName(), ERA.COLDWAR);
		//EraRegistry.registerItem(assembly_pip, assembly_pip.getUnlocalizedName());
		EraRegistry.registerItem(assembly_nopip, assembly_nopip.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_smg, assembly_smg.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_556, assembly_556.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_762, assembly_762.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_45, assembly_45.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_uzi, assembly_uzi.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_lacunae, assembly_lacunae.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_actionexpress, assembly_actionexpress.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_calamity, assembly_calamity.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_nuke, assembly_nuke.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(assembly_luna, assembly_luna.getUnlocalizedName(), ERA.COLDWAR);
		
		//Folly Parts
		EraRegistry.registerItem(folly_shell, folly_shell.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(folly_bullet, folly_bullet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(folly_bullet_nuclear, folly_bullet_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(folly_bullet_du, folly_bullet_du.getUnlocalizedName(), ERA.NEVER);
		
		//Wiring
		EraRegistry.registerItem(wiring_red_copper, wiring_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		
		//Flame War in a Box
		EraRegistry.registerItem(flame_pony, flame_pony.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(flame_conspiracy, flame_conspiracy.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(flame_politics, flame_politics.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(flame_opinion, flame_opinion.getUnlocalizedName(), ERA.NEVER);
		
		//Pellets
		EraRegistry.registerItem(pellet_rtg_radium, pellet_rtg_radium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_weak, pellet_rtg_weak.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg, pellet_rtg.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_strontium, pellet_rtg_strontium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_cobalt, pellet_rtg_cobalt.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_actinium, pellet_rtg_actinium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_polonium, pellet_rtg_polonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_americium, pellet_rtg_americium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_berkelium, pellet_rtg_berkelium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_gold, pellet_rtg_gold.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_lead, pellet_rtg_lead.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_rtg_depleted, pellet_rtg_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(tritium_deuterium_cake, tritium_deuterium_cake.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(pellet_cluster, pellet_cluster.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_buckshot, pellet_buckshot.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_flechette, pellet_flechette.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_chlorophyte, pellet_chlorophyte.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_mercury, pellet_mercury.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_meteorite, pellet_meteorite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_canister, pellet_canister.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_claws, pellet_claws.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_charged, pellet_charged.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pellet_gas, pellet_gas.getUnlocalizedName(), ERA.SECONDWORLDWAR);

		EraRegistry.registerItem(magnetron, magnetron.getUnlocalizedName(), ERA.ALWAYS);

		EraRegistry.registerItem(pellet_coal, pellet_coal.getUnlocalizedName(), ERA.ALWAYS);
		
		//Watz Pellets
		EraRegistry.registerItem(pellet_schrabidium, pellet_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_hes, pellet_hes.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_mes, pellet_mes.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_les, pellet_les.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_beryllium, pellet_beryllium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_neptunium, pellet_neptunium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_lead, pellet_lead.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pellet_advanced, pellet_advanced.getUnlocalizedName(), ERA.NEVER);
		
		//Engine Pieces
		EraRegistry.registerItem(piston_selenium, piston_selenium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(piston_set, piston_set.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(drillbit, drillbit.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Cells
		EraRegistry.registerItem(cell_empty, cell_empty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(cell_uf6, cell_uf6.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(cell_puf6, cell_puf6.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(cell_deuterium, cell_deuterium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(cell_tritium, cell_tritium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(cell_sas3, cell_sas3.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cell_antimatter, cell_antimatter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cell_anti_schrabidium, cell_anti_schrabidium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cell_balefire, cell_balefire.getUnlocalizedName(), ERA.COLDWAR);

		//DEMON CORE
		EraRegistry.registerItem(demon_core_open, demon_core_open.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(demon_core_closed, demon_core_closed.getUnlocalizedName(), ERA.NEVER);
		
		//Particle Containers
		EraRegistry.registerItem(particle_empty, particle_empty.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_hydrogen, particle_hydrogen.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_copper, particle_copper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_lead, particle_lead.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_aproton, particle_aproton.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_aelectron, particle_aelectron.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_amat, particle_amat.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_aschrab, particle_aschrab.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_higgs, particle_higgs.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_muon, particle_muon.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_tachyon, particle_tachyon.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_strange, particle_strange.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_dark, particle_dark.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_sparkticle, particle_sparkticle.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_digamma, particle_digamma.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(particle_lutece, particle_lutece.getUnlocalizedName(), ERA.COLDWAR);
		
		//Singularities, black holes and other cosmic horrors
		EraRegistry.registerItem(singularity_micro, singularity_micro.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(singularity, singularity.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(singularity_counter_resonant, singularity_counter_resonant.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(singularity_super_heated, singularity_super_heated.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(black_hole, black_hole.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(singularity_spark, singularity_spark.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(crystal_xen, crystal_xen.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(pellet_antimatter, pellet_antimatter.getUnlocalizedName(), ERA.COLDWAR);
		
		//Infinite Tanks
		EraRegistry.registerItem(inf_water, inf_water.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(inf_water_mk2, inf_water_mk2.getUnlocalizedName(), ERA.ALWAYS);
		
		//Canisters
		EraRegistry.registerItem(antiknock, antiknock.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(canister_empty, canister_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(canister_full, canister_full.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(canister_napalm, canister_napalm.getUnlocalizedName(), ERA.ALWAYS);
		
		//Gas Tanks
		EraRegistry.registerItem(gas_empty, gas_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_full, gas_full.getUnlocalizedName(), ERA.ALWAYS);
		
		//Universal Tank
		EraRegistry.registerItem(fluid_tank_empty, fluid_tank_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_tank_full, fluid_tank_full.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_tank_lead_empty, fluid_tank_lead_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_tank_lead_full, fluid_tank_lead_full.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_barrel_empty, fluid_barrel_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_barrel_full, fluid_barrel_full.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_barrel_infinite, fluid_barrel_infinite.getUnlocalizedName(), ERA.ALWAYS);
		
		//Batteries
		EraRegistry.registerItem(battery_generic, battery_generic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_red_cell, battery_red_cell.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_red_cell_6, battery_red_cell_6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_red_cell_24, battery_red_cell_24.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_advanced, battery_advanced.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_advanced_cell, battery_advanced_cell.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_advanced_cell_4, battery_advanced_cell_4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_advanced_cell_12, battery_advanced_cell_12.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_lithium, battery_lithium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_lithium_cell, battery_lithium_cell.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_lithium_cell_3, battery_lithium_cell_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_lithium_cell_6, battery_lithium_cell_6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_schrabidium, battery_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_schrabidium_cell, battery_schrabidium_cell.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_schrabidium_cell_2, battery_schrabidium_cell_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_schrabidium_cell_4, battery_schrabidium_cell_4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_spark, battery_spark.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_trixite, battery_trixite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_spark_cell_6, battery_spark_cell_6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_spark_cell_25, battery_spark_cell_25.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_spark_cell_100, battery_spark_cell_100.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_spark_cell_1000, battery_spark_cell_1000.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(battery_spark_cell_2500, battery_spark_cell_2500.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(battery_spark_cell_10000, battery_spark_cell_10000.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(battery_spark_cell_power, battery_spark_cell_power.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cube_power, cube_power.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_creative, battery_creative.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_su, battery_su.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_su_l, battery_su_l.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_potato, battery_potato.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_potatos, battery_potatos.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(battery_steam, battery_steam.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_steam_large, battery_steam_large.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_uranium, battery_sc_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_technetium, battery_sc_technetium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_plutonium, battery_sc_plutonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_polonium, battery_sc_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_gold, battery_sc_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_lead, battery_sc_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(battery_sc_americium, battery_sc_americium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hev_battery, hev_battery.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fusion_core, fusion_core.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(energy_core, energy_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fusion_core_infinite, fusion_core_infinite.getUnlocalizedName(), ERA.ALWAYS);
		
		//Folders
		EraRegistry.registerItem(template_folder, template_folder.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(journal_pip, journal_pip.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(journal_bj, journal_bj.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(journal_silver, journal_silver.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bobmazon_materials, bobmazon_materials.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bobmazon_machines, bobmazon_machines.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bobmazon_weapons, bobmazon_weapons.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bobmazon_tools, bobmazon_tools.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bobmazon_hidden, bobmazon_hidden.getUnlocalizedName(), ERA.NEVER);
		
		//Hydraulic Press Stamps
		EraRegistry.registerItem(stamp_stone_flat, stamp_stone_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_stone_plate, stamp_stone_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_stone_wire, stamp_stone_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_stone_circuit, stamp_stone_circuit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_iron_flat, stamp_iron_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_iron_plate, stamp_iron_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_iron_wire, stamp_iron_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_iron_circuit, stamp_iron_circuit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_steel_flat, stamp_steel_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_steel_plate, stamp_steel_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_steel_wire, stamp_steel_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_steel_circuit, stamp_steel_circuit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_titanium_flat, stamp_titanium_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_titanium_plate, stamp_titanium_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_titanium_wire, stamp_titanium_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_titanium_circuit, stamp_titanium_circuit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_obsidian_flat, stamp_obsidian_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_obsidian_plate, stamp_obsidian_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_obsidian_wire, stamp_obsidian_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_obsidian_circuit, stamp_obsidian_circuit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_desh_flat, stamp_desh_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_desh_plate, stamp_desh_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_desh_wire, stamp_desh_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_desh_circuit, stamp_desh_circuit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_357, stamp_357.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_44, stamp_44.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(stamp_9, stamp_9.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stamp_50, stamp_50.getUnlocalizedName(), ERA.ALWAYS);
		
		//Molds
		EraRegistry.registerItem(mold_base, mold_base.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(mold, mold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(scraps, scraps.getUnlocalizedName(), ERA.ALWAYS);
		
		//Machine Upgrades
		EraRegistry.registerItem(upgrade_template, upgrade_template.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_speed_1, upgrade_speed_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_speed_2, upgrade_speed_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_speed_3, upgrade_speed_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_effect_1, upgrade_effect_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_effect_2, upgrade_effect_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_effect_3, upgrade_effect_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_power_1, upgrade_power_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_power_2, upgrade_power_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_power_3, upgrade_power_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_fortune_1, upgrade_fortune_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_fortune_2, upgrade_fortune_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_fortune_3, upgrade_fortune_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_afterburn_1, upgrade_afterburn_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_afterburn_2, upgrade_afterburn_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_afterburn_3, upgrade_afterburn_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_overdrive_1, upgrade_overdrive_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_overdrive_2, upgrade_overdrive_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_overdrive_3, upgrade_overdrive_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_radius, upgrade_radius.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_health, upgrade_health.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_smelter, upgrade_smelter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_shredder, upgrade_shredder.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_centrifuge, upgrade_centrifuge.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_crystallizer, upgrade_crystallizer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_nullifier, upgrade_nullifier.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_screm, upgrade_screm.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(upgrade_gc_speed, upgrade_gc_speed.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_5g, upgrade_5g.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_stack, upgrade_stack.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(upgrade_ejector, upgrade_ejector.getUnlocalizedName(), ERA.ALWAYS);
		
		//Machine Templates
		EraRegistry.registerItem(siren_track, siren_track.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_identifier, fluid_identifier.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_identifier_multi, fluid_identifier_multi.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_icon, fluid_icon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fluid_duct, fluid_duct.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(assembly_template, assembly_template.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chemistry_template, chemistry_template.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chemistry_icon, chemistry_icon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crucible_template, crucible_template.getUnlocalizedName(), ERA.ALWAYS);
		
		//Machine Items
		EraRegistry.registerItem(fuse, fuse.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(redcoil_capacitor, redcoil_capacitor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(titanium_filter, titanium_filter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(screwdriver, screwdriver.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(screwdriver_desh, screwdriver_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hand_drill, hand_drill.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hand_drill_desh, hand_drill_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chemistry_set, chemistry_set.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chemistry_set_boron, chemistry_set_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(blowtorch, blowtorch.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(acetylene_torch, acetylene_torch.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(boltgun, boltgun.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(overfuse, overfuse.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(arc_electrode, arc_electrode.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(arc_electrode_burnt, arc_electrode_burnt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(arc_electrode_desh, arc_electrode_desh.getUnlocalizedName(), ERA.ALWAYS);
		
		//Particle Collider Fuel
		EraRegistry.registerItem(part_lithium, part_lithium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(part_beryllium, part_beryllium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(part_carbon, part_carbon.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(part_copper, part_copper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(part_plutonium, part_plutonium.getUnlocalizedName(), ERA.COLDWAR);
		
		//FEL laser crystals
		EraRegistry.registerItem(laser_crystal_co2, laser_crystal_co2.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(laser_crystal_bismuth, laser_crystal_bismuth.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(laser_crystal_cmb, laser_crystal_cmb.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(laser_crystal_dnt, laser_crystal_dnt.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(laser_crystal_digamma, laser_crystal_digamma.getUnlocalizedName(), ERA.COLDWAR);
		
		//Recycled Units
		EraRegistry.registerItem(recycled_ground, recycled_ground.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_rock, recycled_rock.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_metal, recycled_metal.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_refined, recycled_refined.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_organic, recycled_organic.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_crystal, recycled_crystal.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_explosive, recycled_explosive.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_electronic, recycled_electronic.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_nuclear, recycled_nuclear.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(recycled_misc, recycled_misc.getUnlocalizedName(), ERA.COLDWAR);
		
		//Catalyst Rune Sigils
		EraRegistry.registerItem(rune_blank, rune_blank.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rune_isa, rune_isa.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rune_dagaz, rune_dagaz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rune_hagalaz, rune_hagalaz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rune_jera, rune_jera.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rune_thurisaz, rune_thurisaz.getUnlocalizedName(), ERA.COLDWAR);
		
		//AMS Catalysts
		EraRegistry.registerItem(ams_catalyst_blank, ams_catalyst_blank.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_aluminium, ams_catalyst_aluminium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_beryllium, ams_catalyst_beryllium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_caesium, ams_catalyst_caesium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_cerium, ams_catalyst_cerium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_cobalt, ams_catalyst_cobalt.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_copper, ams_catalyst_copper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_euphemium, ams_catalyst_euphemium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_dineutronium, ams_catalyst_dineutronium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_iron, ams_catalyst_iron.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_lithium, ams_catalyst_lithium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_niobium, ams_catalyst_niobium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_schrabidium, ams_catalyst_schrabidium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_strontium, ams_catalyst_strontium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_thorium, ams_catalyst_thorium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_catalyst_tungsten, ams_catalyst_tungsten.getUnlocalizedName(), ERA.COLDWAR);
		
		//Shredder Blades
		EraRegistry.registerItem(blades_steel, blades_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(blades_titanium, blades_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(blades_advanced_alloy, blades_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(blades_desh, blades_desh.getUnlocalizedName(), ERA.ALWAYS);
		
		//Generator Stuff
		EraRegistry.registerItem(thermo_element, thermo_element.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(catalytic_converter, catalytic_converter.getUnlocalizedName(), ERA.ALWAYS);
		
		//AMS Components
		EraRegistry.registerItem(ams_focus_blank, ams_focus_blank.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_focus_limiter, ams_focus_limiter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_focus_booster, ams_focus_booster.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_muzzle, ams_muzzle.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_lens, ams_lens.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_core_sing, ams_core_sing.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_core_wormhole, ams_core_wormhole.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_core_eyeofharmony, ams_core_eyeofharmony.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ams_core_thingy, ams_core_thingy.getUnlocalizedName(), ERA.COLDWAR);
		
		//Fusion Shields
		EraRegistry.registerItem(fusion_shield_tungsten, fusion_shield_tungsten.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fusion_shield_desh, fusion_shield_desh.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fusion_shield_chlorophyte, fusion_shield_chlorophyte.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fusion_shield_vaporwave, fusion_shield_vaporwave.getUnlocalizedName(), ERA.COLDWAR);
		
		//Breeding Rods
		EraRegistry.registerItem(rod_empty, rod_empty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod, rod.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_dual_empty, rod_dual_empty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_dual, rod_dual.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_quad_empty, rod_quad_empty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_quad, rod_quad.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//ZIRNOX parts
		EraRegistry.registerItem(rod_zirnox_empty, rod_zirnox_empty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		//EraRegistry.registerItem(rod_zirnox_natural_uranium_fuel, rod_zirnox_natural_uranium_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_uranium_fuel, rod_zirnox_uranium_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_th232, rod_zirnox_th232.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_thorium_fuel, rod_zirnox_thorium_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_mox_fuel, rod_zirnox_mox_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_plutonium_fuel, rod_zirnox_plutonium_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_u233_fuel, rod_zirnox_u233_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_u235_fuel, rod_zirnox_u235_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_les_fuel, rod_zirnox_les_fuel.getUnlocalizedName());
		//EraRegistry.registerItem(rod_zirnox_lithium, rod_zirnox_lithium.getUnlocalizedName());
		EraRegistry.registerItem(rod_zirnox_tritium, rod_zirnox_tritium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		//EraRegistry.registerItem(rod_zirnox_zfb_mox, rod_zirnox_zfb_mox.getUnlocalizedName());
		EraRegistry.registerItem(rod_zirnox, rod_zirnox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		EraRegistry.registerItem(rod_zirnox_natural_uranium_fuel_depleted, rod_zirnox_natural_uranium_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_uranium_fuel_depleted, rod_zirnox_uranium_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_thorium_fuel_depleted, rod_zirnox_thorium_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_mox_fuel_depleted, rod_zirnox_mox_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_plutonium_fuel_depleted, rod_zirnox_plutonium_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_u233_fuel_depleted, rod_zirnox_u233_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_u235_fuel_depleted, rod_zirnox_u235_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_les_fuel_depleted, rod_zirnox_les_fuel_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rod_zirnox_zfb_mox_depleted, rod_zirnox_zfb_mox_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Depleted Fuel
		EraRegistry.registerItem(waste_natural_uranium, waste_natural_uranium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_uranium, waste_uranium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_thorium, waste_thorium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_mox, waste_mox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plutonium, waste_plutonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_u233, waste_u233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_u235, waste_u235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_schrabidium, waste_schrabidium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_zfb_mox, waste_zfb_mox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		EraRegistry.registerItem(waste_plate_u233, waste_plate_u233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plate_u235, waste_plate_u235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plate_mox, waste_plate_mox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plate_pu239, waste_plate_pu239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plate_ra226be, waste_plate_ra226be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plate_sa326, waste_plate_sa326.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(waste_plate_pu238be, waste_plate_pu238be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Pile parts
		EraRegistry.registerItem(pile_rod_uranium, pile_rod_uranium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pile_rod_pu239, pile_rod_pu239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pile_rod_plutonium, pile_rod_plutonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pile_rod_source, pile_rod_source.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pile_rod_boron, pile_rod_boron.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pile_rod_lithium, pile_rod_lithium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(pile_rod_detector, pile_rod_detector.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Plate Fuels
		EraRegistry.registerItem(plate_fuel_u233, plate_fuel_u233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(plate_fuel_u235, plate_fuel_u235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(plate_fuel_mox, plate_fuel_mox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(plate_fuel_pu239, plate_fuel_pu239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(plate_fuel_sa326, plate_fuel_sa326.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(plate_fuel_ra226be, plate_fuel_ra226be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(plate_fuel_pu238be, plate_fuel_pu238be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//RBMK parts
		EraRegistry.registerItem(rbmk_lid, rbmk_lid.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_lid_glass, rbmk_lid_glass.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_empty, rbmk_fuel_empty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_ueu, rbmk_fuel_ueu.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_meu, rbmk_fuel_meu.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_heu233, rbmk_fuel_heu233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_heu235, rbmk_fuel_heu235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_thmeu, rbmk_fuel_thmeu.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_lep, rbmk_fuel_lep.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_mep, rbmk_fuel_mep.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_hep239, rbmk_fuel_hep239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_hep241, rbmk_fuel_hep241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_lea, rbmk_fuel_lea.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_mea, rbmk_fuel_mea.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_hea241, rbmk_fuel_hea241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_hea242, rbmk_fuel_hea242.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_men, rbmk_fuel_men.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_hen, rbmk_fuel_hen.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_mox, rbmk_fuel_mox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_les, rbmk_fuel_les.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_mes, rbmk_fuel_mes.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_hes, rbmk_fuel_hes.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_leaus, rbmk_fuel_leaus.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_heaus, rbmk_fuel_heaus.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_po210be, rbmk_fuel_po210be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_ra226be, rbmk_fuel_ra226be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_pu238be, rbmk_fuel_pu238be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_balefire_gold, rbmk_fuel_balefire_gold.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_flashlead, rbmk_fuel_flashlead.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_balefire, rbmk_fuel_balefire.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rbmk_fuel_zfb_bismuth, rbmk_fuel_zfb_bismuth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_zfb_pu241, rbmk_fuel_zfb_pu241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_zfb_am_mix, rbmk_fuel_zfb_am_mix.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_fuel_drx, rbmk_fuel_drx.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(rbmk_fuel_test, rbmk_fuel_test.getUnlocalizedName(), ERA.SECONDWORLDWAR);

		EraRegistry.registerItem(rbmk_pellet_ueu, rbmk_pellet_ueu.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_meu, rbmk_pellet_meu.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_heu233, rbmk_pellet_heu233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_heu235, rbmk_pellet_heu235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_thmeu, rbmk_pellet_thmeu.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_lep, rbmk_pellet_lep.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_mep, rbmk_pellet_mep.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_hep239, rbmk_pellet_hep239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_hep241, rbmk_pellet_hep241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_lea, rbmk_pellet_lea.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_mea, rbmk_pellet_mea.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_hea241, rbmk_pellet_hea241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_hea242, rbmk_pellet_hea242.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_men, rbmk_pellet_men.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_hen, rbmk_pellet_hen.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_mox, rbmk_pellet_mox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_les, rbmk_pellet_les.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_mes, rbmk_pellet_mes.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_hes, rbmk_pellet_hes.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_leaus, rbmk_pellet_leaus.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_heaus, rbmk_pellet_heaus.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_po210be, rbmk_pellet_po210be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_ra226be, rbmk_pellet_ra226be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_pu238be, rbmk_pellet_pu238be.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_balefire_gold, rbmk_pellet_balefire_gold.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_flashlead, rbmk_pellet_flashlead.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_balefire, rbmk_pellet_balefire.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_zfb_bismuth, rbmk_pellet_zfb_bismuth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_zfb_pu241, rbmk_pellet_zfb_pu241.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_zfb_am_mix, rbmk_pellet_zfb_am_mix.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_pellet_drx, rbmk_pellet_drx.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		EraRegistry.registerItem(watz_pellet, watz_pellet.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(watz_pellet_depleted, watz_pellet_depleted.getUnlocalizedName(), ERA.COLDWAR);
		
		EraRegistry.registerItem(debris_graphite, debris_graphite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(debris_metal, debris_metal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(debris_fuel, debris_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(debris_concrete, debris_concrete.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(debris_exchanger, debris_exchanger.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(debris_shrapnel, debris_shrapnel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(debris_element, debris_element.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(undefined, undefined.getUnlocalizedName(), ERA.COLDWAR);
		
		EraRegistry.registerItem(scrap_plastic, scrap_plastic.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(scrap, scrap.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(scrap_oil, scrap_oil.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(scrap_nuclear, scrap_nuclear.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(trinitite, trinitite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_long, nuclear_waste_long.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_long_tiny, nuclear_waste_long_tiny.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_short, nuclear_waste_short.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_short_tiny, nuclear_waste_short_tiny.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_long_depleted, nuclear_waste_long_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_long_depleted_tiny, nuclear_waste_long_depleted_tiny.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_short_depleted, nuclear_waste_short_depleted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_short_depleted_tiny, nuclear_waste_short_depleted_tiny.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste, nuclear_waste.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_tiny, nuclear_waste_tiny.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_vitrified, nuclear_waste_vitrified.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(nuclear_waste_vitrified_tiny, nuclear_waste_vitrified_tiny.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Spawners
		EraRegistry.registerItem(spawn_chopper, spawn_chopper.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(spawn_worm, spawn_worm.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(spawn_ufo, spawn_ufo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(spawn_duck, spawn_duck.getUnlocalizedName(), ERA.NEVER);
		
		//Computer Tools
		EraRegistry.registerItem(designator, designator.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(designator_range, designator_range.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(designator_manual, designator_manual.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(designator_arty_range, designator_arty_range.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		//EraRegistry.registerItem(turret_control, turret_control.getUnlocalizedName());
		EraRegistry.registerItem(turret_chip, turret_chip.getUnlocalizedName(), ERA.COLDWAR);
		//EraRegistry.registerItem(turret_biometry, turret_biometry.getUnlocalizedName());
		EraRegistry.registerItem(linker, linker.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(reactor_sensor, reactor_sensor.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(oil_detector, oil_detector.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(survey_scanner, survey_scanner.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(mirror_tool, mirror_tool.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(rbmk_tool, rbmk_tool.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(coltan_tool, coltan_tool.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(power_net_tool, power_net_tool.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(dosimeter, dosimeter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(geiger_counter, geiger_counter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(digamma_diagnostic, digamma_diagnostic.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(containment_box, containment_box.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Keys and Locks
		EraRegistry.registerItem(key, key.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(key_red, key_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(key_kit, key_kit.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(key_fake, key_fake.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(mech_key, mech_key.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(pin, pin.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(padlock_rusty, padlock_rusty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(padlock, padlock.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(padlock_reinforced, padlock_reinforced.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(padlock_unbreakable, padlock_unbreakable.getUnlocalizedName(), ERA.ALWAYS);
		
		//Missiles
		EraRegistry.registerItem(missile_generic, missile_generic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_anti_ballistic, missile_anti_ballistic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_incendiary, missile_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_cluster, missile_cluster.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_buster, missile_buster.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_strong, missile_strong.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_incendiary_strong, missile_incendiary_strong.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_cluster_strong, missile_cluster_strong.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_buster_strong, missile_buster_strong.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_emp_strong, missile_emp_strong.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_burst, missile_burst.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_inferno, missile_inferno.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_rain, missile_rain.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_drill, missile_drill.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_nuclear, missile_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_nuclear_cluster, missile_nuclear_cluster.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_volcano, missile_volcano.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_endo, missile_endo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_exo, missile_exo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_doomsday, missile_doomsday.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_taint, missile_taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_micro, missile_micro.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_bhole, missile_bhole.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_schrabidium, missile_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_emp, missile_emp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_shuttle, missile_shuttle.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_carrier, missile_carrier.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_soyuz, missile_soyuz.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_soyuz_lander, missile_soyuz_lander.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_custom, missile_custom.getUnlocalizedName(), ERA.NEVER);
		
		//Missile Parts
		EraRegistry.registerItem(mp_thruster_10_kerosene, mp_thruster_10_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_10_kerosene_tec, mp_thruster_10_kerosene_tec.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_10_solid, mp_thruster_10_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_10_xenon, mp_thruster_10_xenon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_kerosene, mp_thruster_15_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_kerosene_tec, mp_thruster_15_kerosene_tec.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_kerosene_dual, mp_thruster_15_kerosene_dual.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_kerosene_triple, mp_thruster_15_kerosene_triple.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_solid, mp_thruster_15_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_solid_hexdecuple, mp_thruster_15_solid_hexdecuple.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_hydrogen, mp_thruster_15_hydrogen.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_hydrogen_dual, mp_thruster_15_hydrogen_dual.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_balefire_short, mp_thruster_15_balefire_short.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_balefire, mp_thruster_15_balefire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_balefire_large, mp_thruster_15_balefire_large.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_15_balefire_large_rad, mp_thruster_15_balefire_large_rad.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_20_kerosene, mp_thruster_20_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_20_kerosene_dual, mp_thruster_20_kerosene_dual.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_20_kerosene_triple, mp_thruster_20_kerosene_triple.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_20_solid, mp_thruster_20_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_20_solid_multi, mp_thruster_20_solid_multi.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_thruster_20_solid_multier, mp_thruster_20_solid_multier.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_10_flat, mp_stability_10_flat.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_10_cruise, mp_stability_10_cruise.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_10_space, mp_stability_10_space.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_15_flat, mp_stability_15_flat.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_15_thin, mp_stability_15_thin.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_15_soyuz, mp_stability_15_soyuz.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_stability_20_flat, mp_stability_20_flat.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene, mp_fuselage_10_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_camo, mp_fuselage_10_kerosene_camo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_desert, mp_fuselage_10_kerosene_desert.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_sky, mp_fuselage_10_kerosene_sky.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_flames, mp_fuselage_10_kerosene_flames.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_insulation, mp_fuselage_10_kerosene_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_sleek, mp_fuselage_10_kerosene_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_metal, mp_fuselage_10_kerosene_metal.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_kerosene_taint, mp_fuselage_10_kerosene_taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid, mp_fuselage_10_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_flames, mp_fuselage_10_solid_flames.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_insulation, mp_fuselage_10_solid_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_sleek, mp_fuselage_10_solid_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_soviet_glory, mp_fuselage_10_solid_soviet_glory.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_cathedral, mp_fuselage_10_solid_cathedral.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_moonlit, mp_fuselage_10_solid_moonlit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_battery, mp_fuselage_10_solid_battery.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_solid_duracell, mp_fuselage_10_solid_duracell.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_xenon, mp_fuselage_10_xenon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_xenon_bhole, mp_fuselage_10_xenon_bhole.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene, mp_fuselage_10_long_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_camo, mp_fuselage_10_long_kerosene_camo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_desert, mp_fuselage_10_long_kerosene_desert.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_sky, mp_fuselage_10_long_kerosene_sky.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_flames, mp_fuselage_10_long_kerosene_flames.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_insulation, mp_fuselage_10_long_kerosene_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_sleek, mp_fuselage_10_long_kerosene_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_metal, mp_fuselage_10_long_kerosene_metal.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_dash, mp_fuselage_10_long_kerosene_dash.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_taint, mp_fuselage_10_long_kerosene_taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_kerosene_vap, mp_fuselage_10_long_kerosene_vap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid, mp_fuselage_10_long_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid_flames, mp_fuselage_10_long_solid_flames.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid_insulation, mp_fuselage_10_long_solid_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid_sleek, mp_fuselage_10_long_solid_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid_soviet_glory, mp_fuselage_10_long_solid_soviet_glory.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid_bullet, mp_fuselage_10_long_solid_bullet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_long_solid_silvermoonlight, mp_fuselage_10_long_solid_silvermoonlight.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_15_kerosene, mp_fuselage_10_15_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_15_solid, mp_fuselage_10_15_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_15_hydrogen, mp_fuselage_10_15_hydrogen.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_10_15_balefire, mp_fuselage_10_15_balefire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene, mp_fuselage_15_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_camo, mp_fuselage_15_kerosene_camo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_desert, mp_fuselage_15_kerosene_desert.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_sky, mp_fuselage_15_kerosene_sky.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_insulation, mp_fuselage_15_kerosene_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_metal, mp_fuselage_15_kerosene_metal.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_decorated, mp_fuselage_15_kerosene_decorated.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_steampunk, mp_fuselage_15_kerosene_steampunk.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_polite, mp_fuselage_15_kerosene_polite.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_blackjack, mp_fuselage_15_kerosene_blackjack.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_lambda, mp_fuselage_15_kerosene_lambda.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_minuteman, mp_fuselage_15_kerosene_minuteman.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_pip, mp_fuselage_15_kerosene_pip.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_taint, mp_fuselage_15_kerosene_taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_kerosene_yuck, mp_fuselage_15_kerosene_yuck.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid, mp_fuselage_15_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_insulation, mp_fuselage_15_solid_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_desh, mp_fuselage_15_solid_desh.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_soviet_glory, mp_fuselage_15_solid_soviet_glory.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_soviet_stank, mp_fuselage_15_solid_soviet_stank.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_faust, mp_fuselage_15_solid_faust.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_silvermoonlight, mp_fuselage_15_solid_silvermoonlight.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_snowy, mp_fuselage_15_solid_snowy.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_panorama, mp_fuselage_15_solid_panorama.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_roses, mp_fuselage_15_solid_roses.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_solid_mimi, mp_fuselage_15_solid_mimi.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_hydrogen, mp_fuselage_15_hydrogen.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_hydrogen_cathedral, mp_fuselage_15_hydrogen_cathedral.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_balefire, mp_fuselage_15_balefire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_20_kerosene, mp_fuselage_15_20_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_20_kerosene_magnusson, mp_fuselage_15_20_kerosene_magnusson.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_15_20_solid, mp_fuselage_15_20_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_fuselage_20_kerosene, mp_fuselage_20_kerosene.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_he, mp_warhead_10_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_incendiary, mp_warhead_10_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_buster, mp_warhead_10_buster.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_nuclear, mp_warhead_10_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_nuclear_large, mp_warhead_10_nuclear_large.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_taint, mp_warhead_10_taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_10_cloud, mp_warhead_10_cloud.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_he, mp_warhead_15_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_incendiary, mp_warhead_15_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_nuclear, mp_warhead_15_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_nuclear_shark, mp_warhead_15_nuclear_shark.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_nuclear_mimi, mp_warhead_15_nuclear_mimi.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_boxcar, mp_warhead_15_boxcar.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_n2, mp_warhead_15_n2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_balefire, mp_warhead_15_balefire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_15_turbine, mp_warhead_15_turbine.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_warhead_20_he, mp_warhead_20_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_chip_1, mp_chip_1.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_chip_2, mp_chip_2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_chip_3, mp_chip_3.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_chip_4, mp_chip_4.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mp_chip_5, mp_chip_5.getUnlocalizedName(), ERA.NEVER);

		/*EraRegistry.registerItem(missile_skin_camo, missile_skin_camo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_desert, missile_skin_desert.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_flames, missile_skin_flames.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_manly_pink, missile_skin_manly_pink.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_orange_insulation, missile_skin_orange_insulation.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_sleek, missile_skin_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_soviet_glory, missile_skin_soviet_glory.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_soviet_stank, missile_skin_soviet_stank.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_skin_metal, missile_skin_metal.getUnlocalizedName(), ERA.NEVER);*/
		
		//Satellites
		EraRegistry.registerItem(sat_mapper, sat_mapper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_scanner, sat_scanner.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_radar, sat_radar.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_laser, sat_laser.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_foeq, sat_foeq.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_resonator, sat_resonator.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_miner, sat_miner.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_lunar_miner, sat_lunar_miner.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_gerald, sat_gerald.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_chip, sat_chip.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_interface, sat_interface.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_coord, sat_coord.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(sat_designator, sat_designator.getUnlocalizedName(), ERA.COLDWAR);
		
		//Guns
		EraRegistry.registerItem(gun_revolver, gun_revolver.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_saturnite, gun_revolver_saturnite.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_gold, gun_revolver_gold.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_schrabidium, gun_revolver_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_cursed, gun_revolver_cursed.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_nightmare, gun_revolver_nightmare.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_nightmare2, gun_revolver_nightmare2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_pip, gun_revolver_pip.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_nopip, gun_revolver_nopip.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_blackjack, gun_revolver_blackjack.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_silver, gun_revolver_silver.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_red, gun_revolver_red.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bio_revolver, gun_bio_revolver.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_deagle, gun_deagle.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_flechette, gun_flechette.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_ar15, gun_ar15.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_calamity, gun_calamity.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_m2, gun_m2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_minigun, gun_minigun.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_avenger, gun_avenger.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_lacunae, gun_lacunae.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_folly, gun_folly.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_b92, gun_b92.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_b93, gun_b93.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_rpg, gun_rpg.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_karl, gun_karl.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_panzerschreck, gun_panzerschreck.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_quadro, gun_quadro.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_hk69, gun_hk69.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_fatman, gun_fatman.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_proto, gun_proto.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_mirv, gun_mirv.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bf, gun_bf.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_chemthrower, gun_chemthrower.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_mp40, gun_mp40.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_thompson, gun_thompson.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_uzi, gun_uzi.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_uzi_silencer,gun_uzi_silencer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_uzi_saturnite, gun_uzi_saturnite.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_uzi_saturnite_silencer,gun_uzi_saturnite_silencer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_uboinik, gun_uboinik.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_remington, gun_remington.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_spas12, gun_spas12.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_supershotgun, gun_supershotgun.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_ks23, gun_ks23.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_sauer, gun_sauer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_lever_action, gun_lever_action.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_lever_action_dark, gun_lever_action_dark.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_lever_action_sonata, gun_lever_action_sonata.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bolt_action, gun_bolt_action.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bolt_action_green, gun_bolt_action_green.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bolt_action_saturnite, gun_bolt_action_saturnite.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_mymy, gun_mymy.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_xvl1456, gun_xvl1456.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_osipr, gun_osipr.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_immolator, gun_immolator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_flamer, gun_flamer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_cryolator, gun_cryolator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_fireext, gun_fireext.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_mp, gun_mp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bolter, gun_bolter.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bolter_digamma, gun_bolter_digamma.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_zomg, gun_zomg.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_emp, gun_emp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_inverted, gun_revolver_inverted.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_jack, gun_jack.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_spark, gun_spark.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_hp, gun_hp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_euthanasia, gun_euthanasia.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_dash, gun_dash.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_twigun, gun_twigun.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_defabricator, gun_defabricator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_vortex, gun_vortex.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_super_shotgun, gun_super_shotgun.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_moist_nugget, gun_moist_nugget.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_dampfmaschine, gun_dampfmaschine.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_darter, gun_darter.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_detonator, gun_detonator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(crucible, crucible.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_glass_cannon, gun_glass_cannon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_lunatic_marksman, gun_lunatic_marksman.getUnlocalizedName(), ERA.NEVER);
		
		//Ammo
		/*EraRegistry.registerItem(gun_revolver_iron_ammo, gun_revolver_iron_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_ammo, gun_revolver_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_gold_ammo, gun_revolver_gold_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_lead_ammo, gun_revolver_lead_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_schrabidium_ammo, gun_revolver_schrabidium_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_cursed_ammo, gun_revolver_cursed_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_nightmare_ammo, gun_revolver_nightmare_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_357_desh, ammo_357_desh.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_revolver_nightmare2_ammo, gun_revolver_nightmare2_ammo.getUnlocalizedName(), ERA.NEVER);*/
		//EraRegistry.registerItem(gun_revolver_pip_ammo, gun_revolver_pip_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_revolver_nopip_ammo, gun_revolver_nopip_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_calamity_ammo, gun_calamity_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_lacunae_ammo, gun_lacunae_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_b92_ammo, gun_b92_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_rpg_ammo, gun_rpg_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_stinger_ammo, gun_stinger_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_fatman_ammo, gun_fatman_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_mirv_ammo, gun_mirv_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_bf_ammo, gun_bf_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_mp40_ammo, gun_mp40_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_uzi_ammo, gun_uzi_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_uboinik_ammo, gun_uboinik_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_lever_action_ammo, gun_lever_action_ammo.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(gun_bolt_action_ammo, gun_bolt_action_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_xvl1456_ammo, gun_xvl1456_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_osipr_ammo, gun_osipr_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_osipr_ammo2, gun_osipr_ammo2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_immolator_ammo, gun_immolator_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_cryolator_ammo, gun_cryolator_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_emp_ammo, gun_emp_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_jack_ammo, gun_jack_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_spark_ammo, gun_spark_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_hp_ammo, gun_hp_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_defabricator_ammo, gun_defabricator_ammo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_euthanasia_ammo, gun_euthanasia_ammo.getUnlocalizedName(), ERA.NEVER);

		EraRegistry.registerItem(ammo_12gauge, ammo_12gauge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge, ammo_20gauge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge, ammo_4gauge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_357, ammo_357.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44, ammo_44.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_45, ammo_45.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_5mm, ammo_5mm.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_9mm, ammo_9mm.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556, ammo_556.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_762, ammo_762.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_22lr, ammo_22lr.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50ae, ammo_50ae.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg, ammo_50bmg.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_75bolt, ammo_75bolt.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke, ammo_nuke.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fuel, ammo_fuel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fireext, ammo_fireext.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_cell, ammo_cell.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_dart, ammo_dart.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket, ammo_rocket.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_stinger_rocket, ammo_stinger_rocket.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_luna_sniper, ammo_luna_sniper.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade, ammo_grenade.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_shell, ammo_shell.getUnlocalizedName(), ERA.NEVER);
		
		/*EraRegistry.registerItem(ammo_12gauge, ammo_12gauge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_12gauge_incendiary, ammo_12gauge_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_12gauge_shrapnel, ammo_12gauge_shrapnel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_12gauge_du, ammo_12gauge_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_12gauge_sleek, ammo_12gauge_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_12gauge_marauder, ammo_12gauge_marauder.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge, ammo_20gauge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_slug, ammo_20gauge_slug.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_flechette, ammo_20gauge_flechette.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_incendiary, ammo_20gauge_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_shrapnel, ammo_20gauge_shrapnel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_explosive, ammo_20gauge_explosive.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_caustic, ammo_20gauge_caustic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_shock, ammo_20gauge_shock.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_wither, ammo_20gauge_wither.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_20gauge_sleek, ammo_20gauge_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge, ammo_4gauge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_slug, ammo_4gauge_slug.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_flechette, ammo_4gauge_flechette.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_flechette_phosphorus, ammo_4gauge_flechette_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_explosive, ammo_4gauge_explosive.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_semtex, ammo_4gauge_semtex.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_balefire, ammo_4gauge_balefire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_kampf, ammo_4gauge_kampf.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_canister, ammo_4gauge_canister.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_claw, ammo_4gauge_claw.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_vampire, ammo_4gauge_vampire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_void, ammo_4gauge_void.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_titan, ammo_4gauge_titan.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_4gauge_sleek, ammo_4gauge_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44, ammo_44.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_ap, ammo_44_ap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_du, ammo_44_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_phosphorus, ammo_44_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_star, ammo_44_star.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_chlorophyte, ammo_44_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_pip, ammo_44_pip.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_bj, ammo_44_bj.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_silver, ammo_44_silver.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_44_rocket, ammo_44_rocket.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_5mm, ammo_5mm.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_5mm_explosive, ammo_5mm_explosive.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_5mm_du, ammo_5mm_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_5mm_star, ammo_5mm_star.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_5mm_chlorophyte, ammo_5mm_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_9mm, ammo_9mm.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_9mm_ap, ammo_9mm_ap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_9mm_du, ammo_9mm_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_9mm_chlorophyte, ammo_9mm_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_9mm_rocket, ammo_9mm_rocket.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556, ammo_556.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_566_gold, ammo_566_gold.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_phosphorus, ammo_556_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_ap, ammo_556_ap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_du, ammo_556_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_star, ammo_556_star.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_chlorophyte, ammo_556_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_sleek, ammo_556_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_tracer, ammo_556_tracer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_flechette, ammo_556_flechette.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_flechette_incendiary, ammo_556_flechette_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_flechette_phosphorus, ammo_556_flechette_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_flechette_du, ammo_556_flechette_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_flechette_chlorophyte, ammo_556_flechette_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_flechette_sleek, ammo_556_flechette_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_556_k, ammo_556_k.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_22lr, ammo_22lr.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_22lr_ap, ammo_22lr_ap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_22lr_chlorophyte, ammo_22lr_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50ae, ammo_50ae.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50ae_ap, ammo_50ae_ap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50ae_du, ammo_50ae_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50ae_star, ammo_50ae_star.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50ae_chlorophyte, ammo_50ae_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg, ammo_50bmg.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_incendiary, ammo_50bmg_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_phosphorus, ammo_50bmg_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_explosive, ammo_50bmg_explosive.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_ap, ammo_50bmg_ap.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_du, ammo_50bmg_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_star, ammo_50bmg_star.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_chlorophyte, ammo_50bmg_chlorophyte.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_flechette, ammo_50bmg_flechette.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_flechette_am, ammo_50bmg_flechette_am.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_flechette_po, ammo_50bmg_flechette_po.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_50bmg_sleek, ammo_50bmg_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_75bolt, ammo_75bolt.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_75bolt_incendiary, ammo_75bolt_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_75bolt_he, ammo_75bolt_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fuel, ammo_fuel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fuel_napalm, ammo_fuel_napalm.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fuel_phosphorus, ammo_fuel_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fuel_vaporizer, ammo_fuel_vaporizer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fuel_gas, ammo_fuel_gas.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fireext, ammo_fireext.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fireext_foam, ammo_fireext_foam.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_fireext_sand, ammo_fireext_sand.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_cell, ammo_cell.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_dart, ammo_dart.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_dart_nuclear, ammo_dart_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_dart_nerf, ammo_dart_nerf.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket, ammo_rocket.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_he, ammo_rocket_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_incendiary, ammo_rocket_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_phosphorus, ammo_rocket_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_shrapnel, ammo_rocket_shrapnel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_emp, ammo_rocket_emp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_glare, ammo_rocket_glare.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_toxic, ammo_rocket_toxic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_canister, ammo_rocket_canister.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_sleek, ammo_rocket_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_nuclear, ammo_rocket_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_rpc, ammo_rocket_rpc.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_rocket_digamma, ammo_rocket_digamma.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_stinger_rocket, ammo_stinger_rocket.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_stinger_rocket_he, ammo_stinger_rocket_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_stinger_rocket_incendiary, ammo_stinger_rocket_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_stinger_rocket_nuclear, ammo_stinger_rocket_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_stinger_rocket_bones, ammo_stinger_rocket_bones.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade, ammo_grenade.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_he, ammo_grenade_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_incendiary, ammo_grenade_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_phosphorus, ammo_grenade_phosphorus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_toxic, ammo_grenade_toxic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_concussion, ammo_grenade_concussion.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_finned, ammo_grenade_finned.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_sleek, ammo_grenade_sleek.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_nuclear, ammo_grenade_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_tracer, ammo_grenade_tracer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_grenade_kampf, ammo_grenade_kampf.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_shell, ammo_shell.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_shell_explosive, ammo_shell_explosive.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_shell_apfsds_t, ammo_shell_apfsds_t.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_shell_apfsds_du, ammo_shell_apfsds_du.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_shell_w9, ammo_shell_w9.getUnlocalizedName(), ERA.NEVER);*/
		EraRegistry.registerItem(ammo_dgk, ammo_dgk.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_arty, ammo_arty.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_himars, ammo_himars.getUnlocalizedName(), ERA.NEVER);
		/*EraRegistry.registerItem(ammo_nuke, ammo_nuke.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke_low, ammo_nuke_low.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke_high, ammo_nuke_high.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke_tots, ammo_nuke_tots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke_safe, ammo_nuke_safe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke_pumpkin, ammo_nuke_pumpkin.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_nuke_barrel, ammo_nuke_barrel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_mirv, ammo_mirv.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_mirv_low, ammo_mirv_low.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_mirv_high, ammo_mirv_high.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_mirv_safe, ammo_mirv_safe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_mirv_special, ammo_mirv_special.getUnlocalizedName(), ERA.NEVER);*/
		EraRegistry.registerItem(ammo_folly, ammo_folly.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_folly_nuclear, ammo_folly_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ammo_folly_du, ammo_folly_du.getUnlocalizedName(), ERA.NEVER);
		
		//-C-l-i-p-s- Magazines
		EraRegistry.registerItem(clip_revolver_iron, clip_revolver_iron.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver, clip_revolver.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_gold, clip_revolver_gold.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_lead, clip_revolver_lead.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_schrabidium, clip_revolver_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_cursed, clip_revolver_cursed.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_nightmare, clip_revolver_nightmare.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_nightmare2, clip_revolver_nightmare2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_pip, clip_revolver_pip.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_revolver_nopip, clip_revolver_nopip.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_rpg, clip_rpg.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_stinger, clip_stinger.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_fatman, clip_fatman.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_mirv, clip_mirv.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_bf, clip_bf.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_mp40, clip_mp40.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_uzi, clip_uzi.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_uboinik, clip_uboinik.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_lever_action, clip_lever_action.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_bolt_action, clip_bolt_action.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_xvl1456, clip_xvl1456.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_osipr, clip_osipr.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_immolator, clip_immolator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_cryolator, clip_cryolator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_mp, clip_mp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_emp, clip_emp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_jack, clip_jack.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_spark, clip_spark.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_hp, clip_hp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_euthanasia, clip_euthanasia.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(clip_defabricator, clip_defabricator.getUnlocalizedName(), ERA.NEVER);
		
		EraRegistry.registerItem(ammo_container, ammo_container.getUnlocalizedName(), ERA.NEVER);
		
		//Grenades
		EraRegistry.registerItem(stick_dynamite, stick_dynamite.getUnlocalizedName(), ERA.ALWAYS); //heave-ho!
		EraRegistry.registerItem(stick_tnt, stick_tnt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stick_semtex, stick_semtex.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stick_c4, stick_c4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(grenade_generic, grenade_generic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_strong, grenade_strong.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_frag, grenade_frag.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_fire, grenade_fire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_shrapnel, grenade_shrapnel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_cluster, grenade_cluster.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_flare, grenade_flare.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_electric, grenade_electric.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_poison, grenade_poison.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_gas, grenade_gas.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_cloud, grenade_cloud.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_pink_cloud, grenade_pink_cloud.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_smart, grenade_smart.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_mirv, grenade_mirv.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_breach, grenade_breach.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_burst, grenade_burst.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_pulse, grenade_pulse.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_plasma, grenade_plasma.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_tau, grenade_tau.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_schrabidium, grenade_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_nuke, grenade_nuke.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_lemon, grenade_lemon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_gascan, grenade_gascan.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_kyiv, grenade_kyiv.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_mk2, grenade_mk2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_aschrab, grenade_aschrab.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_nuclear, grenade_nuclear.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_zomg, grenade_zomg.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_black_hole, grenade_black_hole.getUnlocalizedName(), ERA.NEVER);

		EraRegistry.registerItem(grenade_if_generic, grenade_if_generic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_he, grenade_if_he.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_bouncy, grenade_if_bouncy.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_sticky, grenade_if_sticky.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_impact, grenade_if_impact.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_incendiary, grenade_if_incendiary.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_toxic, grenade_if_toxic.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_concussion, grenade_if_concussion.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_brimstone, grenade_if_brimstone.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_mystery, grenade_if_mystery.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_spark, grenade_if_spark.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_hopwire, grenade_if_hopwire.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_if_null, grenade_if_null.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(nuclear_waste_pearl, nuclear_waste_pearl.getUnlocalizedName(), ERA.NEVER);
		
		EraRegistry.registerItem(ullapool_caber, ullapool_caber.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(weaponized_starblaster_cell, weaponized_starblaster_cell.getUnlocalizedName(), ERA.NEVER);
		
		//Capes
		EraRegistry.registerItem(cape_radiation, cape_radiation.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cape_gasmask, cape_gasmask.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cape_schrabidium, cape_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cape_hidden, cape_hidden.getUnlocalizedName(), ERA.ALWAYS);
		
		//Tools
		EraRegistry.registerItem(schrabidium_sword, schrabidium_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_hammer, schrabidium_hammer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(shimmer_sledge, shimmer_sledge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(shimmer_axe, shimmer_axe.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(pch, pch.getUnlocalizedName(), ERA.NEVER); //sike, nevermind
		EraRegistry.registerItem(wood_gavel, wood_gavel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(lead_gavel, lead_gavel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(diamond_gavel, diamond_gavel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mese_gavel, mese_gavel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_pickaxe, schrabidium_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_axe, schrabidium_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_shovel, schrabidium_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_hoe, schrabidium_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_sword, steel_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_pickaxe, steel_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_axe, steel_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_shovel, steel_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_hoe, steel_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_sword, titanium_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_pickaxe, titanium_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_axe, titanium_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_shovel, titanium_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_hoe, titanium_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_sword, cobalt_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_pickaxe, cobalt_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_axe, cobalt_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_shovel, cobalt_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_hoe, cobalt_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_decorated_sword, cobalt_decorated_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_decorated_pickaxe, cobalt_decorated_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_decorated_axe, cobalt_decorated_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_decorated_shovel, cobalt_decorated_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_decorated_hoe, cobalt_decorated_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_sword, starmetal_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_pickaxe, starmetal_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_axe, starmetal_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_shovel, starmetal_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_hoe, starmetal_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_sword, alloy_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_pickaxe, alloy_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_axe, alloy_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_shovel, alloy_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_hoe, alloy_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_sword, cmb_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_pickaxe, cmb_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_axe, cmb_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_shovel, cmb_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_hoe, cmb_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(desh_sword, desh_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(desh_pickaxe, desh_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(desh_axe, desh_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(desh_shovel, desh_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(desh_hoe, desh_hoe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(elec_sword, elec_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(elec_pickaxe, elec_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(elec_axe, elec_axe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(elec_shovel, elec_shovel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dnt_sword, dnt_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(smashing_hammer, smashing_hammer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(centri_stick, centri_stick.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(drax, drax.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(drax_mk2, drax_mk2.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(drax_mk3, drax_mk3.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bismuth_pickaxe, bismuth_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(volcanic_pickaxe, volcanic_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(chlorophyte_pickaxe, chlorophyte_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mese_pickaxe, mese_pickaxe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(matchstick, matchstick.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(balefire_and_steel, balefire_and_steel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(crowbar, crowbar.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(wrench, wrench.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(wrench_archineer, wrench_archineer.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(wrench_flipped, wrench_flipped.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(memespoon, memespoon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(saw, saw.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bat, bat.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bat_nail, bat_nail.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(golf_club, golf_club.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pipe_rusty, pipe_rusty.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pipe_lead, pipe_lead.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(reer_graar, reer_graar.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(stopsign, stopsign.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(sopsign, sopsign.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(chernobylsign, chernobylsign.getUnlocalizedName(), ERA.NEVER);

		EraRegistry.registerItem(meteorite_sword, meteorite_sword.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_seared, meteorite_sword_seared.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_reforged, meteorite_sword_reforged.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_hardened, meteorite_sword_hardened.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_alloyed, meteorite_sword_alloyed.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_machined, meteorite_sword_machined.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_treated, meteorite_sword_treated.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_etched, meteorite_sword_etched.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_bred, meteorite_sword_bred.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_irradiated, meteorite_sword_irradiated.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_fused, meteorite_sword_fused.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(meteorite_sword_baleful, meteorite_sword_baleful.getUnlocalizedName(), ERA.NEVER);
		
		//Multitool
		EraRegistry.registerItem(multitool_hit, multitool_hit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_dig, multitool_dig.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_silk, multitool_silk.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_ext, multitool_ext.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_miner, multitool_miner.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_beam, multitool_beam.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_sky, multitool_sky.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_mega, multitool_mega.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_joule, multitool_joule.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multitool_decon, multitool_decon.getUnlocalizedName(), ERA.NEVER);
		
		//Syringes & Pills
		EraRegistry.registerItem(syringe_empty, syringe_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(syringe_antidote, syringe_antidote.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(syringe_poison, syringe_poison.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(syringe_awesome, syringe_awesome.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(syringe_metal_empty, syringe_metal_empty.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(syringe_metal_stimpak, syringe_metal_stimpak.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(syringe_metal_medx, syringe_metal_medx.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(syringe_metal_psycho, syringe_metal_psycho.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(syringe_metal_super, syringe_metal_super.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(syringe_taint, syringe_taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(syringe_mkunicorn, syringe_mkunicorn.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(med_bag, med_bag.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(iv_empty, iv_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(iv_blood, iv_blood.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(iv_xp_empty, iv_xp_empty.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(iv_xp, iv_xp.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(radaway, radaway.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(radaway_strong, radaway_strong.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(radaway_flush, radaway_flush.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(radx, radx.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(siox, siox.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pill_herbal, pill_herbal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pill_iodine, pill_iodine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(xanax, xanax.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fmn, fmn.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(five_htp, five_htp.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(plan_c, plan_c.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pill_red, pill_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(stealth_boy, stealth_boy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_filter, gas_mask_filter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_filter_mono, gas_mask_filter_mono.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_filter_combo, gas_mask_filter_combo.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_filter_rag, gas_mask_filter_rag.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_filter_piss, gas_mask_filter_piss.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(jetpack_tank, jetpack_tank.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(gun_kit_1, gun_kit_1.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gun_kit_2, gun_kit_2.getUnlocalizedName(), ERA.NEVER);
		
		//Food
		EraRegistry.registerItem(bomb_waffle, bomb_waffle.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schnitzel_vegan, schnitzel_vegan.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cotton_candy, cotton_candy.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(apple_lead, apple_lead.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(apple_schrabidium, apple_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(tem_flakes, tem_flakes.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(glowing_stew, glowing_stew.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(balefire_scrambled, balefire_scrambled.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(balefire_and_ham, balefire_and_ham.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(lemon, lemon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(definitelyfood, definitelyfood.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(loops, loops.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(loop_stew, loop_stew.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(spongebob_macaroni, spongebob_macaroni.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(fooditem, fooditem.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(twinkie, twinkie.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(static_sandwich, static_sandwich.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pudding, pudding.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(pancake, pancake.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(nugget, nugget.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(peas, peas.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(marshmallow, marshmallow.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cheese, cheese.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(quesadilla, quesadilla.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(med_ipecac, med_ipecac.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(med_ptsd, med_ptsd.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(canteen_13, canteen_13.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(canteen_vodka, canteen_vodka.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(canteen_fab, canteen_fab.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mucho_mango, mucho_mango.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(chocolate, chocolate.getUnlocalizedName(), ERA.NEVER);
		
		//Energy Drinks
		EraRegistry.registerItem(can_empty, can_empty.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_smart, can_smart.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_creature, can_creature.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_redbomb, can_redbomb.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_mrsugar, can_mrsugar.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_overcharge, can_overcharge.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_luna, can_luna.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_bepis, can_bepis.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_breen, can_breen.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_mug, can_mug.getUnlocalizedName(), ERA.COLDWAR);
		
		//Coffee
		EraRegistry.registerItem(coffee, coffee.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(coffee_radium, coffee_radium.getUnlocalizedName(), ERA.COLDWAR);
		
		//Cola
		EraRegistry.registerItem(bottle_empty, bottle_empty.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle_nuka, bottle_nuka.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle_cherry, bottle_cherry.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle_quantum, bottle_quantum.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle_sparkle, bottle_sparkle.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle_rad, bottle_rad.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle2_empty, bottle2_empty.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle2_korl, bottle2_korl.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle2_fritz, bottle2_fritz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle2_korl_special, bottle2_korl_special.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle2_fritz_special, bottle2_fritz_special.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle2_sunset, bottle2_sunset.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(bottle_opener, bottle_opener.getUnlocalizedName(), ERA.COLDWAR);
		
		//Flasks
		EraRegistry.registerItem(flask_infusion, flask_infusion.getUnlocalizedName(), ERA.NEVER);
		
		//Canned Food
		//EraRegistry.registerItem(canned_beef, canned_beef.getUnlocalizedName());
		//EraRegistry.registerItem(canned_tuna, canned_tuna.getUnlocalizedName());
		//EraRegistry.registerItem(canned_mystery, canned_mystery.getUnlocalizedName());
		//EraRegistry.registerItem(canned_pashtet, canned_pashtet.getUnlocalizedName());
		//EraRegistry.registerItem(canned_cheese, canned_cheese.getUnlocalizedName());
		//EraRegistry.registerItem(canned_jizz, canned_jizz.getUnlocalizedName());
		//EraRegistry.registerItem(canned_milk, canned_milk.getUnlocalizedName());
		//EraRegistry.registerItem(canned_ass, canned_ass.getUnlocalizedName());
		//EraRegistry.registerItem(canned_pizza, canned_pizza.getUnlocalizedName());
		//EraRegistry.registerItem(canned_tube, canned_tube.getUnlocalizedName());
		//EraRegistry.registerItem(canned_tomato, canned_tomato.getUnlocalizedName());
		//EraRegistry.registerItem(canned_asbestos, canned_asbestos.getUnlocalizedName());
		//EraRegistry.registerItem(canned_bhole, canned_bhole.getUnlocalizedName());
		//EraRegistry.registerItem(canned_hotdogs, canned_hotdogs.getUnlocalizedName());
		//EraRegistry.registerItem(canned_leftovers, canned_leftovers.getUnlocalizedName());
		//EraRegistry.registerItem(canned_yogurt, canned_yogurt.getUnlocalizedName());
		//EraRegistry.registerItem(canned_stew, canned_stew.getUnlocalizedName());
		//EraRegistry.registerItem(canned_chinese, canned_chinese.getUnlocalizedName());
		//EraRegistry.registerItem(canned_oil, canned_oil.getUnlocalizedName());
		//EraRegistry.registerItem(canned_fist, canned_fist.getUnlocalizedName());
		//EraRegistry.registerItem(canned_spam, canned_spam.getUnlocalizedName());
		//EraRegistry.registerItem(canned_fried, canned_fried.getUnlocalizedName());
		//EraRegistry.registerItem(canned_napalm, canned_napalm.getUnlocalizedName());
		//EraRegistry.registerItem(canned_diesel, canned_diesel.getUnlocalizedName());
		//EraRegistry.registerItem(canned_kerosene, canned_kerosene.getUnlocalizedName());
		//EraRegistry.registerItem(canned_recursion, canned_recursion.getUnlocalizedName());
		//EraRegistry.registerItem(canned_bark, canned_bark.getUnlocalizedName());
		EraRegistry.registerItem(canned_conserve, canned_conserve.getUnlocalizedName(), ERA.COLDWAR);
		
		//Money
		EraRegistry.registerItem(cap_nuka, cap_nuka.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_quantum, cap_quantum.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_sparkle, cap_sparkle.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_rad, cap_rad.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_korl, cap_korl.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_fritz, cap_fritz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_sunset, cap_sunset.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cap_star, cap_star.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ring_pull, ring_pull.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(can_key, can_key.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(coin_creeper, coin_creeper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(coin_radiation,coin_radiation.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(coin_maskman, coin_maskman.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(coin_worm, coin_worm.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(coin_ufo, coin_ufo.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(medal_liquidator, medal_liquidator.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(v1, v1.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(protection_charm, protection_charm.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(meteor_charm, meteor_charm.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(neutrino_lens, neutrino_lens.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(gas_tester, gas_tester.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(defuser_gold, defuser_gold.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(ballistic_gauntlet, ballistic_gauntlet.getUnlocalizedName(), ERA.COLDWAR);
		
		//Chaos
		EraRegistry.registerItem(chocolate_milk, chocolate_milk.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cbt_device, cbt_device.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(cigarette, cigarette.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(crackpipe, crackpipe.getUnlocalizedName(), ERA.COLDWAR);
		
		//Armor mods
		EraRegistry.registerItem(attachment_mask, attachment_mask.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(attachment_mask_mono, attachment_mask_mono.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(back_tesla, back_tesla.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(servo_set, servo_set.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(servo_set_desh, servo_set_desh.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(pads_rubber, pads_rubber.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pads_slime, pads_slime.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pads_static, pads_static.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_paint, cladding_paint.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_rubber, cladding_rubber.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_lead, cladding_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_desh, cladding_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_ghiorsium, cladding_ghiorsium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_iron, cladding_iron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cladding_obsidian, cladding_obsidian.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_kevlar, insert_kevlar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_sapi, insert_sapi.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_esapi, insert_esapi.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(insert_xsapi, insert_xsapi.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(insert_steel, insert_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_du, insert_du.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_polonium, insert_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_ghiorsium, insert_ghiorsium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(insert_era, insert_era.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_yharonite, insert_yharonite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(insert_doxium, insert_doxium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(armor_polish, armor_polish.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bandaid, bandaid.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(serum, serum.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(quartz_plutonium, quartz_plutonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(morning_glory, morning_glory.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(lodestone, lodestone.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(horseshoe_magnet, horseshoe_magnet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(industrial_magnet, industrial_magnet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bathwater, bathwater.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bathwater_mk2, bathwater_mk2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spider_milk, spider_milk.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ink, ink.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(heart_piece, heart_piece.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(heart_container, heart_container.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(heart_booster, heart_booster.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(heart_fab, heart_fab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(black_diamond, black_diamond.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wd40, wd40.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(scrumpy, scrumpy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(wild_p, wild_p.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(fabsols_vodka, fabsols_vodka.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(shackles, shackles.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(injector_5htp, injector_5htp.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(injector_knife, injector_knife.getUnlocalizedName(), ERA.ALWAYS);
		
		//Minecarts
		EraRegistry.registerItem(cart, cart.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(train, train.getUnlocalizedName(), ERA.ALWAYS);
		
		//High Explosive Lenses
		EraRegistry.registerItem(early_explosive_lenses, early_explosive_lenses.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(explosive_lenses, explosive_lenses.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//The Gadget
		//EraRegistry.registerItem(gadget_explosive, gadget_explosive.getUnlocalizedName());
		EraRegistry.registerItem(gadget_wireing, gadget_wireing.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(gadget_core, gadget_core.getUnlocalizedName(), ERA.COLDWAR);

		//Little Boy
		EraRegistry.registerItem(boy_shielding, boy_shielding.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(boy_target, boy_target.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(boy_bullet, boy_bullet.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(boy_propellant, boy_propellant.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(boy_igniter, boy_igniter.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Fat Man
		//EraRegistry.registerItem(man_explosive, man_explosive.getUnlocalizedName());
		EraRegistry.registerItem(man_igniter, man_igniter.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerItem(man_core, man_core.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Ivy Mike
		EraRegistry.registerItem(mike_core, mike_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(mike_deut, mike_deut.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(mike_cooling_unit, mike_cooling_unit.getUnlocalizedName(), ERA.COLDWAR);
		
		//Tsar Bomba
		EraRegistry.registerItem(tsar_core, tsar_core.getUnlocalizedName(), ERA.COLDWAR);
		
		//FLEIJA
		EraRegistry.registerItem(fleija_igniter, fleija_igniter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fleija_propellant, fleija_propellant.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(fleija_core, fleija_core.getUnlocalizedName(), ERA.COLDWAR);
		
		//Solinium
		EraRegistry.registerItem(solinium_igniter, solinium_igniter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(solinium_propellant, solinium_propellant.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(solinium_core, solinium_core.getUnlocalizedName(), ERA.COLDWAR);
		
		//N2
		EraRegistry.registerItem(n2_charge, n2_charge.getUnlocalizedName(), ERA.COLDWAR);
		
		//FSTBMB
		EraRegistry.registerItem(egg_balefire_shard, egg_balefire_shard.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(egg_balefire, egg_balefire.getUnlocalizedName(), ERA.COLDWAR);
		
		//Conventional Armor
		EraRegistry.registerItem(goggles, goggles.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ashglasses, ashglasses.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask, gas_mask.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_m65, gas_mask_m65.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_mono, gas_mask_mono.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas_mask_olde, gas_mask_olde.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(mask_rag, mask_rag.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(mask_piss, mask_piss.getUnlocalizedName(), ERA.ALWAYS);
		//EraRegistry.registerItem(oxy_mask, oxy_mask.getUnlocalizedName());
		EraRegistry.registerItem(hat, hat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(beta, beta.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(no9, no9.getUnlocalizedName(), ERA.ALWAYS);
		
		EraRegistry.registerItem(steel_helmet, steel_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_plate, steel_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_legs, steel_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steel_boots, steel_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_helmet, titanium_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_plate, titanium_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_legs, titanium_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(titanium_boots, titanium_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_helmet, alloy_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_plate, alloy_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_legs, alloy_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(alloy_boots, alloy_boots.getUnlocalizedName(), ERA.NEVER);
		
		//Custom Rods
		EraRegistry.registerItem(custom_tnt, custom_tnt.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_nuke, custom_nuke.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_hydro, custom_hydro.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_amat, custom_amat.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_dirty, custom_dirty.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_schrab, custom_schrab.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_fall, custom_fall.getUnlocalizedName(), ERA.NEVER);
		
		//Power Armor
		EraRegistry.registerItem(steamsuit_helmet, steamsuit_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steamsuit_plate, steamsuit_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steamsuit_legs, steamsuit_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(steamsuit_boots, steamsuit_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dieselsuit_helmet, dieselsuit_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dieselsuit_plate, dieselsuit_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dieselsuit_legs, dieselsuit_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dieselsuit_boots, dieselsuit_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(t45_helmet, t45_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(t45_plate, t45_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(t45_legs, t45_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(t45_boots, t45_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajr_helmet, ajr_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajr_plate, ajr_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajr_legs, ajr_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajr_boots, ajr_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajro_helmet, ajro_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajro_plate, ajro_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajro_legs, ajro_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(ajro_boots, ajro_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bj_helmet, bj_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bj_plate, bj_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bj_plate_jetpack, bj_plate_jetpack.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bj_legs, bj_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bj_boots, bj_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hev_helmet, hev_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hev_plate, hev_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hev_legs, hev_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hev_boots, hev_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(fau_helmet, fau_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(fau_plate, fau_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(fau_legs, fau_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(fau_boots, fau_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dns_helmet, dns_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dns_plate, dns_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dns_legs, dns_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dns_boots, dns_boots.getUnlocalizedName(), ERA.NEVER);
		
		//Nobody will ever read this anyway, so it shouldn't matter.
		EraRegistry.registerItem(chainsaw, chainsaw.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(igniter, igniter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(detonator, detonator.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(detonator_multi, detonator_multi.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(detonator_laser, detonator_laser.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(detonator_deadman, detonator_deadman.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(detonator_de, detonator_de.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(crate_caller, crate_caller.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bomb_caller, bomb_caller.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(meteor_remote, meteor_remote.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(anchor_remote, anchor_remote.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(defuser, defuser.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(reacher, reacher.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bismuth_tool, bismuth_tool.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(meltdown_tool, meltdown_tool.getUnlocalizedName(), ERA.ALWAYS);
		
		EraRegistry.registerItem(hazmat_helmet, hazmat_helmet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_plate, hazmat_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_legs, hazmat_legs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_boots, hazmat_boots.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_helmet_red, hazmat_helmet_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_plate_red, hazmat_plate_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_legs_red, hazmat_legs_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_boots_red, hazmat_boots_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_helmet_grey, hazmat_helmet_grey.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_plate_grey, hazmat_plate_grey.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_legs_grey, hazmat_legs_grey.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_boots_grey, hazmat_boots_grey.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_paa_helmet, hazmat_paa_helmet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_paa_plate, hazmat_paa_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_paa_legs, hazmat_paa_legs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(hazmat_paa_boots, hazmat_paa_boots.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(liquidator_helmet, liquidator_helmet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(liquidator_plate, liquidator_plate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(liquidator_legs, liquidator_legs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(liquidator_boots, liquidator_boots.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cmb_helmet, cmb_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_plate, cmb_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_legs, cmb_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cmb_boots, cmb_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(paa_plate, paa_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(paa_legs, paa_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(paa_boots, paa_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(asbestos_helmet, asbestos_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(asbestos_plate, asbestos_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(asbestos_legs, asbestos_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(asbestos_boots, asbestos_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(security_helmet, security_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(security_plate, security_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(security_legs, security_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(security_boots, security_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_helmet, cobalt_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_plate, cobalt_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_legs, cobalt_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(cobalt_boots, cobalt_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_helmet, starmetal_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_plate, starmetal_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_legs, starmetal_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(starmetal_boots, starmetal_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(zirconium_legs, zirconium_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dnt_helmet, dnt_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dnt_plate, dnt_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dnt_legs, dnt_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(dnt_boots, dnt_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_helmet, schrabidium_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_plate, schrabidium_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_legs, schrabidium_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(schrabidium_boots, schrabidium_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bismuth_helmet, bismuth_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bismuth_plate, bismuth_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bismuth_legs, bismuth_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(bismuth_boots, bismuth_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(euphemium_helmet, euphemium_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(euphemium_plate, euphemium_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(euphemium_legs, euphemium_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(euphemium_boots, euphemium_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(robes_helmet, robes_helmet.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(robes_plate, robes_plate.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(robes_legs, robes_legs.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(robes_boots, robes_boots.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(apple_euphemium, apple_euphemium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(watch, watch.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(mask_of_infamy, mask_of_infamy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(australium_iii, australium_iii.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(jackt, jackt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(jackt2, jackt2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(jetpack_fly, jetpack_fly.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(jetpack_break, jetpack_break.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(jetpack_vector, jetpack_vector.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(jetpack_boost, jetpack_boost.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(wings_limp, wings_limp.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(wings_murk, wings_murk.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(australium_iv, australium_iv.getUnlocalizedName());
		//EraRegistry.registerItem(australium_v, australium_v.getUnlocalizedName());
		
		//Expensive Ass Shit
		EraRegistry.registerItem(crystal_horn, crystal_horn.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerItem(crystal_charred, crystal_charred.getUnlocalizedName(), ERA.COLDWAR);
		
		//OP Tools
		EraRegistry.registerItem(wand, wand.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(wand_s, wand_s.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(wand_d, wand_d.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(structure_single, structure_single.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(structure_solid, structure_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(structure_pattern, structure_pattern.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(structure_randomized, structure_randomized.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(structure_randomly, structure_randomly.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(rod_of_discord, rod_of_discord.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(analyzer, analyzer.getUnlocalizedName(), ERA.NEVER);
		//EraRegistry.registerItem(remote, remote.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(euphemium_stopper, euphemium_stopper.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(polaroid, polaroid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(glitch, glitch.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(book_secret, book_secret.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(book_of_, book_of_.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(burnt_bark, burnt_bark.getUnlocalizedName(), ERA.NEVER);
		
		//Kits
		EraRegistry.registerItem(nuke_starter_kit, nuke_starter_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(nuke_advanced_kit, nuke_advanced_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(nuke_commercially_kit, nuke_commercially_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(nuke_electric_kit, nuke_electric_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(gadget_kit, gadget_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(boy_kit, boy_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(man_kit, man_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(mike_kit, mike_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(tsar_kit, tsar_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(prototype_kit, prototype_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(fleija_kit, fleija_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(solinium_kit, solinium_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(multi_kit, multi_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(custom_kit, custom_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(missile_kit, missile_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(grenade_kit, grenade_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(t45_kit, t45_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hazmat_kit, hazmat_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hazmat_red_kit, hazmat_red_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(hazmat_grey_kit, hazmat_grey_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(kit_custom, kit_custom.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(euphemium_kit, euphemium_kit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(kit_toolbox_empty, kit_toolbox_empty.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(kit_toolbox, kit_toolbox.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(letter, letter.getUnlocalizedName(), ERA.NEVER);
		
		//Misile Loot Boxes
		EraRegistry.registerItem(loot_10, loot_10.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(loot_15, loot_15.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerItem(loot_misc, loot_misc.getUnlocalizedName(), ERA.NEVER);
		
		//THIS is a bucket.
		EraRegistry.registerItem(bucket_mud, bucket_mud.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bucket_acid, bucket_acid.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bucket_toxic, bucket_toxic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bucket_schrabidic_acid, bucket_schrabidic_acid.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bucket_sulfuric_acid, bucket_sulfuric_acid.getUnlocalizedName(), ERA.ALWAYS);
		
		//Door Items
		EraRegistry.registerItem(door_metal, door_metal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(door_office, door_office.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(door_bunker, door_bunker.getUnlocalizedName(), ERA.ALWAYS);
		
		//Records
		EraRegistry.registerItem(record_lc, record_lc.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(record_ss, record_ss.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(record_vc, record_vc.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(record_glass, record_glass.getUnlocalizedName(), ERA.ALWAYS);
		
		//wow we're far down the item registry, is this the cellar?
		EraRegistry.registerItem(book_guide, book_guide.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(book_lore, book_lore.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(holotape_damaged, holotape_damaged.getUnlocalizedName(), ERA.ALWAYS);
		
		//Technical Items
		EraRegistry.registerItem(smoke1, smoke1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke2, smoke2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke3, smoke3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke4, smoke4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke5, smoke5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke6, smoke6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke7, smoke7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(smoke8, smoke8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke1, b_smoke1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke2, b_smoke2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke3, b_smoke3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke4, b_smoke4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke5, b_smoke5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke6, b_smoke6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke7, b_smoke7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(b_smoke8, b_smoke8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke1, d_smoke1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke2, d_smoke2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke3, d_smoke3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke4, d_smoke4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke5, d_smoke5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke6, d_smoke6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke7, d_smoke7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(d_smoke8, d_smoke8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill1, spill1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill2, spill2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill3, spill3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill4, spill4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill5, spill5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill6, spill6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill7, spill7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(spill8, spill8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas1, gas1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas2, gas2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas3, gas3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas4, gas4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas5, gas5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas6, gas6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas7, gas7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(gas8, gas8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine1, chlorine1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine2, chlorine2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine3, chlorine3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine4, chlorine4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine5, chlorine5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine6, chlorine6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine7, chlorine7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(chlorine8, chlorine8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc1, pc1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc2, pc2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc3, pc3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc4, pc4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc5, pc5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc6, pc6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc7, pc7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(pc8, pc8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud1, cloud1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud2, cloud2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud3, cloud3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud4, cloud4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud5, cloud5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud6, cloud6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud7, cloud7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(cloud8, cloud8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange1, orange1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange2, orange2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange3, orange3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange4, orange4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange5, orange5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange6, orange6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange7, orange7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(orange8, orange8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(energy_ball, energy_ball.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(discharge, discharge.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(empblast, empblast.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_1, flame_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_2, flame_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_3, flame_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_4, flame_4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_5, flame_5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_6, flame_6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_7, flame_7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_8, flame_8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_9, flame_9.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(flame_10, flame_10.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_1, ln2_1.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_2, ln2_2.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_3, ln2_3.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_4, ln2_4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_5, ln2_5.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_6, ln2_6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_7, ln2_7.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_8, ln2_8.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_9, ln2_9.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(ln2_10, ln2_10.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(nothing, nothing.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(void_anim, void_anim.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bob_metalworks, bob_metalworks.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bob_assembly, bob_assembly.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bob_chemistry, bob_chemistry.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bob_oil, bob_oil.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(bob_nuclear, bob_nuclear.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(digamma_see, digamma_see.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(digamma_feel, digamma_feel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(digamma_know, digamma_know.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(digamma_kauai_moho, digamma_kauai_moho.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(digamma_up_on_top, digamma_up_on_top.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(mysteryshovel, mysteryshovel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerItem(memory, memory.getUnlocalizedName(), ERA.ALWAYS);
		
		//CONSERVE REMAP
		addRemap("canned_beef", canned_conserve, EnumFoodType.BEEF, ERA.ALWAYS);
		addRemap("canned_tuna", canned_conserve, EnumFoodType.TUNA, ERA.ALWAYS);
		addRemap("canned_mystery", canned_conserve, EnumFoodType.MYSTERY, ERA.ALWAYS);
		addRemap("canned_pashtet", canned_conserve, EnumFoodType.PASHTET, ERA.ALWAYS);
		addRemap("canned_cheese", canned_conserve, EnumFoodType.CHEESE, ERA.ALWAYS);
		addRemap("canned_jizz", canned_conserve, EnumFoodType.JIZZ, ERA.ALWAYS);
		addRemap("canned_milk", canned_conserve, EnumFoodType.MILK, ERA.ALWAYS);
		addRemap("canned_ass", canned_conserve, EnumFoodType.ASS, ERA.ALWAYS);
		addRemap("canned_pizza", canned_conserve, EnumFoodType.PIZZA, ERA.ALWAYS);
		addRemap("canned_tube", canned_conserve, EnumFoodType.TUBE, ERA.ALWAYS);
		addRemap("canned_tomato", canned_conserve, EnumFoodType.TOMATO, ERA.ALWAYS);
		addRemap("canned_asbestos", canned_conserve, EnumFoodType.ASBESTOS, ERA.ALWAYS);
		addRemap("canned_bhole", canned_conserve, EnumFoodType.BHOLE, ERA.ALWAYS);
		addRemap("canned_hotdogs", canned_conserve, EnumFoodType.HOTDOGS, ERA.ALWAYS);
		addRemap("canned_leftovers", canned_conserve, EnumFoodType.LEFTOVERS, ERA.ALWAYS);
		addRemap("canned_yogurt", canned_conserve, EnumFoodType.YOGURT, ERA.ALWAYS);
		addRemap("canned_stew", canned_conserve, EnumFoodType.STEW, ERA.ALWAYS);
		addRemap("canned_chinese", canned_conserve, EnumFoodType.CHINESE, ERA.ALWAYS);
		addRemap("canned_oil", canned_conserve, EnumFoodType.OIL, ERA.ALWAYS);
		addRemap("canned_fist", canned_conserve, EnumFoodType.FIST, ERA.ALWAYS);
		addRemap("canned_spam", canned_conserve, EnumFoodType.SPAM, ERA.ALWAYS);
		addRemap("canned_fried", canned_conserve, EnumFoodType.FRIED, ERA.ALWAYS);
		addRemap("canned_napalm", canned_conserve, EnumFoodType.NAPALM, ERA.ALWAYS);
		addRemap("canned_diesel", canned_conserve, EnumFoodType.DIESEL, ERA.ALWAYS);
		addRemap("canned_kerosene", canned_conserve, EnumFoodType.KEROSENE, ERA.ALWAYS);
		addRemap("canned_recursion", canned_conserve, EnumFoodType.RECURSION, ERA.ALWAYS);
		addRemap("canned_bark", canned_conserve, EnumFoodType.BARK, ERA.ALWAYS);
		
		addRemap("rod_zirnox_natural_uranium_fuel", rod_zirnox, EnumZirnoxType.NATURAL_URANIUM_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_uranium_fuel", rod_zirnox, EnumZirnoxType.URANIUM_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_th232", rod_zirnox, EnumZirnoxType.TH232, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_thorium_fuel", rod_zirnox, EnumZirnoxType.THORIUM_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_mox_fuel", rod_zirnox, EnumZirnoxType.MOX_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_plutonium_fuel", rod_zirnox, EnumZirnoxType.PLUTONIUM_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_u233_fuel", rod_zirnox, EnumZirnoxType.U233_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_u235_fuel", rod_zirnox, EnumZirnoxType.U235_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_les_fuel", rod_zirnox, EnumZirnoxType.LES_FUEL, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_lithium", rod_zirnox, EnumZirnoxType.LITHIUM, ERA.SECONDWORLDWAR);
		addRemap("rod_zirnox_zfb_mox", rod_zirnox, EnumZirnoxType.ZFB_MOX, ERA.SECONDWORLDWAR);

		addRemap("gas_petroleum", gas_full, Fluids.PETROLEUM.getID(), ERA.ALWAYS);
		addRemap("gas_biogas", gas_full, Fluids.BIOGAS.getID(), ERA.ALWAYS);
		addRemap("gas_lpg", gas_full, Fluids.LPG.getID(), ERA.ALWAYS);
	}
	
	public static void addRemap(String unloc, int removoingTheseWouldTakeForever, Item item, Enum sub, ERA era) {
		addRemap(unloc, item, sub.ordinal(), era);
	}
	
	public static void addRemap(String unloc, Item item, Enum sub, ERA era) {
		addRemap(unloc, item, sub.ordinal(), era);
	}

	public static void addRemap(String unloc, Item item, int meta, ERA era) {
		if(era.ordinal() <= Constants.CURRENT_ERA.ordinal()) {
			Item remap = new ItemRemap(item, meta).setUnlocalizedName(unloc).setTextureName(RefStrings.MODID + ":plate_armor_titanium");
			EraRegistry.registerItem(remap, remap.getUnlocalizedName(), era);
		}
	}
}