...
import com.hbm.blocks.ModBlocks;                  //Rosen sind rot
import com.hbm.handler.BucketHandler;             //Diese Mod ist gut
import com.hbm.handler.ToolAbility;               //Auch so sehr mir es auch weh tut
import com.hbm.handler.ToolAbility.LuckAbility;   //Ich hab den mut
import com.hbm.handler.WeaponAbility;             //tschuldigung bob
import com.hbm.handler.FluidTypeHandler.FluidType;//es klingt für mich sehr verlockend
import com.hbm.handler.guncfg.*;                  //würdest du mich jetzt entblocken
...
public class ModItems {
	...
	public static Item gun_ar15_semi;
	public static Item gun_hydrokar;
	...
	{			
		...
		gun_ar15_semi = new ItemGunBase(Gun556mmFactory.getJoshuaConfig()).setUnlocalizedName("gun_ar15_semi").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":gun_ar15");
		gun_hydrokar = new ItemGunBase(Gun556mmFactory.getHydroKarConfig()).setUnlocalizedName("gun_hydrokar").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":hydrokar");
		...
		gun_meme = new ItemGunBase(GunDartFactory.getMemeConfig()).setUnlocalizedName("gun_meme").setFull3D().setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":gun_meme");
		...
		bobcorn = new ItemLemon(2, 5, false).setUnlocalizedName("bobcorn").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":bobcorn");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(gun_ar15_semi, gun_ar15_semi.getUnlocalizedName());
		GameRegistry.registerItem(gun_hydrokar, gun_hydrokar.getUnlocalizedName());
		...
		GameRegistry.registerItem(gun_meme, gun_meme.getUnlocalizedName());
		...
		GameRegistry.registerItem(bobcorn, bobcorn.getUnlocalizedName());
...
res/armor/liquidator_1.png").cloneStats((ArmorFSB) liquidator_helmet).setUnlocalizedName("liquidator_boots").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":liquidator_boots");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(catalyst_clay, catalyst_clay.getUnlocalizedName());
		GameRegistry.registerItem(missile_assembly, missile_assembly.getUnlocalizedName());
		GameRegistry.registerItem(warhea
