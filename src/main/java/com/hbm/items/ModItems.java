...
public class ModItems {
	...
	{			
		...
		powder_tektite = new ItemHazard().addAsbestos(3).toItem().setUnlocalizedName("powder_tektite").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_tektite");
