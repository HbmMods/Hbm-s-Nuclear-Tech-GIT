...
public class PotionConfig {
	...
	public static int femboyID = 73;
	public static int estrogenID = 74;
	...
	public static void loadFromConfig(Configuration config) {
		...
		femboyID = CommonConfig.createConfigInt(config, CATEGORY_POTION, "8.11_femboyID", "What potion ID the femboy effect will have", 73);
		estrogenID = CommonConfig.createConfigInt(config, CATEGORY_POTION, "8.12_estrogenID", "What potion ID the estrogen effect will have", 74);
