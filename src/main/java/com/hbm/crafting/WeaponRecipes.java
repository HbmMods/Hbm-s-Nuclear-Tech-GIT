...
public class WeaponRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_revolver_saturnite, 1), new Object[] { "SSM", " RW", 'S', BIGMT.plate(), 'W', ModItems.bolt_dura_steel, 'R', ModItems.wire_tungsten, 'M', ModItems.gun_revolver});
	    ...
	    CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_bolt_action_saturnite, 1), new Object[]{"GSG","PPR","  P", 'P', BIGMT.plate(),'R', ModItems.gun_bolt_action, 'S', STEEL.plate(), 'G', ModBlocks.glass_quartz});
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_uzi, 1), new Object[] { "SMS", " PB", " P ", 'S', DURA.ingot(), 'M', ModItems.mechanism_rifle_1, 'P', STEEL.plate(), 'B', ModItems.bolt_dura_steel });
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_uzi_saturnite, 1), new Object[] { "SMS", " PB", " P ", 'S', BIGMT.ingot(), 'M', ModItems.gun_uzi, 'P', BIGMT.plate(), 'B', ModItems.bolt_tungsten });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_uzi_saturnite_silencer, 1), new Object[] { "SMS", " PB", " P ", 'S', BIGMT.ingot(), 'M', ModItems.gun_uzi_silencer, 'P', BIGMT.plate(), 'B', ModItems.bolt_tungsten });
