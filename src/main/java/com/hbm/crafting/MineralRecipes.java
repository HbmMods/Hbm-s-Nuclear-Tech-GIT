...
public class MineralRecipes {
	...
	public static void register() {
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.fallout, 1), new Object[] { "#", '#', ModItems.falloball });
		GameRegistry.addRecipe(new ItemStack(ModItems.falloball, 1), new Object[] { "#", '#', ModItems.fallout });
