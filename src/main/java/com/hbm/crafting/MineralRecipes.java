...
public class MineralRecipes {
	...
	public static void register() {
		...
		GameRegistry.addRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.block_ferrouranium), 1), new Object[] {"###", "###", "###", '#', ModItems.ingot_ferrouranium});
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.ingot_ferrouranium, 9), new Object[] {"#", '#', Item.getItemFromBlock(ModBlocks.block_ferrouranium)});
