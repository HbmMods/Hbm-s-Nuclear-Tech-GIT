...
public class ArmorRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.bj_helmet, 1), new Object[] { "SBS", "NCN", "III", 'S', ModItems.plate_armor_lunar, 'B',ModItems.bj_eyepatch,'N', KEY_ANYPANE ,'C', ModItems.starmetal_helmet, 'I', STAR.ingot() });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.bj_eyepatch, 1), new Object[] { "SBS", " C ", " I ", 'S', Items.string, 'B', new ItemStack(Blocks.wool, 1, 15), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ADVANCED), 'I', STAR.ingot() });
