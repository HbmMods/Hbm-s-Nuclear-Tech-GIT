...
public class ConsumableRecipes {
	...
	public static void register() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.piano_woman), new Object[] { Items.glass_bottle, Items.water_bucket, ModItems.powder_asbestos, ModItems.dust, ModItems.powder_steel, ModItems.circuit_aluminium, ModItems.canister_napalm, Items.sugar, ModItems.solid_fuel });
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.syringe_morphine), new Object[] { ModItems.syringe_empty, "dustLanthanum", Items.milk_bucket })); 
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pill_calcium), new Object[] { ModItems.powder_calcium, ModItems.powder_fire, Items.sugar });
