...
public class CraftingManager {
	...
	public static void AddCraftingRec() {
		...
		addRecipeAuto(new ItemStack(ModBlocks.red_pylon_steel, 4), new Object[] { "CWC", "PWP", " T ", 'C', ModItems.coil_copper, 'W', STEEL.pipe(), 'P', ModItems.plate_polymer, 'T', ModBlocks.red_wire_coated });
