...
public class CraftingManager {
	...
	public static void AddCraftingRec() {
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.deuterium_filter, 1), new Object[] { "TST", "SCS", "TST", 'T', ModItems.ingot_tcalloy, 'S', ModItems.sulfur, 'C', ModItems.catalyst_clay });
	...
	public static void AddSmeltingRec()
	{
		...
		GameRegistry.addSmelting(ModItems.raw_zirconium, new ItemStack(ModItems.nugget_zirconium), 24.0F);
		...
		GameRegistry.addSmelting(ModItems.powder_technetium, new ItemStack(ModItems.ingot_technetium), 1.0F);
