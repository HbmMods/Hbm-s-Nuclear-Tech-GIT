...
public class CraftingManager {
	...
	public static void reg2() {
		...
		addRecipeAuto(new ItemStack(ModItems.drone, 2, EnumDroneType.PATROL.ordinal()), new Object[] { "PPP", "HCH", " H ", 'P', ANY_PLASTIC.ingot(), 'H', STEEL.shell(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.VACUUM_TUBE) });
		...
		addRecipeAuto(new ItemStack(ModItems.drone, 1, EnumDroneType.PATROL_EXPRESS.ordinal()), new Object[] { " P ", "KDK", " P ", 'P', TI.plateCast(), 'K', Fluids.KEROSENE.getDict(1_000), 'D', new ItemStack(ModItems.drone, 1, EnumDroneType.PATROL.ordinal()) });
		...
		addRecipeAuto(new ItemStack(ModItems.drone, 1, EnumDroneType.PATROL_EXPRESS_CHUNKLOADING.ordinal()), new Object[] { " P ", "KDK", " P ", 'P', TI.plateCast(), 'K', Fluids.KEROSENE.getDict(1_000), 'D', new ItemStack(ModItems.drone, 1, EnumDroneType.PATROL_CHUNKLOADING.ordinal()) });
		...
		addRecipeAuto(new ItemStack(ModBlocks.drone_waypoint, 8), new Object[] { "G", "T", "C", 'G', KEY_GREEN, 'T', Blocks.redstone_torch, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC) });
		addShapelessAuto(new ItemStack(ModBlocks.drone_waypoint_request), new Object[] { new ItemStack(ModBlocks.drone_waypoint)});
		addShapelessAuto(new ItemStack(ModBlocks.drone_waypoint), new Object[] { new ItemStack(ModBlocks.drone_waypoint_request)});

		addRecipeAuto(new ItemStack(ModBlocks.drone_crate, 2), new Object[] { "T", "C", 'T', ModBlocks.drone_waypoint, 'C', ModBlocks.crate_steel });
		addRecipeAuto(new ItemStack(ModBlocks.drone_crate_provider, 4), new Object[] { "T", "C", "B", 'T', ModBlocks.drone_waypoint_request, 'C', ModBlocks.crate_steel, 'B', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ANALOG) });
		addShapelessAuto(new ItemStack(ModBlocks.drone_crate_requester), new Object[] { new ItemStack(ModBlocks.drone_crate_provider)});
		addShapelessAuto(new ItemStack(ModBlocks.drone_crate_provider), new Object[] { new ItemStack(ModBlocks.drone_crate_requester)});
