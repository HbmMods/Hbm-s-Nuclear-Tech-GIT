...
public class ResourceManager {
	...
	public static final IModelCustom cc_plasma = new HFRWavefrontObject(new ResourceLocation(RefStrings.MODID, "models/weapons/cc_assault_rifle.obj"));
	...
	public static final ResourceLocation cc_plasma_tex = new ResourceLocation(RefStrings.MODID, "textures/models/weapons/cc_assault_rifle.png.png");
