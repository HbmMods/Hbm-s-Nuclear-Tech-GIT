...
public class ResourceManager {
	...
	public static final IModelCustom mp_w_fairing = AdvancedModelLoader.loadModel(new ResourceLocation(RefStrings.MODID, "models/missile_parts/mp_w_fairing.obj"));
