...
public class GunGrenadeFactory {
	...
	public static BulletConfiguration getGrenadeLeadbursterConfig() {
		...
		bullet.bntImpact = (bulletnt, x, y, z, sideHit) -> {
			...
			switch(sideHit) {
			case 0: bulletnt.rotationPitch = (90); break;
			case 1: bulletnt.rotationPitch = (-90); break;
			case 2: bulletnt.rotationPitch = 0; bulletnt.rotationYaw = 0; break;
			case 3: bulletnt.rotationPitch = 0; bulletnt.rotationYaw = 180; break;
			case 4: bulletnt.rotationPitch = 0; bulletnt.rotationYaw = 90; break;
			case 5: bulletnt.rotationPitch = 0; bulletnt.rotationYaw = -90; break;
			}
		...
		bullet.bntUpdate = (bulletnt) -> {
			...
			for(int i = 0; i < 5; i++) {
				...
				pellet.prevRotationPitch = pellet.rotationPitch = (float) (Math.atan2(pellet.motionY, hyp) * 180.0D / Math.PI);
