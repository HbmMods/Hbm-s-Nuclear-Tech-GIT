...
public class Gun22LRFactory {
	...
	public static BulletConfiguration get22LRConfig() {
		...
		{
				final double dmgMod = MathHelper.clamp_double(projectile.getDistanceSqToEntity(projectile.shooter), 0, 12);
				projectile.overrideDamage = (float) dmgMod;
		};
	...
	public static BulletConfiguration get22LRAPConfig() {
		...
		bullet.bHurt = (projectile, hit) ->
		{
				final double dmgMod = MathHelper.clamp_double(projectile.getDistanceSqToEntity(projectile.shooter), 0, 20);
				projectile.overrideDamage = (float) dmgMod;
		};
		return bullet;
	}
