...
import com.hbm.packet.TEPassengerPacket;
...
public class TileEntityLaunchPadPassenger extends TileEntityLoadedBase implements ISidedInventory, IEnergyReceiverMK2, SimpleComponent, IGUIProvider {
	...
	public TileEntityLaunchPadPassenger() {
	...
	public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new ContainerLaunchPadTier2(player.inventory, this);
	}

	@Override
	@SideOnly(Side.CLIENT)
	public GuiScreen provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new GUILaunchPadTier2(player.inventory, this);
	}
}
