...
public class TileEntityMachineTurbineGas extends TileEntityMachineBase implements IFluidStandardTransceiver, IEnergyProviderMK2, IControlReceiver, IGUIProvider, SimpleComponent, IInfoProviderEC, CompatHandler.OCComponent, IFluidCopiable, IConfigurableMachine {
	...
	public static int rpmIdle = 10;
	public static int tempIdle = 300;
	...
	public void readIfPresent(JsonObject obj) {
		...
		rpmIdle = IConfigurableMachine.grab(obj, "I:rpmIdle", rpmIdle);
		tempIdle = IConfigurableMachine.grab(obj, "I:tempIdle", tempIdle);
	}

	@Override
	public void writeConfig(JsonWriter writer) throws IOException {
		writer.name("L:maxPower").value(maxPower);
		writer.name("I:rpmIdle").value(rpmIdle);
		writer.name("I:tempIdle").value(tempIdle);
	}
