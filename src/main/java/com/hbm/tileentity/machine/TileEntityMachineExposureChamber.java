...
public class TileEntityMachineExposureChamber extends TileEntityMachineBase implements IGUIProvider, IEnergyReceiverMK2, IUpgradeInfoProvider, IConfigurableMachine {
	...
	public static int processTimeBase = 200;
	public static int consumptionBase = 10_000;
	public static int maxParticles = 8;

	@Override
	public String getConfigName() {
		return "exposureChamber";
	}

	@Override
	public void readIfPresent(JsonObject obj) {
		maxPower = IConfigurableMachine.grab(obj, "L:maxPower", maxPower);
		processTimeBase = IConfigurableMachine.grab(obj, "I:processTime", processTime);
		consumptionBase = IConfigurableMachine.grab(obj, "I:consumption", consumptionBase);
		maxParticles = IConfigurableMachine.grab(obj, "I:maxParticles", maxParticles);
	}

	@Override
	public void writeConfig(JsonWriter writer) throws IOException {
		writer.name("L:maxPower").value(maxPower);
		writer.name("I:processTime").value(processTime);
		writer.name("I:consumption").value(consumptionBase);
		writer.name("I:maxParticles").value(maxParticles);
	}
