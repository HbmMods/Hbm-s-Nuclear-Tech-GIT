...
import com.hbm.inventory.container.ContainerHeaterHugeHeatex;
import com.hbm.inventory.fluid.FluidType;
import com.hbm.inventory.fluid.Fluids;
import com.hbm.inventory.fluid.tank.FluidTank;
import com.hbm.inventory.fluid.trait.FT_Coolable;
import com.hbm.inventory.fluid.trait.FT_Coolable.CoolingType;
import com.hbm.inventory.gui.GUIHeaterHugeHeatex;
...
public class TileEntityHeaterHugeHeatex extends TileEntityMachineBase implements IHeatHugeSource, INBTPacketReceiver, IFluidStandardTransceiver, IGUIProvider, IControlReceiver {
	...
	public TileEntityHeaterHugeHeatex() {
		super(1);
		this.tanks = new FluidTank[2];
		this.tanks[0] = new FluidTank(Fluids.COOLANT_HOT, 10_000_000, 0);
		this.tanks[1] = new FluidTank(Fluids.COOLANT, 10_000_000, 1);
	}

	@Override
	public String getName() {
		return "container.heaterHugeHeatex";
	}
	...
	public void networkUnpack(NBTTagCompound nbt) {
		...
		this.heatEnergy = nbt.getLong("heat");
	...
	protected void tryConvert() {
		...
		this.heatEnergy += (long)trait.heatEnergy * (long)ops * (long)trait.getEfficiency(CoolingType.HEATEXCHANGER);
		this.markChanged();
	}
	...
	public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new ContainerHeaterHugeHeatex(player.inventory, this);
	}

	@Override
	@SideOnly(Side.CLIENT)
	public GuiScreen provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new GUIHeaterHugeHeatex(player.inventory, this);
	}
