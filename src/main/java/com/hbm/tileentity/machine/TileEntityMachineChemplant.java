...
public class TileEntityMachineChemplant extends TileEntityMachineBase implements IConfigurableMachine, IEnergyReceiverMK2, IFluidStandardTransceiver, IGUIProvider, IUpgradeInfoProvider {

	public long power;
	public int progress;
	public int maxProgress = 100; // Not configurable at all...
	...
	// simply added those two values to avoid messing too much with the original code...
