...
public class TileEntityMachineTurbine extends TileEntity implements ISidedInventory, IFluidContainer, IFluidAcceptor, IFluidSource, IEnergySource {
	...
	public int age = 0;
	public List<IEnergyConsumer> list1 = new ArrayList();
