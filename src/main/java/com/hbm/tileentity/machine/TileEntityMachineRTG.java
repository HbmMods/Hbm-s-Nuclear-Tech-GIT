...
public class TileEntityMachineRTG extends TileEntityLoadedBase implements ISidedInventory, IEnergyProviderMK2, IGUIProvider, IInfoProviderEC, IConfigurableMachine {
	...
	// configurable values
	public static long powerMax = 100000;
	...
	public void readIfPresent(JsonObject obj) {
		powerMax = IConfigurableMachine.grab(obj, "L:maxPower", powerMax);
	}

	@Override
	public void writeConfig(JsonWriter writer) throws IOException {
		writer.name("L:maxPower").value(powerMax);
	}
