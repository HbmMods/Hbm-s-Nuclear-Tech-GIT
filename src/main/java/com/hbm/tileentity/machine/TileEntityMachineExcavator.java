...
public class TileEntityMachineExcavator extends TileEntityMachineBase implements IEnergyReceiverMK2, IFluidStandardReceiver, IControlReceiver, IGUIProvider, IUpgradeInfoProvider, IFluidCopiable, IConfigurableMachine {
	...
	public static long baseConsumption = 10_000L;
	...
	public void readIfPresent(JsonObject obj) {
		...
		baseConsumption = IConfigurableMachine.grab(obj, "L:consumption", baseConsumption);
	}

	@Override
	public void writeConfig(JsonWriter writer) throws IOException {
		writer.name("L:maxPower").value(maxPower);
		writer.name("L:consumption").value(baseConsumption);
	}
