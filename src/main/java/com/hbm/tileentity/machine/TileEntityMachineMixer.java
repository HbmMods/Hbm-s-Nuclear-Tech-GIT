...
public class TileEntityMachineMixer extends TileEntityMachineBase implements INBTPacketReceiver, IControlReceiver, IGUIProvider, IEnergyReceiverMK2, IFluidStandardTransceiver, IUpgradeInfoProvider, IFluidCopiable, IConfigurableMachine {

	public long power;
	public int progress;
	public int processTime; // not configurable: recipe based time!
	public int recipeIndex;
	private int consumption = baseConsumption;
