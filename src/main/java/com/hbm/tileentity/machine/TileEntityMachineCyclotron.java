...
public class TileEntityMachineCyclotron extends TileEntityMachineBase implements IEnergyReceiverMK2, IFluidStandardTransceiver, IGUIProvider, IConditionalInvAccess, IUpgradeInfoProvider, IInfoProviderEC, IFluidCopiable, IConfigurableMachine {
	...
	// configurable values
	public static long maxPower = 100_000_000;
	public static int consumption = 1_000_000;
	public static int duration = 690;
	...
	public void readIfPresent(JsonObject obj) {
		...
		duration = IConfigurableMachine.grab(obj, "I:duration", duration);
	}
	...
	public void writeConfig(JsonWriter writer) throws IOException {
		...
		writer.name("I:duration").value(duration);
	}
