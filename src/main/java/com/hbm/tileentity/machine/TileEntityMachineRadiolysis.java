...
public class TileEntityMachineRadiolysis extends TileEntityMachineBase implements IEnergyProviderMK2, IFluidStandardTransceiver, IGUIProvider, IInfoProviderEC, IFluidCopiable, IConfigurableMachine {
	...
	// configurable values:
	public static int maxPower = 1000000;
