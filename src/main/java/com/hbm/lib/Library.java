...
public class Library {
	...
	{
		if (slots[index] != null && slots[index].getItem() instanceof IDataStorageUser)
		{
			IDataStorageUser medium = (IDataStorageUser) slots[index].getItem();
			long cur = IDataStorageUser.getDataUsed(slots[index]);
