...
public class LaunchPadRocket extends BlockDummyable implements ILookOverlay {
	...
	public void printHook(Pre event, World world, int x, int y, int z) {
		...
		if(pad.requiredSolidFuel > 0) {
			text.add(EnumChatFormatting.GREEN + "-> " + EnumChatFormatting.RESET + I18nUtil.resolveKey(ModItems.rocket_fuel.getUnlocalizedName() + ".name") + ": " + pad.solidFuel + "/" + pad.requiredSolidFuel + "kg");
		}
