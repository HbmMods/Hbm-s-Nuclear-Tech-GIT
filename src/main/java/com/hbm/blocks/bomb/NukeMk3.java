...
import com.hbm.tileentity.bomb.TileEntityNukeMk3;
...
public class NukeMk3 extends BlockContainer implements IBomb {

	public TileEntityNukeMk3 tetn = new TileEntityNukeMk3();

	private final Random field_149933_a = new Random();
	private static boolean keepInventory = false;

	public NukeMk3(Material p_i45386_1_) {
		super(p_i45386_1_);
	}

	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityNukeMk3();
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_) {
		if(!keepInventory) {
			TileEntityNukeMk3 tileentityfurnace = (TileEntityNukeMk3) p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(world.isRemote) {
			...
			TileEntityNukeMk3 entity = (TileEntityNukeMk3) world.getTileEntity(x, y, z);
			if(entity != null) {
	...
	public void onNeighborBlockChange(World p_149695_1_, int x, int y, int z, Block p_149695_5_) {
		TileEntityNukeMk3 entity = (TileEntityNukeMk3) p_149695_1_.getTileEntity(x, y, z);
