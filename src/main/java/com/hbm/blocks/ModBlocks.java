...
public class ModBlocks {
	...
	public static Block ore_ardite;
	...
	private static void initializeBlock() {
		...
		ore_ardite = new BlockOre(Material.rock).setBlockName("ore_ardite").setCreativeTab(MainRegistry.blockTab).setHardness(1.5F).setResistance(600.0F).setBlockTextureName(RefStrings.MODID + ":ore_ardite");
		ore_nickel = new BlockOre(Material.rock).setBlockName("ore_nickel").setCreativeTab(MainRegistry.blockTab).setHardness(1.5F).setResistance(600.0F).setBlockTextureName(RefStrings.MODID + ":ore_nickel");
		ore_platinum = new BlockOre(Material.rock).setBlockName("ore_platinum").setCreativeTab(MainRegistry.blockTab).setHardness(1.5F).setResistance(600.0F).setBlockTextureName(RefStrings.MODID + ":ore_platinum");
		ore_silver = new BlockOre(Material.rock).setBlockName("ore_silver").setCreativeTab(MainRegistry.blockTab).setHardness(1.5F).setResistance(600.0F).setBlockTextureName(RefStrings.MODID + ":ore_silver");
		ore_tin = new BlockOre(Material.rock).setBlockName("ore_tin").setCreativeTab(MainRegistry.blockTab).setHardness(1.5F).setResistance(600.0F).setBlockTextureName(RefStrings.MODID + ":ore_tin");
	...
	private static void registerBlock() {
		//Test
		EraRegistry.registerBlock(test_render, test_render.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_bomb, test_bomb.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_bomb_advanced, test_bomb_advanced.getUnlocalizedName(), ERA.NEVER);
		
		EraRegistry.registerBlock(test_nuke, test_nuke.getUnlocalizedName(), ERA.NEVER);
		
		EraRegistry.registerBlock(event_tester, event_tester.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(obj_tester, obj_tester.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_core, test_core.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_charge, test_charge.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_pipe, test_pipe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_ct, test_ct.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(test_rail, test_rail.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(structure_anchor, structure_anchor.getUnlocalizedName(), ERA.NEVER);

		//Ores
		EraRegistry.registerBlock(ore_ardite, ItemBlockLore.class, ore_ardite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_nickel, ItemBlockLore.class, ore_nickel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_platinum, ItemBlockLore.class, ore_platinum.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_silver, ItemBlockLore.class, ore_silver.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_tin, ItemBlockLore.class, ore_tin.getUnlocalizedName(), ERA.ALWAYS);
		
		EraRegistry.registerBlock(ore_uranium, ore_uranium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(ore_uranium_scorched, ore_uranium_scorched.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_thorium, ore_thorium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(ore_titanium, ore_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_sulfur, ore_sulfur.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_niter, ore_niter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_copper, ore_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_tungsten, ore_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_aluminium, ore_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_fluorite, ore_fluorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_beryllium, ore_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_lead, ore_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_oil, ItemBlockLore.class, ore_oil.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_oil_empty, ore_oil_empty.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_oil_sand, ore_oil_sand.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_lignite, ore_lignite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_asbestos, ore_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_schrabidium, ItemBlockLore.class, ore_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		
		//Rare Minerals
		EraRegistry.registerBlock(ore_australium, ItemOreBlock.class, ore_australium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(ore_weidanium, ItemOreBlock.class, ore_weidanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_reiium, ItemOreBlock.class, ore_reiium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_unobtainium, ItemOreBlock.class, ore_unobtainium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_daffergon, ItemOreBlock.class, ore_daffergon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_verticium, ItemOreBlock.class, ore_verticium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_rare, ItemOreBlock.class, ore_rare.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_cobalt, ore_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_cinnebar, ore_cinnebar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_coltan, ore_coltan.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Stone clusters
		EraRegistry.registerBlock(cluster_iron, ItemBlockBase.class, cluster_iron.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cluster_titanium, ItemBlockBase.class, cluster_titanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cluster_aluminium, ItemBlockBase.class, cluster_aluminium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cluster_copper, ItemBlockBase.class, cluster_copper.getUnlocalizedName(), ERA.NEVER);
		
		//Bedrock ores
		EraRegistry.registerBlock(ore_bedrock_coltan, ore_bedrock_coltan.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_bedrock_oil, ore_bedrock_oil.getUnlocalizedName(), ERA.NEVER);
		
		//Nice Meme
		EraRegistry.registerBlock(ore_coal_oil, ore_coal_oil.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_coal_oil_burning, ore_coal_oil_burning.getUnlocalizedName(), ERA.NEVER);
		
		//Nether Ores
		EraRegistry.registerBlock(ore_nether_coal, ore_nether_coal.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_smoldering, ore_nether_smoldering.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_uranium, ore_nether_uranium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_uranium_scorched, ore_nether_uranium_scorched.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_plutonium, ore_nether_plutonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(ore_nether_tungsten, ore_nether_tungsten.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_sulfur, ore_nether_sulfur.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_fire, ore_nether_fire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_nether_cobalt, ore_nether_cobalt.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_nether_schrabidium, ItemBlockLore.class, ore_nether_schrabidium.getUnlocalizedName(), ERA.NEVER);
		
		//Meteor Ores
		EraRegistry.registerBlock(ore_meteor_uranium, ore_meteor_uranium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_thorium, ore_meteor_thorium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_titanium, ore_meteor_titanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_sulfur, ore_meteor_sulfur.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_copper, ore_meteor_copper.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_tungsten, ore_meteor_tungsten.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_aluminium, ore_meteor_aluminium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_lead, ore_meteor_lead.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_lithium, ore_meteor_lithium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_meteor_starmetal, ore_meteor_starmetal.getUnlocalizedName(), ERA.ALWAYS);
		
		//Gneiss Ores
		EraRegistry.registerBlock(ore_gneiss_iron, ore_gneiss_iron.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_gold, ore_gneiss_gold.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_uranium, ore_gneiss_uranium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_uranium_scorched, ore_gneiss_uranium_scorched.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_copper, ore_gneiss_copper.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_asbestos, ore_gneiss_asbestos.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_lithium, ore_gneiss_lithium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_gneiss_schrabidium, ItemBlockLore.class, ore_gneiss_schrabidium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_rare, ItemOreBlock.class, ore_gneiss_rare.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_gneiss_gas, ore_gneiss_gas.getUnlocalizedName(), ERA.ALWAYS);
		
		//Depth ores
		EraRegistry.registerBlock(ore_depth_cinnebar, ItemBlockBase.class, ore_depth_cinnebar.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_depth_zirconium, ItemBlockBase.class, ore_depth_zirconium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ore_depth_borax, ItemBlockBase.class, ore_depth_borax.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cluster_depth_iron, ItemBlockBase.class, cluster_depth_iron.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cluster_depth_titanium, ItemBlockBase.class, cluster_depth_titanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cluster_depth_tungsten, ItemBlockBase.class, cluster_depth_tungsten.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ore_alexandrite, ItemBlockBase.class, ore_alexandrite.getUnlocalizedName(), ERA.COLDWAR);
		
		//Nether depth ores
		EraRegistry.registerBlock(ore_depth_nether_neodymium, ItemBlockBase.class, ore_depth_nether_neodymium.getUnlocalizedName(), ERA.NEVER);
		
		//Basalt ores
		EraRegistry.registerBlock(basalt_sulfur, basalt_sulfur.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(basalt_fluorite, basalt_fluorite.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(basalt_asbestos, basalt_asbestos.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(basalt_gem, ItemBlockBase.class, basalt_gem.getUnlocalizedName(), ERA.NEVER);
		
		//End Ores
		EraRegistry.registerBlock(ore_tikite, ore_tikite.getUnlocalizedName(), ERA.ALWAYS);
		
		//It's a meme you dip
		EraRegistry.registerBlock(ore_random, ItemRandomOreBlock.class, ore_random.getUnlocalizedName(), ERA.NEVER);
		
		//Bedrock ore
		eraRegister(ore_bedrock, ERA.NEVER);
		eraRegister(ore_volcano, ERA.NEVER);
		
		//Crystals
		EraRegistry.registerBlock(crystal_power, crystal_power.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(crystal_energy, crystal_energy.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(crystal_robust, crystal_robust.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(crystal_trixite, crystal_trixite.getUnlocalizedName(), ERA.NEVER);
		
		//Resource-bearing Stones
		eraRegister(stone_resource, ERA.ALWAYS);
		eraRegister(stalagmite, ERA.NEVER);
		eraRegister(stalactite, ERA.NEVER);
		eraRegister(stone_biome, ERA.NEVER);
		
		//Stone Variants
		EraRegistry.registerBlock(stone_porous, stone_porous.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(stone_gneiss, stone_gneiss.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gneiss_brick, gneiss_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gneiss_tile, gneiss_tile.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gneiss_chiseled, gneiss_chiseled.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(stone_depth, ItemBlockBase.class, stone_depth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(depth_brick, ItemBlockBase.class, depth_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(depth_tiles, ItemBlockBase.class, depth_tiles.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(stone_depth_nether, ItemBlockBase.class, stone_depth_nether.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(depth_nether_brick, ItemBlockBase.class, depth_nether_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(depth_nether_tiles, ItemBlockBase.class, depth_nether_tiles.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(depth_dnt, ItemBlockBase.class, depth_dnt.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(basalt, basalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(basalt_smooth, basalt_smooth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(basalt_brick, basalt_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(basalt_polished, basalt_polished.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(basalt_tiles, basalt_tiles.getUnlocalizedName(), ERA.ALWAYS);
		//GameRegistry.registerBlock(stone_deep_cobble, ItemBlockBase.class, stone_deep_cobble.getUnlocalizedName());
		
		//Blocks
		EraRegistry.registerBlock(block_uranium, block_uranium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_u233, block_u233.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_u235, block_u235.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_u238, block_u238.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_uranium_fuel, block_uranium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_neptunium, block_neptunium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_polonium, block_polonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_mox_fuel, block_mox_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_plutonium, block_plutonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_pu238, block_pu238.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_pu239, block_pu239.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_pu240, block_pu240.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_pu_mix, block_pu_mix.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_plutonium_fuel, block_plutonium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_thorium, block_thorium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_thorium_fuel, block_thorium_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_titanium, block_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_sulfur, block_sulfur.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_niter, block_niter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_niter_reinforced, block_niter_reinforced.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_copper, block_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_red_copper, block_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_advanced_alloy, block_advanced_alloy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_tungsten, block_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_aluminium, block_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_fluorite, block_fluorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_beryllium, block_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_cobalt, block_cobalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_steel, block_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_lead, block_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_bismuth, block_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_coltan, block_coltan.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_tantalium, block_tantalium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_niobium, block_niobium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_lithium, block_lithium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_zirconium, block_zirconium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_white_phosphorus, block_white_phosphorus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_red_phosphorus, block_red_phosphorus.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_yellowcake, block_yellowcake.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_scrap, block_scrap.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_electrical_scrap, block_electrical_scrap.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_fallout, block_fallout.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_foam, block_foam.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_graphite, block_graphite.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(block_coke, ERA.ALWAYS);
		EraRegistry.registerBlock(block_graphite_drilled, block_graphite_drilled.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_fuel, block_graphite_fuel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_rod, block_graphite_rod.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_plutonium, block_graphite_plutonium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_source, block_graphite_source.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_lithium, block_graphite_lithium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_tritium, block_graphite_tritium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_graphite_detector, block_graphite_detector.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_boron, block_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_insulator, block_insulator.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_fiberglass, block_fiberglass.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_asbestos, block_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_trinitite, block_trinitite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_waste, block_waste.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_waste_painted, block_waste_painted.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_waste_vitrified, block_waste_vitrified.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(ancient_scrap, ancient_scrap.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_corium, block_corium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_corium_cobble, block_corium_cobble.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_schraranium, ItemBlockBase.class, block_schraranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_schrabidium, ItemBlockBase.class, block_schrabidium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_schrabidate, ItemBlockBase.class, block_schrabidate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_solinium, ItemBlockBase.class, block_solinium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_schrabidium_fuel, ItemBlockBase.class, block_schrabidium_fuel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_euphemium, ItemBlockLore.class, block_euphemium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_schrabidium_cluster, ItemBlockBase.class, block_schrabidium_cluster.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_euphemium_cluster, ItemBlockLore.class, block_euphemium_cluster.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_dineutronium, block_dineutronium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_magnetized_tungsten, block_magnetized_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_combine_steel, block_combine_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_desh, block_desh.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_dura_steel, block_dura_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_starmetal, block_starmetal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_polymer, block_polymer.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_bakelite, block_bakelite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_rubber, block_rubber.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_australium, ItemOreBlock.class, block_australium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_weidanium, ItemOreBlock.class, block_weidanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_reiium, ItemOreBlock.class, block_reiium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_unobtainium, ItemOreBlock.class, block_unobtainium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_daffergon, ItemOreBlock.class, block_daffergon.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_verticium, ItemOreBlock.class, block_verticium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_lanthanium, block_lanthanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_ra226, block_ra226.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_actinium, block_actinium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(block_tritium, block_tritium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_semtex, block_semtex.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_c4, block_c4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_smore, block_smore.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(block_slag, block_slag.getUnlocalizedName(), ERA.ALWAYS);

		//Bottlecap Blocks
		EraRegistry.registerBlock(block_cap_nuka, block_cap_nuka.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_quantum, block_cap_quantum.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_rad, block_cap_rad.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_sparkle, block_cap_sparkle.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_korl, block_cap_korl.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_fritz, block_cap_fritz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_sunset, block_cap_sunset.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(block_cap_star, block_cap_star.getUnlocalizedName(), ERA.COLDWAR);
		
		//Deco Blocks
		EraRegistry.registerBlock(deco_titanium, deco_titanium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_red_copper, deco_red_copper.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_tungsten, deco_tungsten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_aluminium, deco_aluminium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_steel, deco_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_lead, deco_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_beryllium, deco_beryllium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_asbestos, deco_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_emitter, ItemBlockBase.class, deco_emitter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(part_emitter, ItemBlockBase.class, part_emitter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(deco_loot, deco_loot.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(bobblehead, ItemBlockMeta.class, bobblehead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(snowglobe, ItemBlockMeta.class, snowglobe.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(hazmat, hazmat.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(deco_rbmk, deco_rbmk.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(deco_rbmk_smooth, deco_rbmk_smooth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//Gravel
		EraRegistry.registerBlock(gravel_obsidian, ItemBlockBlastInfo.class, gravel_obsidian.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(gravel_diamond, ItemBlockLore.class, gravel_diamond.getUnlocalizedName(), ERA.NEVER);
		
		//Lamps
		EraRegistry.registerBlock(lamp_tritium_green_off, lamp_tritium_green_off.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(lamp_tritium_green_on, lamp_tritium_green_on.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(lamp_tritium_blue_off, lamp_tritium_blue_off.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(lamp_tritium_blue_on, lamp_tritium_blue_on.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(lamp_uv_off, lamp_uv_off.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(lamp_uv_on, lamp_uv_on.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(lamp_demon, lamp_demon.getUnlocalizedName(), ERA.NEVER);

		//Reinforced Blocks
		EraRegistry.registerBlock(asphalt, ItemBlockBlastInfo.class, asphalt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(asphalt_light, ItemBlockBlastInfo.class, asphalt_light.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_brick, ItemBlockBlastInfo.class, reinforced_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_glass, ItemBlockBlastInfo.class, reinforced_glass.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_light, ItemBlockBlastInfo.class, reinforced_light.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_sand, ItemBlockBlastInfo.class, reinforced_sand.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_lamp_off, ItemBlockBlastInfo.class, reinforced_lamp_off.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_lamp_on, ItemBlockBlastInfo.class, reinforced_lamp_on.getUnlocalizedName(), ERA.ALWAYS);

		//Bricks
		EraRegistry.registerBlock(reinforced_stone, ItemBlockBlastInfo.class, reinforced_stone.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_ducrete, ItemBlockBlastInfo.class, reinforced_ducrete.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_smooth, ItemBlockBlastInfo.class, concrete_smooth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_colored, ItemBlockColoredConcrete.class, concrete_colored.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(concrete_colored_ext, ERA.ALWAYS);
		EraRegistry.registerBlock(concrete, ItemBlockBlastInfo.class, concrete.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_asbestos, ItemBlockBlastInfo.class, concrete_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_super, ItemBlockBlastInfo.class, concrete_super.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_super_broken, ItemBlockBlastInfo.class, concrete_super_broken.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ducrete_smooth, ItemBlockBlastInfo.class, ducrete_smooth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ducrete, ItemBlockBlastInfo.class, ducrete.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_pillar, ItemBlockBlastInfo.class, concrete_pillar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete, ItemBlockBlastInfo.class, brick_concrete.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_mossy, ItemBlockBlastInfo.class, brick_concrete_mossy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_cracked, ItemBlockBlastInfo.class, brick_concrete_cracked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_broken, ItemBlockBlastInfo.class, brick_concrete_broken.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_marked, ItemBlockBlastInfo.class, brick_concrete_marked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_ducrete, ItemBlockBlastInfo.class, brick_ducrete.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_obsidian, ItemBlockBlastInfo.class, brick_obsidian.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_compound, ItemBlockBlastInfo.class, brick_compound.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_light, ItemBlockBlastInfo.class, brick_light.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_asbestos, brick_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_fire, ItemBlockBlastInfo.class, brick_fire.getUnlocalizedName(), ERA.ALWAYS);

		EraRegistry.registerBlock(concrete_slab, ItemModSlab.class, concrete_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_double_slab, ItemModSlab.class, concrete_double_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_brick_slab, ItemModSlab.class, concrete_brick_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_brick_double_slab, ItemModSlab.class, concrete_brick_double_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_slab, ItemModSlab.class, brick_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_double_slab, ItemModSlab.class, brick_double_slab.getUnlocalizedName(), ERA.ALWAYS);

		EraRegistry.registerBlock(concrete_smooth_stairs, concrete_smooth_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_stairs, concrete_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(concrete_asbestos_stairs, concrete_asbestos_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ducrete_smooth_stairs, ducrete_smooth_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_stairs, brick_concrete_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_mossy_stairs, brick_concrete_mossy_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_cracked_stairs, brick_concrete_cracked_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_concrete_broken_stairs, brick_concrete_broken_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_ducrete_stairs, brick_ducrete_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_stone_stairs, reinforced_stone_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(reinforced_brick_stairs, reinforced_brick_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_obsidian_stairs, brick_obsidian_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_light_stairs, brick_light_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_compound_stairs, brick_compound_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_asbestos_stairs, brick_asbestos_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_fire_stairs, brick_fire_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ducrete_stairs, ducrete_stairs.getUnlocalizedName(), ERA.ALWAYS);
		
		//CMB Building Elements
		EraRegistry.registerBlock(cmb_brick, ItemBlockBlastInfo.class, cmb_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(cmb_brick_reinforced, ItemBlockBlastInfo.class, cmb_brick_reinforced.getUnlocalizedName(), ERA.ALWAYS);
		
		//Tiles
		EraRegistry.registerBlock(vinyl_tile, ItemBlockBlastInfo.class, vinyl_tile.getUnlocalizedName(), ERA.ALWAYS); //i would rather die than dip into fucking blocks with subtypes again
		
		EraRegistry.registerBlock(tile_lab, tile_lab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(tile_lab_cracked, tile_lab_cracked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(tile_lab_broken, tile_lab_broken.getUnlocalizedName(), ERA.ALWAYS);
		
		//Other defensive stuff
		EraRegistry.registerBlock(barbed_wire, barbed_wire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(barbed_wire_fire, barbed_wire_fire.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(barbed_wire_poison, barbed_wire_poison.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(barbed_wire_acid, barbed_wire_acid.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(barbed_wire_wither, barbed_wire_wither.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(barbed_wire_ultradeath, barbed_wire_ultradeath.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(spikes, spikes.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(tesla, tesla.getUnlocalizedName(), ERA.ALWAYS);
		
		//Charger
		EraRegistry.registerBlock(charger, charger.getUnlocalizedName(), ERA.NEVER);
		
		//Siege blocks
		EraRegistry.registerBlock(siege_shield, ItemBlockLore.class, siege_shield.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(siege_internal, ItemBlockLore.class, siege_internal.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(siege_circuit, ItemBlockLore.class, siege_circuit.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(siege_emergency, siege_emergency.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(siege_hole, siege_hole.getUnlocalizedName(), ERA.NEVER);
		
		//Decoration Blocks
		EraRegistry.registerBlock(block_meteor, block_meteor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_meteor_cobble, block_meteor_cobble.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_meteor_broken, block_meteor_broken.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_meteor_molten, block_meteor_molten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(block_meteor_treasure, block_meteor_treasure.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_polished, meteor_polished.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_brick, meteor_brick.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_brick_mossy, meteor_brick_mossy.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_brick_cracked, meteor_brick_cracked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_brick_chiseled, meteor_brick_chiseled.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_pillar, meteor_pillar.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_spawner, meteor_spawner.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(meteor_battery, ItemBlockLore.class, meteor_battery.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle, brick_jungle.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_cracked, brick_jungle_cracked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_fragile, brick_jungle_fragile.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_lava, brick_jungle_lava.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_ooze, brick_jungle_ooze.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_mystic, brick_jungle_mystic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_trap, ItemTrapBlock.class, brick_jungle_trap.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_glyph, ItemGlyphBlock.class, brick_jungle_glyph.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_jungle_circle, brick_jungle_circle.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_dungeon, brick_dungeon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_dungeon_flat, brick_dungeon_flat.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_dungeon_tile, brick_dungeon_tile.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_dungeon_circle, brick_dungeon_circle.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(brick_forgotten, brick_forgotten.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_computer, ItemBlockBase.class, deco_computer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(filing_cabinet, ItemBlockBase.class, filing_cabinet.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(tape_recorder, tape_recorder.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(steel_poles, steel_poles.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pole_top, pole_top.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pole_satellite_receiver, pole_satellite_receiver.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(steel_wall, steel_wall.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(steel_corner, steel_corner.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(steel_roof, steel_roof.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(steel_beam, steel_beam.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(steel_scaffold, ERA.ALWAYS);
		EraRegistry.registerBlock(steel_grate, steel_grate.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(steel_grate_wide, ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe, ItemBlockBase.class, deco_pipe.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rusted, ItemBlockBase.class, deco_pipe_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_green, ItemBlockBase.class, deco_pipe_green.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_green_rusted, ItemBlockBase.class, deco_pipe_green_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_red, ItemBlockBase.class, deco_pipe_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_marked, ItemBlockBase.class, deco_pipe_marked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rim, ItemBlockBase.class, deco_pipe_rim.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rim_rusted, ItemBlockBase.class, deco_pipe_rim_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rim_green, ItemBlockBase.class, deco_pipe_rim_green.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rim_green_rusted, ItemBlockBase.class, deco_pipe_rim_green_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rim_red, ItemBlockBase.class, deco_pipe_rim_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_rim_marked, ItemBlockBase.class, deco_pipe_rim_marked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_framed, ItemBlockBase.class, deco_pipe_framed.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_framed_rusted, ItemBlockBase.class, deco_pipe_framed_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_framed_green, ItemBlockBase.class, deco_pipe_framed_green.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_framed_green_rusted, ItemBlockBase.class, deco_pipe_framed_green_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_framed_red, ItemBlockBase.class, deco_pipe_framed_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_framed_marked, ItemBlockBase.class, deco_pipe_framed_marked.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_quad, ItemBlockBase.class, deco_pipe_quad.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_quad_rusted, ItemBlockBase.class, deco_pipe_quad_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_quad_green, ItemBlockBase.class, deco_pipe_quad_green.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_quad_green_rusted, ItemBlockBase.class, deco_pipe_quad_green_rusted.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_quad_red, ItemBlockBase.class, deco_pipe_quad_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(deco_pipe_quad_marked, ItemBlockBase.class, deco_pipe_quad_marked.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(plant_flower, ERA.ALWAYS);
		eraRegister(plant_tall, ERA.ALWAYS);
		eraRegister(plant_dead, ERA.ALWAYS);
		eraRegister(reeds, ERA.ALWAYS);
		EraRegistry.registerBlock(mush, mush.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(mush_block, mush_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(mush_block_stem, mush_block_stem.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(moon_turf, moon_turf.getUnlocalizedName(), ERA.ALWAYS);
		
		//Waste
		EraRegistry.registerBlock(waste_earth, waste_earth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(waste_mycelium, waste_mycelium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(waste_trinitite, waste_trinitite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(waste_trinitite_red, waste_trinitite_red.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(waste_log, waste_log.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(waste_leaves, waste_leaves.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(waste_planks, waste_planks.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(frozen_grass, frozen_grass.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(frozen_dirt, frozen_dirt.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(frozen_log, frozen_log.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(frozen_planks, frozen_planks.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(dirt_dead, dirt_dead.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(dirt_oily, dirt_oily.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(sand_dirty, sand_dirty.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(sand_dirty_red, sand_dirty_red.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(stone_cracked, stone_cracked.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(fallout, fallout.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(foam_layer, foam_layer.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(sand_boron_layer, sand_boron_layer.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(leaves_layer, leaves_layer.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(burning_earth, burning_earth.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(tektite, tektite.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(ore_tektite_osmiridium, ore_tektite_osmiridium.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(impact_dirt, impact_dirt.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		//RAD
		EraRegistry.registerBlock(sellafield_slaked, sellafield_slaked.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(sellafield, ItemBlockNamedMeta.class, sellafield.getUnlocalizedName(), ERA.NEVER);

		//Geysirs
		EraRegistry.registerBlock(geysir_water, geysir_water.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(geysir_chlorine, geysir_chlorine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(geysir_vapor, geysir_vapor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(geysir_nether, geysir_nether.getUnlocalizedName(), ERA.ALWAYS);

		//Nukes
		EraRegistry.registerBlock(nuke_gadget, nuke_gadget.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_boy, nuke_boy.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(nuke_man, nuke_man.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(nuke_mike, nuke_mike.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_tsar, nuke_tsar.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_prototype, ItemPrototypeBlock.class, nuke_prototype.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_fleija, nuke_fleija.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_solinium, nuke_solinium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_n2, nuke_n2.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_n45, nuke_n45.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_fstbmb, nuke_fstbmb.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(nuke_custom, nuke_custom.getUnlocalizedName(), ERA.COLDWAR);
		
		//Generic Bombs
		EraRegistry.registerBlock(bomb_multi, bomb_multi.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(crashed_balefire, crashed_balefire.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fireworks, fireworks.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dynamite, dynamite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(tnt, tnt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(semtex, semtex.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(c4, c4.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(fissure_bomb, ERA.ALWAYS);
		
		//Turrets
		EraRegistry.registerBlock(turret_chekhov, turret_chekhov.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_friendly, turret_friendly.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_jeremy, turret_jeremy.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_tauon, turret_tauon.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_richard, turret_richard.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_howard, turret_howard.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_howard_damaged, turret_howard_damaged.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_maxwell, turret_maxwell.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_fritz, turret_fritz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_brandon, turret_brandon.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_arty, turret_arty.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_himars, turret_himars.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(turret_sentry, turret_sentry.getUnlocalizedName(), ERA.COLDWAR);
		
		//Wall-mounted Explosives
		EraRegistry.registerBlock(charge_dynamite, ItemBlockBase.class, charge_dynamite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(charge_miner, ItemBlockBase.class, charge_miner.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(charge_c4, ItemBlockBase.class, charge_c4.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(charge_semtex, ItemBlockBase.class, charge_semtex.getUnlocalizedName(), ERA.ALWAYS);
		
		//Mines
		EraRegistry.registerBlock(mine_ap, mine_ap.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(mine_he, mine_he.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(mine_shrap, mine_shrap.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(mine_fat, mine_fat.getUnlocalizedName(), ERA.COLDWAR);
		
		//Block Bombs
		EraRegistry.registerBlock(flame_war, flame_war.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(float_bomb, float_bomb.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(therm_endo, therm_endo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(therm_exo, therm_exo.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(emp_bomb, emp_bomb.getUnlocalizedName(), ERA.NEVER);
		//GameRegistry.registerBlock(rejuvinator, rejuvinator.getUnlocalizedName());
		EraRegistry.registerBlock(det_cord, det_cord.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(det_charge, det_charge.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(det_nuke, det_nuke.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(det_miner, det_miner.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_barrel, ItemBlockLore.class, red_barrel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pink_barrel, ItemBlockLore.class, pink_barrel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(lox_barrel, ItemBlockLore.class, lox_barrel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(taint_barrel, taint_barrel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(yellow_barrel, yellow_barrel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(vitrified_barrel, vitrified_barrel.getUnlocalizedName(), ERA.NEVER);
		
		//Siren
		EraRegistry.registerBlock(machine_siren, machine_siren.getUnlocalizedName(), ERA.ALWAYS);
		
		//This Thing
		EraRegistry.registerBlock(broadcaster_pc, broadcaster_pc.getUnlocalizedName(), ERA.ALWAYS);
		
		//Geiger Counter
		EraRegistry.registerBlock(geiger, geiger.getUnlocalizedName(), ERA.ALWAYS);
		
		//HEV Battery
		EraRegistry.registerBlock(hev_battery, hev_battery.getUnlocalizedName(), ERA.ALWAYS);
		
		//Chainlink Fence
		EraRegistry.registerBlock(fence_metal, fence_metal.getUnlocalizedName(), ERA.ALWAYS);
		
		//Sands, Glass
		EraRegistry.registerBlock(ash_digamma, ash_digamma.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_boron, sand_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_lead, sand_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_uranium, sand_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_polonium, sand_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_quartz, sand_quartz.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_gold, sand_gold.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sand_gold198, sand_gold198.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_boron, glass_boron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_lead, glass_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_uranium, glass_uranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_trinitite, glass_trinitite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_polonium, glass_polonium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_ash, glass_ash.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(glass_quartz, glass_quartz.getUnlocalizedName(), ERA.ALWAYS);
		
		//Silo Hatch
		EraRegistry.registerBlock(seal_frame, seal_frame.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(seal_controller, seal_controller.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(seal_hatch, seal_hatch.getUnlocalizedName(), ERA.ALWAYS);
		
		//Vault Door
		EraRegistry.registerBlock(vault_door, vault_door.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(blast_door, blast_door.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(fire_door, fire_door.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(transition_seal, transition_seal.getUnlocalizedName(), ERA.ALWAYS);
		
		//Doors
		EraRegistry.registerBlock(door_metal, door_metal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(door_office, door_office.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(door_bunker, door_bunker.getUnlocalizedName(), ERA.ALWAYS);
		
		//Crates
		eraRegister(crate_iron, ERA.ALWAYS);
		eraRegister(crate_steel, ERA.ALWAYS);
		eraRegister(crate_desh, ERA.ALWAYS);
		eraRegister(crate_tungsten, ERA.ALWAYS);
		eraRegister(safe, ERA.ALWAYS);
		eraRegister(mass_storage, ERA.ALWAYS);
		
		//Junk
		EraRegistry.registerBlock(boxcar, boxcar.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(boat, boat.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(bomber, bomber.getUnlocalizedName(), ERA.NEVER);
		...
		EraRegistry.registerBlock(machine_autocrafter, ItemBlockBase.class, machine_autocrafter.getUnlocalizedName(), ERA.ALWAYS);
		
		EraRegistry.registerBlock(anvil_iron, ItemBlockBase.class, anvil_iron.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_lead, ItemBlockBase.class, anvil_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_steel, ItemBlockBase.class, anvil_steel.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_meteorite, ItemBlockBase.class, anvil_meteorite.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_starmetal, ItemBlockBase.class, anvil_starmetal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_ferrouranium, ItemBlockBase.class, anvil_ferrouranium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_bismuth, ItemBlockBase.class, anvil_bismuth.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_schrabidate, ItemBlockBase.class, anvil_schrabidate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_dnt, ItemBlockBase.class, anvil_dnt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_osmiridium, ItemBlockBase.class, anvil_osmiridium.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(anvil_murky, ItemBlockBase.class, anvil_murky.getUnlocalizedName(), ERA.COLDWAR);
		
		EraRegistry.registerBlock(press_preheater, press_preheater.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_press, machine_press.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_epress, machine_epress.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(heater_firebox, ERA.ALWAYS);
		eraRegister(heater_oven, ERA.ALWAYS);
		eraRegister(heater_oilburner, ERA.ALWAYS);
		eraRegister(heater_electric, ERA.ALWAYS);
		eraRegister(heater_heatex, ERA.ALWAYS);
		eraRegister(furnace_iron, ERA.ALWAYS);
		eraRegister(furnace_steel, ERA.ALWAYS);
		eraRegister(furnace_combination, ERA.ALWAYS);
		eraRegister(machine_stirling, ERA.ALWAYS);
		eraRegister(machine_stirling_steel, ERA.ALWAYS);
		eraRegister(machine_sawmill, ERA.ALWAYS);
		eraRegister(machine_crucible, ERA.ALWAYS);
		eraRegister(machine_boiler, ERA.ALWAYS);
		eraRegister(foundry_mold, ERA.ALWAYS);
		eraRegister(foundry_basin, ERA.ALWAYS);
		eraRegister(foundry_channel, ERA.ALWAYS);
		eraRegister(foundry_tank, ERA.ALWAYS);
		eraRegister(foundry_outlet, ERA.ALWAYS);
		eraRegister(foundry_slagtap, ERA.ALWAYS);
		eraRegister(slag, ERA.ALWAYS);
		eraRegister(machine_difurnace_off, ERA.ALWAYS);
		eraRegister(machine_difurnace_on, ERA.ALWAYS);
		eraRegister(machine_difurnace_extension, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_difurnace_rtg_off, machine_difurnace_rtg_off.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_difurnace_rtg_on, machine_difurnace_rtg_on.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_centrifuge, machine_centrifuge.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_gascent, machine_gascent.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_fel, machine_fel.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_silex, machine_silex.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_crystallizer, machine_crystallizer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_uf6_tank, machine_uf6_tank.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_puf6_tank, machine_puf6_tank.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_reactor_breeding, machine_reactor_breeding.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_nuke_furnace_off, machine_nuke_furnace_off.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_nuke_furnace_on, machine_nuke_furnace_on.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_rtg_furnace_off, machine_rtg_furnace_off.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_rtg_furnace_on, machine_rtg_furnace_on.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_coal_off, machine_coal_off.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_coal_on, machine_coal_on.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(machine_diesel, ERA.ALWAYS);
		eraRegister(machine_selenium, ERA.ALWAYS);
		eraRegister(machine_combustion_engine, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_generator, machine_generator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(machine_controller, machine_controller.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_research, reactor_research.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_zirnox, reactor_zirnox.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(zirnox_destroyed, zirnox_destroyed.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_industrial_generator, machine_industrial_generator.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_radgen, machine_radgen.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_cyclotron, machine_cyclotron.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_rtg_grey, machine_rtg_grey.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_geo, machine_geo.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_amgen, machine_amgen.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_minirtg, machine_minirtg.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_powerrtg, machine_powerrtg.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_radiolysis, machine_radiolysis.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_hephaestus, machine_hephaestus.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(machine_spp_bottom, machine_spp_bottom.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(machine_spp_top, machine_spp_top.getUnlocalizedName(), ERA.COLDWAR);

		EraRegistry.registerBlock(hadron_plating, hadron_plating.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_plating_blue, hadron_plating_blue.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_plating_black, hadron_plating_black.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_plating_yellow, hadron_plating_yellow.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_plating_striped, hadron_plating_striped.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_plating_glass, hadron_plating_glass.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_plating_voltz, hadron_plating_voltz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_alloy, ItemBlockBase.class, hadron_coil_alloy.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_gold, ItemBlockBase.class, hadron_coil_gold.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_neodymium, ItemBlockBase.class, hadron_coil_neodymium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_magtung, ItemBlockBase.class, hadron_coil_magtung.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_schrabidium, ItemBlockBase.class, hadron_coil_schrabidium.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_schrabidate, ItemBlockBase.class, hadron_coil_schrabidate.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_starmetal, ItemBlockBase.class, hadron_coil_starmetal.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_chlorophyte, ItemBlockBase.class, hadron_coil_chlorophyte.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_coil_mese, ItemBlockBase.class, hadron_coil_mese.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_power, hadron_power.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_power_10m, hadron_power_10m.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_power_100m, hadron_power_100m.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_power_1g, hadron_power_1g.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_power_10g, hadron_power_10g.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_diode, hadron_diode.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_analysis, hadron_analysis.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_analysis_glass, hadron_analysis_glass.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_access, hadron_access.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(hadron_core, hadron_core.getUnlocalizedName(), ERA.COLDWAR);
		
		EraRegistry.registerBlock(rbmk_rod, rbmk_rod.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_rod_mod, rbmk_rod_mod.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_rod_reasim, rbmk_rod_reasim.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_rod_reasim_mod, rbmk_rod_reasim_mod.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_control, rbmk_control.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_control_mod, rbmk_control_mod.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_control_auto, rbmk_control_auto.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_blank, rbmk_blank.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_boiler, rbmk_boiler.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_reflector, rbmk_reflector.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_absorber, rbmk_absorber.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_moderator, rbmk_moderator.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_outgasser, rbmk_outgasser.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_storage, rbmk_storage.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_cooler, rbmk_cooler.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_heater, rbmk_heater.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_console, rbmk_console.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_crane_console, rbmk_crane_console.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_loader, rbmk_loader.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_steam_inlet, rbmk_steam_inlet.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_steam_outlet, rbmk_steam_outlet.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(rbmk_heatex, rbmk_heatex.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(pribris, pribris.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(pribris_burning, pribris_burning.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(pribris_radiating, pribris_radiating.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(pribris_digamma, pribris_digamma.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		
		EraRegistry.registerBlock(red_cable, red_cable.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_cable_classic, red_cable_classic.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_cable_paintable, red_cable_paintable.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_wire_coated, red_wire_coated.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_connector, ItemBlockBase.class, red_connector.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_pylon, ItemBlockBase.class, red_pylon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(red_pylon_large, ItemBlockBase.class, red_pylon_large.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(substation, ItemBlockBase.class, substation.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(cable_switch, cable_switch.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(cable_detector, cable_detector.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(cable_diode, ItemBlockBase.class, cable_diode.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_detector, machine_detector.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(oil_duct, oil_duct.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(oil_duct_solid, oil_duct_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(gas_duct, gas_duct.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(gas_duct_solid, gas_duct_solid.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(fluid_duct, fluid_duct.getUnlocalizedName(), ERA.NEVER);
		eraRegister(fluid_duct_neo, ERA.ALWAYS);
		eraRegister(fluid_duct_box, ERA.ALWAYS);
		eraRegister(fluid_duct_paintable, ERA.ALWAYS);
		eraRegister(fluid_duct_gauge, ERA.ALWAYS);
		EraRegistry.registerBlock(fluid_duct_solid, fluid_duct_solid.getUnlocalizedName(), ERA.NEVER);
		eraRegister(radio_torch_sender, ERA.ALWAYS);
		eraRegister(radio_torch_receiver, ERA.ALWAYS);

		EraRegistry.registerBlock(crane_extractor, crane_extractor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crane_inserter, crane_inserter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crane_grabber, crane_grabber.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crane_router, crane_router.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crane_boxer, crane_boxer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crane_unboxer, crane_unboxer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(conveyor, conveyor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(conveyor_double, conveyor_double.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(conveyor_triple, conveyor_triple.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(conveyor_chute, conveyor_chute.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(conveyor_lift, conveyor_lift.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crane_splitter, crane_splitter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(fan, fan.getUnlocalizedName(), ERA.ALWAYS);
		
		EraRegistry.registerBlock(piston_inserter, piston_inserter.getUnlocalizedName(), ERA.ALWAYS);
		
		EraRegistry.registerBlock(chain, chain.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ladder_sturdy, ladder_sturdy.getUnlocalizedName(), ERA.ALWAYS);
		//We use Carpenter's blocks
		EraRegistry.registerBlock(ladder_iron, ladder_iron.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_gold, ladder_gold.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_titanium, ladder_titanium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_copper, ladder_copper.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_tungsten, ladder_tungsten.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_aluminium, ladder_aluminium.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_steel, ladder_steel.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_lead, ladder_lead.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ladder_cobalt, ladder_cobalt.getUnlocalizedName(), ERA.NEVER);
		
		eraRegister(barrel_plastic, ERA.SECONDWORLDWAR);
		eraRegister(barrel_corroded, ERA.ALWAYS);
		eraRegister(barrel_iron, ERA.ALWAYS);
		eraRegister(barrel_steel, ERA.ALWAYS);
		eraRegister(barrel_tcalloy, ERA.ALWAYS);
		eraRegister(barrel_antimatter, ERA.COLDWAR);
		eraRegister(machine_battery_potato, ERA.ALWAYS);
		eraRegister(machine_battery, ERA.ALWAYS);
		eraRegister(machine_lithium_battery, ERA.ALWAYS);
		eraRegister(machine_schrabidium_battery, ERA.ALWAYS);
		eraRegister(machine_dineutronium_battery, ERA.ALWAYS);
		eraRegister(machine_fensu, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_transformer, machine_transformer.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_transformer_20, machine_transformer_20.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_transformer_dnt, machine_transformer_dnt.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_transformer_dnt_20, machine_transformer_dnt_20.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_converter_he_rf, machine_converter_he_rf.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_converter_rf_he, machine_converter_rf_he.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_electric_furnace_off, machine_electric_furnace_off.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_electric_furnace_on, machine_electric_furnace_on.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_arc_furnace_off, machine_arc_furnace_off.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_arc_furnace_on, machine_arc_furnace_on.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_microwave, machine_microwave.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_assembler, machine_assembler.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_assemfac, machine_assemfac.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_chemplant, machine_chemplant.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_chemfac, machine_chemfac.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(machine_mixer, ERA.ALWAYS);
		eraRegister(machine_fluidtank, ERA.ALWAYS);
		eraRegister(machine_bat9000, ERA.ALWAYS);
		eraRegister(machine_orbus, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_boiler_off, machine_boiler_off.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(machine_boiler_on, machine_boiler_on.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(machine_boiler_electric_on, machine_boiler_electric_on.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(machine_boiler_electric_off, machine_boiler_electric_off.getUnlocalizedName(), ERA.NEVER);
		eraRegister(machine_steam_engine, ERA.ALWAYS);
		eraRegister(machine_turbine, ERA.ALWAYS);
		eraRegister(machine_large_turbine, ERA.ALWAYS);
		eraRegister(machine_chungus, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_condenser, machine_condenser.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_tower_small, machine_tower_small.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_tower_large, machine_tower_large.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_deuterium_extractor, machine_deuterium_extractor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_deuterium_tower, machine_deuterium_tower.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_liquefactor, ItemBlockBase.class, machine_liquefactor.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_solidifier, ItemBlockBase.class, machine_solidifier.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(machine_compressor, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_electrolyser, machine_electrolyser.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_deaerator, machine_deaerator.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(machine_waste_drum, machine_waste_drum.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_storage_drum, machine_storage_drum.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_shredder, machine_shredder.getUnlocalizedName(), ERA.ALWAYS);
		//TODO: Check out original code
		EraRegistry.registerBlock(machine_shredder_large, machine_shredder_large.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(machine_well, ERA.ALWAYS);
		eraRegister(machine_pumpjack, ERA.ALWAYS);
		eraRegister(machine_fracking_tower, ERA.ALWAYS);
		eraRegister(machine_flare, ERA.ALWAYS);
		eraRegister(machine_refinery, ERA.ALWAYS);
		eraRegister(machine_vacuum_distill, ERA.COLDWAR);
		eraRegister(machine_fraction_tower, ERA.ALWAYS);
		eraRegister(fraction_spacer, ERA.ALWAYS);
		eraRegister(machine_catalytic_cracker, ERA.ALWAYS);
		eraRegister(machine_catalytic_reformer, ERA.ALWAYS);
		eraRegister(machine_coker, ERA.ALWAYS);
		eraRegister(machine_drill, ERA.COLDWAR);
		eraRegister(machine_autosaw, ERA.COLDWAR);
		eraRegister(machine_excavator, ERA.COLDWAR);
		eraRegister(machine_mining_laser, ERA.COLDWAR);
		eraRegister(barricade, ERA.ALWAYS);
		eraRegister(machine_turbofan, ERA.ALWAYS);
		eraRegister(machine_turbinegas, ERA.ALWAYS);
		EraRegistry.registerBlock(machine_schrabidium_transmutator, machine_schrabidium_transmutator.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_combine_factory, machine_combine_factory.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_teleporter, machine_teleporter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(teleanchor, teleanchor.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(field_disturber, field_disturber.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(machine_satlinker, machine_satlinker.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(machine_keyforge, machine_keyforge.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_armor_table, machine_armor_table.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(machine_forcefield, machine_forcefield.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(radiorec, radiorec.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(radiobox, radiobox.getUnlocalizedName(), ERA.ALWAYS);
		
		//Multiblock Helpers
		EraRegistry.registerBlock(marker_structure, marker_structure.getUnlocalizedName(), ERA.ALWAYS);
		
		//The muffler
		EraRegistry.registerBlock(muffler, muffler.getUnlocalizedName(), ERA.ALWAYS);
		
		//Multiblock Parts
		EraRegistry.registerBlock(struct_launcher, struct_launcher.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_scaffold, struct_scaffold.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_launcher_core, struct_launcher_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_launcher_core_large, struct_launcher_core_large.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_soyuz_core, struct_soyuz_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_iter_core, struct_iter_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_plasma_core, struct_plasma_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(struct_watz_core, struct_watz_core.getUnlocalizedName(), ERA.COLDWAR);
		
		//Absorbers
		EraRegistry.registerBlock(absorber, absorber.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(absorber_red, absorber_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(absorber_green, absorber_green.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(absorber_pink, absorber_pink.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(decon, decon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(transission_hatch, transission_hatch.getUnlocalizedName(), ERA.ALWAYS);
		
		//Solar Tower Blocks
		EraRegistry.registerBlock(machine_solar_boiler, machine_solar_boiler.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(solar_mirror, solar_mirror.getUnlocalizedName(), ERA.ALWAYS);
		
		//Literal fucking garbage
		EraRegistry.registerBlock(factory_titanium_hull, factory_titanium_hull.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(factory_advanced_hull, factory_advanced_hull.getUnlocalizedName(), ERA.ALWAYS);
		
		//Multiblock Generators
		EraRegistry.registerBlock(reactor_element, reactor_element.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_control, reactor_control.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_hatch, reactor_hatch.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_ejector, reactor_ejector.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_inserter, reactor_inserter.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_conductor, reactor_conductor.getUnlocalizedName(), ERA.SECONDWORLDWAR);
		EraRegistry.registerBlock(reactor_computer, reactor_computer.getUnlocalizedName(), ERA.SECONDWORLDWAR);

		EraRegistry.registerBlock(fusion_conductor, fusion_conductor.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fusion_center, fusion_center.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fusion_motor, fusion_motor.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fusion_heater, fusion_heater.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fusion_hatch, fusion_hatch.getUnlocalizedName(), ERA.COLDWAR);
		//GameRegistry.registerBlock(fusion_core, fusion_core.getUnlocalizedName());
		EraRegistry.registerBlock(plasma, ItemBlockLore.class, plasma.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(iter, iter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(plasma_heater, plasma_heater.getUnlocalizedName(), ERA.COLDWAR);

		EraRegistry.registerBlock(watz_element, watz_element.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(watz_control, watz_control.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(watz_cooler, watz_cooler.getUnlocalizedName(), ERA.COLDWAR);
		eraRegister(watz_end, ERA.COLDWAR);
		EraRegistry.registerBlock(watz_hatch, watz_hatch.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(watz_conductor, watz_conductor.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(watz_core, watz_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(watz, watz.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(watz_pump, watz_pump.getUnlocalizedName(), ERA.COLDWAR);

		EraRegistry.registerBlock(fwatz_conductor, fwatz_conductor.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_scaffold, fwatz_scaffold.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_hatch, fwatz_hatch.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_computer, fwatz_computer.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_core, fwatz_core.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_cooler, fwatz_cooler.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_tank, fwatz_tank.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fwatz_plasma, fwatz_plasma.getUnlocalizedName(), ERA.COLDWAR);
		
		//E
		EraRegistry.registerBlock(balefire, balefire.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(fire_digamma, fire_digamma.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(digamma_matter, digamma_matter.getUnlocalizedName(), ERA.COLDWAR);
		eraRegister(volcano_core, ERA.NEVER);
		
		//AMS
		EraRegistry.registerBlock(ams_base, ams_base.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ams_emitter, ams_emitter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ams_limiter, ams_limiter.getUnlocalizedName(), ERA.ALWAYS);
		
		//Dark Fusion Core
		EraRegistry.registerBlock(dfc_emitter, dfc_emitter.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dfc_injector, dfc_injector.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dfc_receiver, dfc_receiver.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dfc_stabilizer, dfc_stabilizer.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dfc_core, dfc_core.getUnlocalizedName(), ERA.COLDWAR);
		
		//Missile Blocks
		EraRegistry.registerBlock(machine_missile_assembly, machine_missile_assembly.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(launch_pad, launch_pad.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(compact_launcher, compact_launcher.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(launch_table, launch_table.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(soyuz_launcher, soyuz_launcher.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(sat_dock, sat_dock.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(soyuz_capsule, soyuz_capsule.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(machine_radar, machine_radar.getUnlocalizedName(), ERA.ALWAYS);
		
		//Guide
		EraRegistry.registerBlock(book_guide, book_guide.getUnlocalizedName(), ERA.ALWAYS);
		
		//Sat Blocks
		EraRegistry.registerBlock(sat_mapper, sat_mapper.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(sat_scanner, sat_scanner.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(sat_radar, sat_radar.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(sat_laser, sat_laser.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(sat_foeq, sat_foeq.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(sat_resonator, sat_resonator.getUnlocalizedName(), ERA.COLDWAR);
		
		//Rails
		EraRegistry.registerBlock(rail_wood, ItemBlockBase.class, rail_wood.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(rail_narrow, ItemBlockBase.class, rail_narrow.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(rail_highspeed, ItemBlockBase.class, rail_highspeed.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(rail_booster, ItemBlockBase.class, rail_booster.getUnlocalizedName(), ERA.ALWAYS);
		eraRegister(rail_narrow_straight, ERA.ALWAYS);
		eraRegister(rail_narrow_curve, ERA.ALWAYS);
		eraRegister(rail_large_straight, ERA.ALWAYS);
		eraRegister(rail_large_curve, ERA.ALWAYS);
		
		//Crate
		EraRegistry.registerBlock(crate, crate.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_weapon, crate_weapon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_lead, crate_lead.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_metal, crate_metal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_red, crate_red.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_can, crate_can.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_ammo, crate_ammo.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(crate_jungle, crate_jungle.getUnlocalizedName(), ERA.ALWAYS);
		
		//ElB
		EraRegistry.registerBlock(statue_elb, statue_elb.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(statue_elb_g, statue_elb_g.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(statue_elb_w, statue_elb_w.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(statue_elb_f, statue_elb_f.getUnlocalizedName(), ERA.ALWAYS);
		
		//Fluids
		EraRegistry.registerBlock(mud_block, mud_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(acid_block, acid_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(toxic_block, toxic_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(schrabidic_block, schrabidic_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(corium_block, corium_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(volcanic_lava_block, volcanic_lava_block.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(sulfuric_acid_block, sulfuric_acid_block.getUnlocalizedName(), ERA.ALWAYS);
		//GameRegistry.registerBlock(concrete_liquid, concrete_liquid.getUnlocalizedName());
		
		//Multiblock Dummy Blocks
		EraRegistry.registerBlock(dummy_block_drill, dummy_block_drill.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_port_drill, dummy_port_drill.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_assembler, dummy_block_assembler.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_port_assembler, dummy_port_assembler.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_ams_limiter, dummy_block_ams_limiter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_port_ams_limiter, dummy_port_ams_limiter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_ams_emitter, dummy_block_ams_emitter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_port_ams_emitter, dummy_port_ams_emitter.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_ams_base, dummy_block_ams_base.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_port_ams_base, dummy_port_ams_base.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_vault, dummy_block_vault.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_blast, dummy_block_blast.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_uf6, dummy_block_uf6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_block_puf6, dummy_block_puf6.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(dummy_plate_compact_launcher, dummy_plate_compact_launcher.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dummy_port_compact_launcher, dummy_port_compact_launcher.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dummy_plate_launch_table, dummy_plate_launch_table.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dummy_port_launch_table, dummy_port_launch_table.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(dummy_plate_cargo, dummy_plate_cargo.getUnlocalizedName(), ERA.COLDWAR);
		
		//Other Technical Blocks
		EraRegistry.registerBlock(oil_pipe, oil_pipe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(drill_pipe, drill_pipe.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(vent_chlorine, vent_chlorine.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(vent_cloud, vent_cloud.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(vent_pink_cloud, vent_pink_cloud.getUnlocalizedName(), ERA.COLDWAR);
		EraRegistry.registerBlock(vent_chlorine_seal, vent_chlorine_seal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(chlorine_gas, chlorine_gas.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_radon, gas_radon.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_radon_dense, gas_radon_dense.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_radon_tomb, gas_radon_tomb.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_meltdown, gas_meltdown.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_monoxide, gas_monoxide.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_asbestos, gas_asbestos.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_coal, gas_coal.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_flammable, gas_flammable.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(gas_explosive, gas_explosive.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(vacuum, vacuum.getUnlocalizedName(), ERA.ALWAYS);
		
		//???
		EraRegistry.registerBlock(crystal_virus, crystal_virus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(crystal_hardened, crystal_hardened.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(crystal_pulsar, crystal_pulsar.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(taint, ItemTaintBlock.class, taint.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(residue, residue.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cheater_virus, cheater_virus.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(cheater_virus_seed, cheater_virus_seed.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(ntm_dirt, ntm_dirt.getUnlocalizedName(), ERA.NEVER);
		EraRegistry.registerBlock(pink_log, pink_log.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pink_planks, pink_planks.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pink_slab, pink_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pink_double_slab, pink_double_slab.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(pink_stairs, pink_stairs.getUnlocalizedName(), ERA.ALWAYS);
		EraRegistry.registerBlock(ff, ff.getUnlocalizedName(), ERA.NEVER);
	}
	
	private static void eraRegister(Block b, ERA era) {
		EraRegistry.registerBlock(b, ItemBlockBase.class, b.getUnlocalizedName(), era);
	}
	
	/*private static void register(Block b, Class<? extends ItemBlock> clazz) {
		EraRegistry.registerBlock(b, clazz, b.getUnlocalizedName());
	}*/
}