...
public class MachineMilkReformer extends BlockDummyable {

	// music listened to: https://www.youtube.com/watch?v=9imCm6CrNZ8&list=RD9imCm6CrNZ8&index=1 

	
	public MachineMilkReformer(Material mat) {
		super(mat);
	}
