...
public class DummyBlockCyclotron extends DummyOldBase {

	public DummyBlockCyclotron(Material p_i45386_1_, boolean port) {
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		} else if(!player.isSneaking())
		{
    		...
    		if(te != null && te instanceof TileEntityDummy) {
    			...
    			if(entity != null)
    			{
    				FMLNetworkHandler.openGui(player, MainRegistry.instance, EnumGUI.CYCLOTRON.ordinal(), world, a, b, c);
    			}
    		}
			return true;
		} else {
