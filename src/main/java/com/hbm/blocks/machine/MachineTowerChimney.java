...
import com.hbm.tileentity.machine.TileEntityTowerChimney;
...
public class MachineTowerChimney extends BlockDummyable implements ILookOverlay {

	public MachineTowerChimney(Material mat) {
		super(mat);
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int meta) {
		...
		if(meta >= 12)
			return new TileEntityTowerChimney();
	...
	public void printHook(Pre event, World world, int x, int y, int z) {
		...
		if(!(te instanceof TileEntityTowerChimney))
			return;

		TileEntityTowerChimney tower = (TileEntityTowerChimney) te;
