...
import com.hbm.tileentity.machine.rbmk.TileEntityRBMKTurbine;
...
public class RBMKTurbine extends BlockContainer implements ITooltipProvider {

	private final Random field_149933_a = new Random();
	@SideOnly(Side.CLIENT)
	private IIcon iconTop;

	public RBMKTurbine(Material p_i45386_1_) {
		super(p_i45386_1_);
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityRBMKTurbine();
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		} else if(!player.isSneaking())
		{
			...
			TileEntityRBMKTurbine entity = (TileEntityRBMKTurbine) te;
			if(entity != null)
			{
