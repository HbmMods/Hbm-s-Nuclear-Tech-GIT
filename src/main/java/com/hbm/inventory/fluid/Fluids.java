...
public class Fluids {
	...
	public static void init() {
		...
		HCL =		new FluidType("HCL",		0xFFCC80, 3, 0, 3, EnumSymbol.ACID).addTraits(new FT_Corrosive(30), LIQUID);
		//TODO: fire diamonds
		//sh
		...
		registerCalculatedFuel(BLOODGAS, (baseline / 0.36 * flammabilityHigh * demandMedium * complexityFraction), 3.5, FuelGrade.AERO);
