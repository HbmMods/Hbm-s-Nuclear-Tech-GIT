...
public class AnvilSmithingCyanideRecipe extends AnvilSmithingRecipe {
	...
	public boolean matches(ItemStack left, ItemStack right) {
		return (doesStackMatch(right, this.right) || right.getItem() == ModItems.pill_blue) && left.getItem() instanceof ItemFood;
	}
	...
	public ItemStack getOutput(ItemStack left, ItemStack right) {
		...
		out.stackTagCompound.setBoolean(right.getItem() == ModItems.pill_blue ? "ntmBluePill" : "ntmCyanide", true);
