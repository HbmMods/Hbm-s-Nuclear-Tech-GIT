...
public class SILEXRecipes {
	...
	public static void register() {
		...
		itemTranslation.put(ComparableStack.getComparableStack(ModItems.fluid_icon, 1, Fluids.UF6.getID()), ComparableStack.getComparableStack(ModItems.ingot_uranium));
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.ingot_pu_mix), new SILEXRecipe(900, 100, 2)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.ingot_am_mix), new SILEXRecipe(900, 100, 2)
		...
		itemTranslation.put(ComparableStack.getComparableStack(ModItems.fluid_icon, 1, Fluids.PUF6.getID()), ComparableStack.getComparableStack(ModItems.ingot_plutonium));
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.ingot_schraranium), new SILEXRecipe(900, 100, 2)
		...
		itemTranslation.put(ComparableStack.getComparableStack(ModItems.powder_australium), ComparableStack.getComparableStack(ModItems.ingot_australium));
		recipes.put(ComparableStack.getComparableStack(ModItems.ingot_australium), new SILEXRecipe(900, 100, 2)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.crystal_schraranium), new SILEXRecipe(900, 100, 3)
		...
		recipes.put(ComparableStack.getComparableStack(ModBlocks.ore_tikite), new SILEXRecipe(900, 100, EnumWavelengths.UV)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.crystal_trixite), new SILEXRecipe(1200, 100, EnumWavelengths.UV)
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_plutonium), 2))
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_cobalt), 3))
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_niobium), 3))
		...
		itemTranslation.put(ComparableStack.getComparableStack(ModItems.powder_lapis), ComparableStack.getComparableStack(Items.dye, 1, 4));
		recipes.put(ComparableStack.getComparableStack(Items.dye, 1, 4), new SILEXRecipe(100, 100 ,1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.fluid_icon, 1, Fluids.DEATH.getID()), new SILEXRecipe(1000, 1000, 4)
		...
		for(int i = 0; i < 5; i++) {
			...
			// UEU //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_ueu, 1, i), new SILEXRecipe(600, 100, 1) 	//NU and MEU will breed more plutonium due to their higher concentrations of U-238
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_ueu, 1, i + 5), new SILEXRecipe(600, 100, 1)
			...
			// MEU //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_meu, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_meu, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// HEU233 //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_heu233, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_heu233, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// HEU235 //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_heu235, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_heu235, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// TH232 //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_thmeu, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_thmeu, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// LEP //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_lep, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_lep, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// MEP //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_mep, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_mep, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// HEP239 //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hep239, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hep239, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_pu239), 84 - i * 20))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM239.ordinal()), 15 + 20 * i)) );
			
			// HEP241 //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hep241, 1, i), new SILEXRecipe(600, 100, 2)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hep241, 1, i + 5), new SILEXRecipe(600, 100, 2)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_pu241), 84 - i * 20))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), 15 + 20 * i)) );
			
			// MEN //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_men, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_men, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// HEN //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hen, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hen, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// MOX //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_mox, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_mox, 1, i + 5), new SILEXRecipe(600, 100, 1)	//Plutonium processing isn't possible w/o fucking up the NEI handler or removing xenon
			...
			// LEAUS //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_leaus, 1, i), new SILEXRecipe(600, 100, 2)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_leaus, 1, i + 5), new SILEXRecipe(600, 100, 2)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// HEAUS //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_heaus, 1, i), new SILEXRecipe(600, 100, 2)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_heaus, 1, i + 5), new SILEXRecipe(600, 100, 2)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// LES //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_les, 1, i), new SILEXRecipe(600, 100, 2)
			...
			//TODO: Readd xenon processing if/when the NEI handler can display more than 6 outputs properly
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_les, 1, i + 5), new SILEXRecipe(600, 100, 2)	//I'd rather not fuck up the NEI handler, so six items it is
			...
			// MES //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_mes, 1, i), new SILEXRecipe(600, 100, 2)
			...
			//TODO: Readd xenon processing if/when the NEI handler can display more than 6 outputs properly
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_mes, 1, i + 5), new SILEXRecipe(600, 100, 2)
			...
			// HES //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hes, 1, i), new SILEXRecipe(600, 100, 2)
			...
			//TODO: Readd xenon processing if/when the NEI handler can display more than 6 outputs properly
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_hes, 1, i + 5), new SILEXRecipe(600, 100, 2)
			...
			// BALEFIRE //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_balefire, 1, i), new SILEXRecipe(400, 100, 3)
			...
			// FLASHGOLD //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_balefire_gold, 1, i), new SILEXRecipe(600, 100, 2)
			...
			// FLASHLEAD //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_flashlead, 1, i), new SILEXRecipe(600, 100, 2)
			...
			// POBE //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_po210be, 1, i), new SILEXRecipe(600, 100, 1)
			...
			// PUBE //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_pu238be, 1, i), new SILEXRecipe(600, 100, 1)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_pu238be, 1, i + 5), new SILEXRecipe(600, 100, 1)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 1))
			...
			// RABE //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_ra226be, 1, i), new SILEXRecipe(600, 100, 1)
			...
			// DRX //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_drx, 1, i), new SILEXRecipe(600, 100, 4)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_drx, 1, i + 5), new SILEXRecipe(600, 100, 4)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.undefined), 1))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.undefined), 1))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.undefined), 1))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.undefined), 1))
			...
			// ZFB BI //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_zfb_bismuth, 1, i), new SILEXRecipe(600, 100, 2)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_zfb_bismuth, 1, i + 5), new SILEXRecipe(600, 100, 2)
			...
			// ZFB PU-241 //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_zfb_pu241, 1, i), new SILEXRecipe(600, 100, 2)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_zfb_pu241, 1, i + 5), new SILEXRecipe(600, 100, 2)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 3))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_u235), 50 - i * 10))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_pu240), 50 - i * 10))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_pu241), 50 + i * 20))
			...
			// ZFB RG-AM //
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_zfb_am_mix, 1, i), new SILEXRecipe(600, 100, 2)
			...
			recipes.put(ComparableStack.getComparableStack(ModItems.rbmk_pellet_zfb_am_mix, 1, i + 5), new SILEXRecipe(600, 100, 2)
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.powder_xe135_tiny), 3))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_pu241), 100 - i * 20))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_am_mix), 50 + i * 20))
					.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_zirconium), 147)) );
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long, 1, ItemWasteLong.WasteClass.URANIUM235.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long_depleted, 1, ItemWasteLong.WasteClass.URANIUM235.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.URANIUM235.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.URANIUM235.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long, 1, ItemWasteLong.WasteClass.URANIUM233.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long_depleted, 1, ItemWasteLong.WasteClass.URANIUM233.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.URANIUM233.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.URANIUM233.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.PLUTONIUM239.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.PLUTONIUM239.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.PLUTONIUM240.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.PLUTONIUM240.ordinal()), new SILEXRecipe(900, 100, 1)
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_zirconium), 2))
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), new SILEXRecipe(900, 100, 2)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), new SILEXRecipe(900, 100, 2)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long, 1, ItemWasteLong.WasteClass.THORIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long_depleted, 1, ItemWasteLong.WasteClass.THORIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long_depleted, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long, 1, ItemWasteLong.WasteClass.SCHRABIDIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_long_depleted, 1, ItemWasteLong.WasteClass.SCHRABIDIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short, 1, ItemWasteShort.WasteClass.SCHRABIDIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.nuclear_waste_short_depleted, 1, ItemWasteShort.WasteClass.SCHRABIDIUM.ordinal()), new SILEXRecipe(900, 100, 1)
		...
		recipes.put(ComparableStack.getComparableStack(ModItems.fallout, 1), new SILEXRecipe(900, 100, 2)
		...
		recipes.put(ComparableStack.getComparableStack(Blocks.gravel, 1), new SILEXRecipe(1000, 250, EnumWavelengths.VISIBLE)
	...
	public static ComparableStack translateItem(ItemStack stack) {
		ComparableStack orig = ComparableStack.getComparableStack(stack.getItem(), 1, stack.getItemDamage());
