...
public class SILEXRecipes {
	...
	public static void register() {
		...
		recipes.put("ingotUranium", new SILEXRecipe(900, 100, 2)
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_u235), 2))
		...
		recipes.put("ingotPlutonium", new SILEXRecipe(900, 100, 2)
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_pu238), 2))
		...
		recipes.put(new ComparableStack(ModItems.crystal_schraranium), new SILEXRecipe(900, 100, 3)
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_schrabidium), 7))
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_uranium), 1))
				.addOut(new WeightedRandomObject(new ItemStack(ModItems.nugget_plutonium), 1))
				);
		...
		recipes.put(new ComparableStack(ModItems.fallout, 1), new SILEXRecipe(100, 100, 2)
