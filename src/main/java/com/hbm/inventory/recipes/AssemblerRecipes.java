...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.gun_brimstone, 1), new AStack[] {new OreDictStack(PB.plate(), 14), new OreDictStack(CU.plate(), 14), new ComparableStack(ModItems.plate_desh, 4), new ComparableStack(ModItems.laser_crystal_co2, 1), new OreDictStack(RUBBER.ingot(), 2), new ComparableStack(Blocks.glass_pane, 2),new ComparableStack(ModItems.coil_advanced_torus, 8), new ComparableStack(ModItems.wire_red_copper, 6), new ComparableStack(ModItems.battery_lithium_cell_6, 1), new ComparableStack(ModItems.mechanism_revolver_2, 2) }, 600);
