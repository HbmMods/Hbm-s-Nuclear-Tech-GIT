...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_lithium_battery, 1), new AStack[] {new OreDictStack(ANY_PLASTIC.ingot(), 4), new OreDictStack(CO.dust(), 12), new OreDictStack(LI.dust(), 12), new OreDictStack(ALLOY.ingot(), 2), new ComparableStack(ModItems.wire_red_copper, 4), },300);
		makeRecipe(new ComparableStack(ModBlocks.machine_saturnite_battery, 1), new AStack[] {new OreDictStack(BIGMT.ingot(), 8), new OreDictStack(DURA.dust(), 12), new OreDictStack(ZR.dust(), 12), new OreDictStack(PU238.ingot(), 4), new OreDictStack(TC99.nugget(), 2), },400);
		makeRecipe(new ComparableStack(ModBlocks.machine_desh_battery, 1), new AStack[] {new OreDictStack(DESH.ingot(), 12), new OreDictStack(BAKELITE.dust(), 12), new OreDictStack(P_RED.dust(), 12), new OreDictStack(GRAPHITE.ingot(), 6), new OreDictStack(ANY_BISMOID.nugget(), 2), },600);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_euphemium_battery, 1), new AStack[] {new OreDictStack(EUPH.ingot(), 24), new OreDictStack(XE135.dust(), 16), new OreDictStack(SBD.dust(), 16), new OreDictStack(STAR.ingot(), 12), new OreDictStack(GH336.nugget(), 8), },1600);
		makeRecipe(new ComparableStack(ModBlocks.machine_verticium_battery, 1), new AStack[] {new OreDictStack(VERTICIUM.ingot(), 32), new ComparableStack(ModItems.powder_chlorophyte, 24), new ComparableStack(ModItems.powder_balefire, 24), new OreDictStack(PB209.ingot(), 4), new OreDictStack(AS.nugget(), 8), },3200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_electronium_battery, 1), new AStack[] {new ComparableStack(ModItems.ingot_electronium, 64), new OreDictStack(OSMIRIDIUM.dust(), 48), new ComparableStack(ModItems.battery_spark_cell_10000, 1), new OreDictStack(AU198.ingot(), 32), new ComparableStack(ModItems.nugget_u238, 16), },6400);
