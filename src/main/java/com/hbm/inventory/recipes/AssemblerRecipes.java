...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.rbmk_reflector_advance, 1), new AStack[] {
				new ComparableStack(ModBlocks.rbmk_reflector, 1),
				new ComparableStack(ModItems.plate_paa, 5),
				new ComparableStack(ModItems.motor, 2),
				new OreDictStack(KEY_CIRCUIT_BISMUTH, 1)
		}, 200);
