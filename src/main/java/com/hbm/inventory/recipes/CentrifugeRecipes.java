...
public class CentrifugeRecipes {
	...
	public static void register() {
		...
		recipes.put("orePlutonium", new ItemStack[] {
				...
				new ItemStack(ModItems.powder_plutonium, 1),
				new ItemStack(ModItems.nugget_ra226, 3),
				new ItemStack(Blocks.gravel, 1) });
		...
		recipes.put(new ComparableStack(ModItems.pellet_solinium_laced), new ItemStack[]
				{
					...
					new ItemStack(ModItems.powder_combine_steel, 2),
		...
		recipes.put(new ComparableStack(ModItems.crystal_plutonium), new ItemStack[] { new ItemStack(ModItems.powder_plutonium, 2), new ItemStack(ModItems.powder_plutonium, 2), new ItemStack(ModItems.nugget_ra226, 9), new ItemStack(ModItems.powder_lithium_tiny, 1) });
