...
public class BlastFurnaceRecipesNT extends GenericRecipes<GenericRecipeNoPower> {
	...
	public void registerDefaults() {
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.steelFromIngot").setDuration(800)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.steelFromDust").setDuration(800)
				.inputItems(new OreDictStack(IRON.dust(), 2), new OreDictStack(KEY_SAND))
				.outputItems(new ItemStack(ModItems.ingot_steel, 2), new ItemStack(ModItems.ingot_raw, 1, Mats.MAT_SLAG.id)));
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.steelFromOre").setDuration(800)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.steelWithFlux").setDuration(1_200)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.mingrade").setDuration(400)
				.inputItems(new OreDictStack(CU.ingot()), new OreDictStack(REDSTONE.dust()))
				.outputItems(new ItemStack(ModItems.ingot_red_copper, 2)));
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.mingradeDust").setDuration(400)
				.inputItems(new OreDictStack(CU.dust()), new OreDictStack(REDSTONE.dust()))
				.outputItems(new ItemStack(ModItems.ingot_red_copper, 2)));
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.mingradeIngot").setDuration(400)
				.inputItems(new OreDictStack(CU.ingot()), new OreDictStack(REDSTONE.ingot()))
				.outputItems(new ItemStack(ModItems.ingot_red_copper, 2)));
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.mingradeCursed").setDuration(400)
				.inputItems(new OreDictStack(CU.dust()), new OreDictStack(REDSTONE.ingot()))
				.outputItems(new ItemStack(ModItems.ingot_red_copper, 2)));
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.mingradeOre").setDuration(1_200)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.meteorSword").setDuration(1_200)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.meteor").setDuration(600)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.starmetal").setDuration(600)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.paa").setDuration(600)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.firebrick").setDuration(800)
		...
		this.register((GenericRecipeNoPower) new GenericRecipeNoPower("blast.firebrickLimestone").setDuration(800)
