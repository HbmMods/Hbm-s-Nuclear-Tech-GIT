...
public class Mats {
	...
	public static final NTMMaterial MAT_CURIUM		= makeSmeltable(9600,		CM,		    0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, DUST).m();
	public static final NTMMaterial MAT_RGC		    = makeSmeltable(9601,		CMRG,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, DUST).m();
	public static final NTMMaterial MAT_CM242		= makeSmeltable(9642,		CM242,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CM243		= makeSmeltable(9643,		CM243,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CM244		= makeSmeltable(9644,		CM244,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CM245		= makeSmeltable(9645,		CM245,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CM246		= makeSmeltable(9646,		CM246,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CM246		= makeSmeltable(9647,		CM247,		0x927178, 0XEAD7dc, 0XEAD7DC).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_BK247		= makeSmeltable(9747,		BK247,		0xACAEAE, 0x7B7C7C, 0xFFFFF).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_BK248		= makeSmeltable(9748,		BK248,		0xACAEAE, 0x7B7C7C, 0xFFFFF).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_BK249		= makeSmeltable(9749,		BK249,		0xACAEAE, 0x7B7C7C, 0xFFFFF).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CF249		= makeSmeltable(9849,		CF249,		0xFFC5A2, 0xFF9D60, 0xFFDBC9).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CF250		= makeSmeltable(9850,		CF250,		0xFFC5A2, 0xFF9D60, 0xFFDBC9).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CF251		= makeSmeltable(9851,		CF251,		0xFFC5A2, 0xFF9D60, 0xFFDBC9).setAutogen(NUGGET, BILLET, BLOCK).m();
	public static final NTMMaterial MAT_CF252		= makeSmeltable(9852,		CF252,		0xFFC5A2, 0xFF9D60, 0xFFDBC9).setAutogen(NUGGET, BILLET, BLOCK).m();
