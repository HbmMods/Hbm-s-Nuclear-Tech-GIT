...
public class GUIRBMKTurbine extends GuiInfoContainer {

	public static ResourceLocation texture = new ResourceLocation(RefStrings.MODID + ":textures/gui/gui_turbine.png");
	private TileEntityRBMKTurbine diFurnace;
	
	public GUIRBMKTurbine(InventoryPlayer invPlayer, TileEntityRBMKTurbine tedf) {
		super(new ContainerRBMKTurbine(invPlayer, tedf));
		diFurnace = tedf;
