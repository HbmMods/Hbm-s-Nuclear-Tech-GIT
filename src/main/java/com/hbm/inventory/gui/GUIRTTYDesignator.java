...
public class GUIRTTYDesignator extends GuiScreen {
	private static ResourceLocation texture = new ResourceLocation(RefStrings.MODID + ":textures/gui/machine/gui_rtty_designator.png");
	public ItemStack designator;
	...
	public GUIRTTYDesignator(ItemStack designator) {
		this.designator = designator;
		if(designator != null && designator.hasTagCompound()) {
			startingChannel = designator.stackTagCompound.getString(ItemRTTYPager.KEY_CHANNEL);
		}
	...
	private void drawGuiContainerForegroundLayer(int x, int y) {
		String name = I18nUtil.resolveKey("container.rttyDesignator");
