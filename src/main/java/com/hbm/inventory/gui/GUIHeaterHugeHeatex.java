...
public class GUIHeaterHugeHeatex extends GuiInfoContainer {
	...
	public GUIHeaterHugeHeatex(InventoryPlayer invPlayer, TileEntityHeaterHugeHeatex tedf) {
		super(new ContainerHeaterHugeHeatex(invPlayer, tedf));
		heater = tedf;
