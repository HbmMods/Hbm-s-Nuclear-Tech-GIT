...
public class GUIITER extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		iter.tanks[2].renderTankInfo(this, mouseX, mouseY, guiLeft + 12 + 4, guiTop + 86, 16, 52);
		iter.tanks[3].renderTankInfo(this, mouseX, mouseY, guiLeft + 26 + 128, guiTop + 86, 16, 52);
