...
public class GUIVVER extends GuiInfoContainer {

	protected TileEntityVVERController controller;
	private final ResourceLocation texture = new ResourceLocation(RefStrings.MODID + ":textures/gui/reactors/gui_pwr.png");
	
	private GuiTextField field;
	
	public GUIVVER(InventoryPlayer inventory, TileEntityVVERController controller) {
		super(new ContainerVVER(inventory, controller));
	...
	public void drawScreen(int x, int y, float interp) {
		...
		if(controller.typeLoaded != -1 && controller.amountLoaded > 0) {
			ItemStack display = new ItemStack(ModItems.vver_fuel, 1, controller.typeLoaded);
