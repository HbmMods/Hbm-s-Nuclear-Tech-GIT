...
public class ContainerVVER extends Container {
	
	TileEntityVVERController controller;

	public ContainerVVER(InventoryPlayer invPlayer, TileEntityVVERController controller) {
