...
public class WorldGenElectricVolcano extends WorldGenerator
{
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
	{
		...
		if (p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_) != ModBlocks.ike_regolith)
		{
			return false;
		}
		else
		{
			...
			int l = p_76484_2_.nextInt(4) + 20;
			int i1 = l / 4 + p_76484_2_.nextInt(12);
			
			if (i1 > 1 && p_76484_2_.nextInt(90) == 0)
			{
				...
				for (l1 = -k1; l1 <= k1; ++l1)
				{
					...
					for (int i2 = -k1; i2 <= k1; ++i2)
					{
						...
						if ((l1 == 0 && i2 == 0 || f1 * f1 + f2 * f2 <= f * f) && (l1 != -k1 && l1 != k1 && i2 != -k1 && i2 != k1 || p_76484_2_.nextFloat() <= 0.75F))
						{
							...
							if (block.getMaterial() == Material.air || block == ModBlocks.ike_regolith || block == ModBlocks.ike_stone)
							{
