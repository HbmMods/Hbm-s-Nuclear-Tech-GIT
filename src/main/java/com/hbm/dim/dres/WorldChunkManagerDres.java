...
public class WorldChunkManagerDres extends WorldChunkManager
{
	...
	protected WorldChunkManagerDres()
	{
	...
	public WorldChunkManagerDres(long seed, WorldType type)
	{
		this();
	...
	public WorldChunkManagerDres(World world)
	{
