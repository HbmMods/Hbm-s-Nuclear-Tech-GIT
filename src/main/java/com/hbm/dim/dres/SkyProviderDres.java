...
public class SkyProviderDres extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        float solar = (AstronomyUtil.KerbolRadius*4/(AstronomyUtil.DresAU*AstronomyUtil.AUToKm))*360;
        double DunaDres = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.DunaAU, AstronomyUtil.DunaP, AstronomyUtil.DresAU, AstronomyUtil.DresP);
        double EveDres = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.EveAU, AstronomyUtil.EveP, AstronomyUtil.DunaAU, AstronomyUtil.DunaP);
        double KerbinDres = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.KerbinAU, AstronomyUtil.KerbinP, AstronomyUtil.DresAU, AstronomyUtil.DresP);
        double DresJool = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.DresAU, AstronomyUtil.DresP, AstronomyUtil.JoolAU, AstronomyUtil.JoolP);
		...
		f10 = (AstronomyUtil.KerbolRadius/(AstronomyUtil.DresAU*AstronomyUtil.AUToKm))*900;
		float f11 = f10*2;
		tessellator.startDrawingQuads();
		...
		}
		{
    		...
    		f10 = (float) (0.15F/DresJool);
    		GL11.glColor4d(0.4588f, 0.6784f, 0.3059f, 1/DresJool);
    	...
    	}
		{
        	...
        	float KerbinSyn = AstronomyUtil.calculateSynodicPeriod(AstronomyUtil.KerbinP, AstronomyUtil.DresP);
        	...
        	double elong = AstronomyUtil.getMaxPlanetaryElongation(FMLClientHandler.instance().getClient().theWorld, AstronomyUtil.KerbinAU, AstronomyUtil.DresAU);
        	GL11.glRotatef((float) (sine*elong), 1.0F, 0.0F, 0.0F);
        	GL11.glRotatef(90F, 0.0F, 1.0F, 0.0F);
        	GL11.glEnable(GL11.GL_TEXTURE_2D);
        	GL11.glColor4d(0.2863F, 0.3882F, 0.4745F, 1/KerbinDres);
        	f10 = (float) (KerbinRad/KerbinDres);
        	mc.renderEngine.bindTexture(this.planet);
        	tessellator.startDrawingQuads();
        	tessellator.addVertexWithUV(-f10, 100.0D, -f10, 0.0D, 0.0D);
        	tessellator.addVertexWithUV(f10, 100.0D, -f10, 1.0D, 0.0D);
    	...
    	}
        {
        	...
        	GL11.glRotatef(90F, 0.0F, 1.0F, 0.0F);
        	GL11.glEnable(GL11.GL_TEXTURE_2D);
        	GL11.glColor4d(0.408F, 0.298F, 0.553F, 1/EveDres);
        	f10 = (float) (EveRad/EveDres);
        	mc.renderEngine.bindTexture(this.planet);
        	tessellator.startDrawingQuads();
        	tessellator.addVertexWithUV(-f10, 100.0D, -f10, 0.0D, 0.0D);
        	tessellator.addVertexWithUV(f10, 100.0D, -f10, 1.0D, 0.0D);
        ...
        }
    	{
        	...
        	GL11.glRotatef(90F, 0.0F, 1.0F, 0.0F);
        	GL11.glEnable(GL11.GL_TEXTURE_2D);
        	GL11.glColor4d(0.4863F, 0.4F, 0.3456, 1/DunaDres);
        	f10 = Math.max(0.1F, (float) (MohoRad/DunaDres));
        	mc.renderEngine.bindTexture(this.planet);
        	tessellator.startDrawingQuads();
        	tessellator.addVertexWithUV(-f10, 100.0D, -f10, 0.0D, 0.0D);
        	tessellator.addVertexWithUV(f10, 100.0D, -f10, 1.0D, 0.0D);
