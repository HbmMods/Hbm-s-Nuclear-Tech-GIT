...
import com.hbm.dim.laythe.GenLayerLaythe.GenLayerLaythe;
...
public class WorldChunkManagerLaythe extends WorldChunkManager
{
	...
	protected WorldChunkManagerLaythe()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList();
		this.myBiomesToSpawnIn.add(BiomeGenBaseLaythe.laytheIsland);
		this.myBiomesToSpawnIn.add(BiomeGenBaseLaythe.laytheOcean);
	}

	public WorldChunkManagerLaythe(long seed, WorldType type)
	{
		this();
		GenLayer[] genLayers = GenLayerLaythe.makeTheWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public WorldChunkManagerLaythe(World world)
	{
	...
	public BiomeGenBase getBiomeGenAt(int par1, int par2)
	{
		...
		if (biome == null)
		{
			return BiomeGenBaseLaythe.laytheIsland;
		}
		return biome;
	}
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int x, int z, int length, int width)
	{
		...
		for (int i = 0; i < length * width; i++)
		{
			...
			{
				par1ArrayOfBiomeGenBase[i] =  BiomeGenBaseLaythe.laytheIsland;
			}
		}
