...
public class SkyProviderLaythe extends IRenderHandler {
	...
	private static final ResourceLocation jool = new ResourceLocation("hbm:textures/misc/space/jool.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        float solar = (AstronomyUtil.KerbolRadius*4/(AstronomyUtil.JoolAU*AstronomyUtil.AUToKm))*360;
        double LaytheTylo = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.LaytheJoolKm, AstronomyUtil.LaytheP, AstronomyUtil.TyloJoolKm, AstronomyUtil.TyloP);
        double LaytheVall = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.LaytheJoolKm, AstronomyUtil.LaytheP, AstronomyUtil.VallJoolKm, AstronomyUtil.VallJoolKm);
        double LaytheBop = AstronomyUtil.getInterplanetaryDistance(world, AstronomyUtil.LaytheJoolKm, AstronomyUtil.LaytheP, AstronomyUtil.BopJoolKm, AstronomyUtil.BopP); // biomes 'o plenty penis
		...
		}
		{
    		...
    		f10 = Math.max(0.0F, (float) (BopRad / LaytheTylo)) * 180;
    		mc.renderEngine.bindTexture(this.bop);
    		tessellator.startDrawingQuads();
    		tessellator.addVertexWithUV(-f10, 100.0D, -f10, 0.0D, 0.0D);
    		tessellator.addVertexWithUV(f10, 100.0D, -f10, 1.0D, 0.0D);
    		tessellator.addVertexWithUV(f10, 100.0D, f10, 1.0D, 1.0D);
