...
import com.hbm.blocks.machine.SpotlightPowered;
...
public class RenderLightPowered implements ISimpleBlockRenderingHandler {

	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
		if (!(block instanceof SpotlightPowered)) return;
		SpotlightPowered spot = (SpotlightPowered) block;
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		if (!(block instanceof SpotlightPowered)) return true;
		SpotlightPowered spot = (SpotlightPowered) block;
		...
		if(spot instanceof SpotlightModularPowered) {
	...
	public int getRenderId() {
		return SpotlightPowered.renderID;
	}
