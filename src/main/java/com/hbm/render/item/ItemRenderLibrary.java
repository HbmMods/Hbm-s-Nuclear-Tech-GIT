...
public class ItemRenderLibrary {
	...
	public static void init() {
		...
		renderers.put(Item.getItemFromBlock(ModBlocks.machine_turbinegas), new ItemRenderBase() {
			public void renderInventory() {
				GL11.glTranslated(1.5, 0, 0);
				GL11.glRotated(90, 0, 1, 0);
				GL11.glScaled(2.5, 2.5, 2.5);
			...
			public void renderCommon() {
				GL11.glScaled(0.75, 0.75, 0.75);
				GL11.glShadeModel(GL11.GL_SMOOTH);
				bindTexture(ResourceManager.turbinegas_tex); ResourceManager.turbinegas.renderAll();
				GL11.glShadeModel(GL11.GL_FLAT);
			}});
