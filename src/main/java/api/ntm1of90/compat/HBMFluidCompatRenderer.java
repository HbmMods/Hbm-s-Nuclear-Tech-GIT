...
/**
 * A utility class for rendering HBM fluids in other mods' GUIs and inventories.
 * This class provides methods that other mods can use to render our fluids correctly.
 */
@SideOnly(Side.CLIENT)
public class HBMFluidCompatRenderer {
     ...
     * @return The HBM fluid type, or Fluids.NONE if not found
     */
