...
public class AE2DirectColorFixer {
    ...
    public static void initialize() {
        ...
        if (!Loader.isModLoaded("appliedenergistics2")) {
            System.out.println("[HBM] Applied Energistics 2 not detected, skipping AE2 direct color fixer");
            return;
        }
        ...
        try {
            ...
            System.out.println("[HBM] AE2 direct color fixer initialized");
        } catch (Exception e) {
            System.err.println("[HBM] Error initializing AE2 direct color fixer: " + e.getMessage());
        }
    ...
    private static void initializeAE2() {
        try {
            ...
            System.out.println("[HBM] Successfully initialized AE2 direct color fixer");
        } catch (Exception e) {
            System.err.println("[HBM] Error initializing AE2 direct color fixer: " + e.getMessage());
        }
    }
    ...
    private static void registerAllFluidColors() {
        try {
            ...
            System.out.println("[HBM] Registered all fluid colors with AE2");
        } catch (Exception e) {
            System.err.println("[HBM] Error registering fluid colors with AE2: " + e.getMessage());
        }
    }
