...
public class AE2FluidCellInventoryFixer {
    ...
    public static void initialize() {
        ...
        if (!Loader.isModLoaded("appliedenergistics2")) {
            System.out.println("[HBM] Applied Energistics 2 not detected, skipping AE2 fluid cell inventory fixer");
            return;
        }
        ...
        try {
            ...
            System.out.println("[HBM] AE2 fluid cell inventory fixer initialized");
        } catch (Exception e) {
            System.err.println("[HBM] Error initializing AE2 fluid cell inventory fixer: " + e.getMessage());
        }
    ...
    private static void initializeAE2() {
        try {
            ...
            if (fluidColorsField == null) {
                System.err.println("[HBM] Could not find fluid colors field in FluidCellInventory");
                return;
            }
            ...
            System.out.println("[HBM] Successfully initialized AE2 fluid cell inventory fixer");
        } catch (Exception e) {
            System.err.println("[HBM] Error initializing AE2 fluid cell inventory fixer: " + e.getMessage());
        }
    }
    ...
    private static void registerAllFluidColors() {
        ...
        try {
            ...
            if (colors == null) {
                System.err.println("[HBM] Fluid colors map is null in FluidCellInventory");
                return;
            }
            ...
            System.out.println("[HBM] Registered all fluid colors with AE2's fluid cell inventory");
        } catch (Exception e) {
            System.err.println("[HBM] Error registering fluid colors with AE2's fluid cell inventory: " + e.getMessage());
        }
    }
