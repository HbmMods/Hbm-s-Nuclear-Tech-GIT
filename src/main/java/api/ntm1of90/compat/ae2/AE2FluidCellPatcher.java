...
public class AE2FluidCellPatcher {
    ...
    public static void initialize() {
        ...
        if (!Loader.isModLoaded("appliedenergistics2")) {
            System.out.println("[HBM] Applied Energistics 2 not detected, skipping AE2 fluid cell patcher");
            return;
        }
        ...
        try {
            ...
            System.out.println("[HBM] AE2 fluid cell patcher initialized");
        } catch (Exception e) {
            System.err.println("[HBM] Error initializing AE2 fluid cell patcher: " + e.getMessage());
        }
    ...
    private static void initializeAE2() {
        try {
            ...
            System.out.println("[HBM] Successfully initialized AE2 fluid cell patcher");
        } catch (Exception e) {
            System.err.println("[HBM] Error initializing AE2 fluid cell patcher: " + e.getMessage());
        }
    }
    ...
    private static void patchFluidCellInventory() {
        try {
            ...
            if (fluidColorsField != null) {
                ...
                System.out.println("[HBM] Successfully patched AE2's FluidCellInventory");
            } else {
                System.err.println("[HBM] Could not find fluid colors field in FluidCellInventory");
            }
        } catch (Exception e) {
            System.err.println("[HBM] Could not patch AE2's FluidCellInventory: " + e.getMessage());
        }
    }
    ...
    private static void patchFluidCellRenderer() {
        try {
            ...
            if (fluidColorsField != null) {
                ...
                System.out.println("[HBM] Successfully patched AE2's FluidCellRenderer");
            } else {
                System.err.println("[HBM] Could not find fluid colors field in FluidCellRenderer");
            }
        } catch (Exception e) {
            System.err.println("[HBM] Could not patch AE2's FluidCellRenderer: " + e.getMessage());
        }
    }
    ...
    private static void patchFluidCellDisplay() {
        try {
            ...
            if (fluidColorsField != null) {
                ...
                System.out.println("[HBM] Successfully patched AE2's fluid cell display");
            } else {
                System.err.println("[HBM] Could not find fluid colors field in fluid cell display");
            }
        } catch (Exception e) {
            System.err.println("[HBM] Could not patch AE2's fluid cell display: " + e.getMessage());
        }
    }
