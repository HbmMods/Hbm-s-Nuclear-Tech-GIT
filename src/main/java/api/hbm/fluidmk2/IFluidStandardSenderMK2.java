...
public interface IFluidStandardSenderMK2 extends IFluidProviderMK2 {
	...
	@Deprecated public default EnumTransferAction tryProvide(FluidType type, World world, int x, int y, int z, ForgeDirection dir) { return tryProvide(type, 0, world, x, y, z, dir); }

	@Deprecated public default EnumTransferAction tryProvide(FluidType type, int pressure, World world, int x, int y, int z, ForgeDirection dir) {
