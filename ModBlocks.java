...
public class ModBlocks {
	...
	public static Block machine_hydrazine_thruster;
	...
	private static void initializeBlock() {
		...
		machine_hydrazine_thruster = new MachineHydrazineThruster(Material.iron).setBlockName("machine_hydrazine_thruster").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel");
	...
	private static void registerBlock() {
		...
		register(machine_hydrazine_thruster);
