...
public class AnvilRecipes extends SerializableRecipe {
	...
	public static void registerConstructionRecipes() {
		...
		constructionRecipes.add(new AnvilConstructionRecipe(new ComparableStack(ModItems.billet_cm242be, 1), new AnvilOutput(new ItemStack(ModItems.plate_fuel_cm242be))).setTier(4));
