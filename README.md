...
# License
All rights reserved. You are allowed to use this on servers or in modpacks, but for anything else you need my explicit permission. **Especially** for redistributing modified versions of this software.
