...
public class ModItems {
	...
	{			
		...
		crystal_cinnabar = new Item().setUnlocalizedName("crystal_cinnabar").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":crystal_cinnabar_placeholder");
